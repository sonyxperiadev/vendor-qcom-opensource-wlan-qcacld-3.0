				 ...
				 uint8_t *pBuf)
{
	...
	tmp111__ = 0U;
	tmp111__ |= (pSrc->ess << 0);
	tmp111__ |= (pSrc->ibss << 1);
	tmp111__ |= (pSrc->cfPollable << 2);
	tmp111__ |= (pSrc->cfPollReq << 3);
	tmp111__ |= (pSrc->privacy << 4);
	tmp111__ |= (pSrc->shortPreamble << 5);
	tmp111__ |= (pSrc->criticalUpdateFlag << 6);
	tmp111__ |= (pSrc->channelAgility << 7);
	tmp111__ |= (pSrc->spectrumMgt << 8);
	tmp111__ |= (pSrc->qos << 9);
	tmp111__ |= (pSrc->shortSlotTime << 10);
	tmp111__ |= (pSrc->apsd << 11);
	tmp111__ |= (pSrc->rrm << 12);
	tmp111__ |= (pSrc->dsssOfdm << 13);
	tmp111__ |= (pSrc->delayedBA << 14);
	tmp111__ |= (pSrc->immediateBA << 15);
				  ...
				  uint8_t *pBuf)
{
	uint8_t tmp112__;
	tmp112__ = 0U;
	tmp112__ |= (pSrc->chanWidth << 0);
	tmp112__ |= (pSrc->reserved << 2);
	tmp112__ |= (pSrc->rxNSS << 4);
	tmp112__ |= (pSrc->rxNSSType << 7);
	*pBuf = tmp112__;
	(void)pCtx;
				   ...
				   uint8_t *pBuf)
{
	uint8_t tmp113__;
	tmp113__ = 0U;
	tmp113__ |= (pSrc->PowerSave_En << 0);
	tmp113__ |= (pSrc->Mode << 1);
			   ...
			   uint8_t *pBuf)
{
	...
	tmp114__ |= (pSrc->schedule << 16);
	tmp114__ |= (pSrc->unused << 17);
				    ...
				    uint8_t *pBuf)
{
	uint16_t tmp115__;
	tmp115__ = 0U;
	tmp115__ |= (pSrc->amsdu_supp << 0);
	tmp115__ |= (pSrc->policy << 1);
	tmp115__ |= (pSrc->tid << 2);
	tmp115__ |= (pSrc->buff_size << 6);
				    ...
				    uint8_t *pBuf)
{
	uint16_t tmp117__;
	tmp117__ = 0U;
	tmp117__ |= (pSrc->reserved << 0);
	tmp117__ |= (pSrc->initiator << 11);
	tmp117__ |= (pSrc->tid << 12);
					       ...
					       uint8_t *pBuf)
{
	uint32_t tmp118__;
	tmp118__ = 0U;
	tmp118__ |= (pSrc->switch_mode << 0);
	tmp118__ |= (pSrc->op_class << 8);
	tmp118__ |= (pSrc->new_channel << 16);
	tmp118__ |= (pSrc->switch_count << 24);
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 0;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp119__ = 0U;
		tmp119__ |= (pSrc->minor << 0);
		tmp119__ |= (pSrc->major << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		pBuf += 2; *pnConsumed += 2;
		tmp120__ = 0U;
		tmp120__ |= (pSrc->minor << 0);
		tmp120__ |= (pSrc->major << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 101;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp121__ = 0U;
		tmp121__ |= (pSrc->oce_release << 0);
		tmp121__ |= (pSrc->is_sta_cfon << 3);
		tmp121__ |= (pSrc->non_oce_ap_present << 4);
		tmp121__ |= (pSrc->reserved << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					     ...
					     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 103;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp122__ = 0U;
		tmp122__ |= (pSrc->downlink_av_cap << 0);
		tmp122__ |= (pSrc->uplink_av_cap << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 70;
		...
		++pBuf; ++(*pnConsumed);
		tmp124__ = 0U;
		tmp124__ |= (pSrc->LinkMeasurement << 0);
		tmp124__ |= (pSrc->NeighborRpt << 1);
		tmp124__ |= (pSrc->parallel << 2);
		tmp124__ |= (pSrc->repeated << 3);
		tmp124__ |= (pSrc->BeaconPassive << 4);
		tmp124__ |= (pSrc->BeaconActive << 5);
		tmp124__ |= (pSrc->BeaconTable << 6);
		tmp124__ |= (pSrc->BeaconRepCond << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp125__ = 0U;
		tmp125__ |= (pSrc->FrameMeasurement << 0);
		tmp125__ |= (pSrc->ChannelLoad << 1);
		tmp125__ |= (pSrc->NoiseHistogram << 2);
		tmp125__ |= (pSrc->statistics << 3);
		tmp125__ |= (pSrc->LCIMeasurement << 4);
		tmp125__ |= (pSrc->LCIAzimuth << 5);
		tmp125__ |= (pSrc->TCMCapability << 6);
		tmp125__ |= (pSrc->triggeredTCM << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp126__ = 0U;
		tmp126__ |= (pSrc->APChanReport << 0);
		tmp126__ |= (pSrc->RRMMIBEnabled << 1);
		tmp126__ |= (pSrc->operatingChanMax << 2);
		tmp126__ |= (pSrc->nonOperatinChanMax << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp127__ = 0U;
		tmp127__ |= (pSrc->MeasurementPilot << 0);
		tmp127__ |= (pSrc->MeasurementPilotEnabled << 3);
		tmp127__ |= (pSrc->NeighborTSFOffset << 4);
		tmp127__ |= (pSrc->RCPIMeasurement << 5);
		tmp127__ |= (pSrc->RSNIMeasurement << 6);
		tmp127__ |= (pSrc->BssAvgAccessDelay << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp128__ = 0U;
		tmp128__ |= (pSrc->BSSAvailAdmission << 0);
		tmp128__ |= (pSrc->AntennaInformation << 1);
		tmp128__ |= (pSrc->fine_time_meas_rpt << 2);
		tmp128__ |= (pSrc->lci_capability << 3);
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 15;
		...
		++pBuf; ++(*pnConsumed);
		tmp129__ = 0U;
		tmp129__ |= (pSrc->aggregation << 0);
		tmp129__ |= (pSrc->tsid << 1);
		tmp129__ |= (pSrc->direction << 5);
			      ...
			      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 13;
		...
		++pBuf; ++(*pnConsumed);
		tmp130__ = 0U;
		tmp130__ |= (pSrc->traffic_type << 0);
		tmp130__ |= (pSrc->tsid << 1);
		tmp130__ |= (pSrc->direction << 5);
		tmp130__ |= (pSrc->access_policy << 7);
		tmp130__ |= (pSrc->aggregation << 9);
		tmp130__ |= (pSrc->psb << 10);
		tmp130__ |= (pSrc->user_priority << 11);
		tmp130__ |= (pSrc->tsinfo_ack_pol << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp131__ = 0U;
		tmp131__ |= (pSrc->schedule << 0);
		tmp131__ |= (pSrc->unused << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp132__ = 0U;
		tmp132__ |= (pSrc->size << 0);
		tmp132__ |= (pSrc->fixed << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 191;
		...
		++pBuf; ++(*pnConsumed);
		tmp133__ = 0U;
		tmp133__ |= (pSrc->maxMPDULen << 0);
		tmp133__ |= (pSrc->supportedChannelWidthSet << 2);
		tmp133__ |= (pSrc->ldpcCodingCap << 4);
		tmp133__ |= (pSrc->shortGI80MHz << 5);
		tmp133__ |= (pSrc->shortGI160and80plus80MHz << 6);
		tmp133__ |= (pSrc->txSTBC << 7);
		tmp133__ |= (pSrc->rxSTBC << 8);
		tmp133__ |= (pSrc->suBeamFormerCap << 11);
		tmp133__ |= (pSrc->suBeamformeeCap << 12);
		tmp133__ |= (pSrc->csnofBeamformerAntSup << 13);
		tmp133__ |= (pSrc->numSoundingDim << 16);
		tmp133__ |= (pSrc->muBeamformerCap << 19);
		tmp133__ |= (pSrc->muBeamformeeCap << 20);
		tmp133__ |= (pSrc->vhtTXOPPS << 21);
		tmp133__ |= (pSrc->htcVHTCap << 22);
		tmp133__ |= (pSrc->maxAMPDULenExp << 23);
		tmp133__ |= (pSrc->vhtLinkAdaptCap << 26);
		tmp133__ |= (pSrc->rxAntPattern << 28);
		tmp133__ |= (pSrc->txAntPattern << 29);
		tmp133__ |= (pSrc->extended_nss_bw_supp << 30);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp134__ = 0U;
		tmp134__ |= (pSrc->rxHighSupDataRate << 0);
		tmp134__ |= (pSrc->max_nsts_total << 13);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp135__ = 0U;
		tmp135__ |= (pSrc->txSupDataRate << 0);
		tmp135__ |= (pSrc->vht_extended_nss_bw_cap << 13);
		tmp135__ |= (pSrc->reserved << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp138__ = 0U;
		tmp138__ |= (pSrc->tsinfo_rsvd << 0);
		tmp138__ |= (pSrc->burst_size_defn << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
							   ...
							   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 2;
		...
		++pBuf; ++(*pnConsumed);
		tmp140__ = 0U;
		tmp140__ |= (pSrc->beacon_report_id << 0);
		tmp140__ |= (pSrc->fragment_id_number << 8);
		tmp140__ |= (pSrc->more_fragments << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 195;
		...
		++pBuf; ++(*pnConsumed);
		tmp143__ = 0U;
		tmp143__ |= (pSrc->max_tx_pwr_count << 0);
		tmp143__ |= (pSrc->max_tx_pwr_interpret << 3);
		tmp143__ |= (pSrc->max_tx_pwr_category << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				     ...
				     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp144__ = 0U;
		tmp144__ |= (pSrc->acbe_aifsn << 0);
		tmp144__ |= (pSrc->acbe_acm << 4);
		tmp144__ |= (pSrc->acbe_aci << 5);
		tmp144__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp145__ = 0U;
		tmp145__ |= (pSrc->acbe_acwmin << 0);
		tmp145__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp146__ = 0U;
		tmp146__ |= (pSrc->acbk_aifsn << 0);
		tmp146__ |= (pSrc->acbk_acm << 4);
		tmp146__ |= (pSrc->acbk_aci << 5);
		tmp146__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp147__ = 0U;
		tmp147__ |= (pSrc->acbk_acwmin << 0);
		tmp147__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp148__ = 0U;
		tmp148__ |= (pSrc->acvi_aifsn << 0);
		tmp148__ |= (pSrc->acvi_acm << 4);
		tmp148__ |= (pSrc->acvi_aci << 5);
		tmp148__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp149__ = 0U;
		tmp149__ |= (pSrc->acvi_acwmin << 0);
		tmp149__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp150__ = 0U;
		tmp150__ |= (pSrc->acvo_aifsn << 0);
		tmp150__ |= (pSrc->acvo_acm << 4);
		tmp150__ |= (pSrc->acvo_aci << 5);
		tmp150__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp151__ = 0U;
		tmp151__ |= (pSrc->acvo_acwmin << 0);
		tmp151__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 42;
		...
		++pBuf; ++(*pnConsumed);
		tmp152__ = 0U;
		tmp152__ |= (pSrc->non_erp_present << 0);
		tmp152__ |= (pSrc->use_prot << 1);
		tmp152__ |= (pSrc->barker_preamble << 2);
		tmp152__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 55;
		...
		tmp154__ |= (pSrc->IECount << 8);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

		frameshtons(pCtx, pBuf, tmp154__, 0);
		*pnConsumed += 2;
		pBuf += 2;
		nBuf -=  2 ;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 45;
		...
		++pBuf; ++(*pnConsumed);
		tmp155__ = 0U;
		tmp155__ |= (pSrc->advCodingCap << 0);
		tmp155__ |= (pSrc->supportedChannelWidthSet << 1);
		tmp155__ |= (pSrc->mimoPowerSave << 2);
		tmp155__ |= (pSrc->greenField << 4);
		tmp155__ |= (pSrc->shortGI20MHz << 5);
		tmp155__ |= (pSrc->shortGI40MHz << 6);
		tmp155__ |= (pSrc->txSTBC << 7);
		tmp155__ |= (pSrc->rxSTBC << 8);
		tmp155__ |= (pSrc->delayedBA << 10);
		tmp155__ |= (pSrc->maximalAMSDUsize << 11);
		tmp155__ |= (pSrc->dsssCckMode40MHz << 12);
		tmp155__ |= (pSrc->psmp << 13);
		tmp155__ |= (pSrc->stbcControlFrame << 14);
		tmp155__ |= (pSrc->lsigTXOPProtection << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp156__ = 0U;
		tmp156__ |= (pSrc->maxRxAMPDUFactor << 0);
		tmp156__ |= (pSrc->mpduDensity << 2);
		tmp156__ |= (pSrc->reserved1 << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 16;
		...
		tmp157__ = 0U;
		tmp157__ |= (pSrc->pco << 0);
		tmp157__ |= (pSrc->transitionTime << 1);
		tmp157__ |= (pSrc->reserved2 << 3);
		tmp157__ |= (pSrc->mcsFeedback << 8);
		tmp157__ |= (pSrc->reserved3 << 10);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp158__ = 0U;
		tmp158__ |= (pSrc->txBF << 0);
		tmp158__ |= (pSrc->rxStaggeredSounding << 1);
		tmp158__ |= (pSrc->txStaggeredSounding << 2);
		tmp158__ |= (pSrc->rxZLF << 3);
		tmp158__ |= (pSrc->txZLF << 4);
		tmp158__ |= (pSrc->implicitTxBF << 5);
		tmp158__ |= (pSrc->calibration << 6);
		tmp158__ |= (pSrc->explicitCSITxBF << 8);
		tmp158__ |= (pSrc->explicitUncompressedSteeringMatrix << 9);
		tmp158__ |= (pSrc->explicitBFCSIFeedback << 10);
		tmp158__ |= (pSrc->explicitUncompressedSteeringMatrixFeedback << 13);
		tmp158__ |= (pSrc->explicitCompressedSteeringMatrixFeedback << 16);
		tmp158__ |= (pSrc->csiNumBFAntennae << 19);
		tmp158__ |= (pSrc->uncompressedSteeringMatrixBFAntennae << 21);
		tmp158__ |= (pSrc->compressedSteeringMatrixBFAntennae << 23);
		tmp158__ |= (pSrc->reserved4 << 25);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp159__ = 0U;
		tmp159__ |= (pSrc->antennaSelection << 0);
		tmp159__ |= (pSrc->explicitCSIFeedbackTx << 1);
		tmp159__ |= (pSrc->antennaIndicesFeedbackTx << 2);
		tmp159__ |= (pSrc->explicitCSIFeedback << 3);
		tmp159__ |= (pSrc->antennaIndicesFeedback << 4);
		tmp159__ |= (pSrc->rxAS << 5);
		tmp159__ |= (pSrc->txSoundingPPDUs << 6);
		tmp159__ |= (pSrc->reserved5 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp160__ = 0U;
		tmp160__ |= (pSrc->secondaryChannelOffset << 0);
		tmp160__ |= (pSrc->recommendedTxWidthSet << 2);
		tmp160__ |= (pSrc->rifsMode << 3);
		tmp160__ |= (pSrc->controlledAccessOnly << 4);
		tmp160__ |= (pSrc->serviceIntervalGranularity << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp161__ = 0U;
		tmp161__ |= (pSrc->opMode << 0);
		tmp161__ |= (pSrc->nonGFDevicesPresent << 2);
		tmp161__ |= (pSrc->transmitBurstLimit << 3);
		tmp161__ |= (pSrc->obssNonHTStaPresent << 4);
		tmp161__ |= (pSrc->chan_center_freq_seg2 << 5);
		tmp161__ |= (pSrc->reserved << 13);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp162__ = 0U;
		tmp162__ |= (pSrc->basicSTBCMCS << 0);
		tmp162__ |= (pSrc->dualCTSProtection << 7);
		tmp162__ |= (pSrc->secondaryBeacon << 8);
		tmp162__ |= (pSrc->lsigTXOPProtectionFullSupport << 9);
		tmp162__ |= (pSrc->pcoActive << 10);
		tmp162__ |= (pSrc->pcoPhase << 11);
		tmp162__ |= (pSrc->reserved2 << 12);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp163__ = 0U;
		tmp163__ |= (pSrc->late << 0);
		tmp163__ |= (pSrc->incapable << 1);
		tmp163__ |= (pSrc->refused << 2);
		tmp163__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->type) {
			...
			case 0:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp164__ = 0U;
				tmp164__ |= (pSrc->report.Basic.bss << 0);
				tmp164__ |= (pSrc->report.Basic.ofdm_preamble << 1);
				tmp164__ |= (pSrc->report.Basic.unid_signal << 2);
				tmp164__ |= (pSrc->report.Basic.rader << 3);
				tmp164__ |= (pSrc->report.Basic.unmeasured << 4);
				tmp164__ |= (pSrc->report.Basic.unused << 5);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
			...
			case 5:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp165__ = 0U;
				tmp165__ |= (pSrc->report.Beacon.condensed_PHY << 0);
				tmp165__ |= (pSrc->report.Beacon.reported_frame_type << 7);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp166__ = 0U;
		tmp166__ |= (pSrc->parallel << 0);
		tmp166__ |= (pSrc->enable << 1);
		tmp166__ |= (pSrc->request << 2);
		tmp166__ |= (pSrc->report << 3);
		tmp166__ |= (pSrc->durationMandatory << 4);
		tmp166__ |= (pSrc->unused << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp167__ = 0U;
		tmp167__ |= (pSrc->overDSCap << 0);
		tmp167__ |= (pSrc->resourceReqCap << 1);
		tmp167__ |= (pSrc->reserved << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 6;
		pBuf += 6;
		tmp168__ = 0U;
		tmp168__ |= (pSrc->APReachability << 0);
		tmp168__ |= (pSrc->Security << 2);
		tmp168__ |= (pSrc->KeyScope << 3);
		tmp168__ |= (pSrc->SpecMgmtCap << 4);
		tmp168__ |= (pSrc->QosCap << 5);
		tmp168__ |= (pSrc->apsd << 6);
		tmp168__ |= (pSrc->rrm << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp169__ = 0U;
		tmp169__ |= (pSrc->DelayedBA << 0);
		tmp169__ |= (pSrc->ImmBA << 1);
		tmp169__ |= (pSrc->MobilityDomain << 2);
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 199;
		...
		++pBuf; ++(*pnConsumed);
		tmp170__ = 0U;
		tmp170__ |= (pSrc->chanWidth << 0);
		tmp170__ |= (pSrc->vht_160_80p80_supp << 2);
		tmp170__ |= (pSrc->no_ldpc << 3);
		tmp170__ |= (pSrc->rxNSS << 4);
		tmp170__ |= (pSrc->rxNSSType << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 106;
		...
		++pBuf; ++(*pnConsumed);
		tmp171__ = 0U;
		tmp171__ |= (pSrc->ac_bk_traffic_aval << 0);
		tmp171__ |= (pSrc->ac_be_traffic_aval << 1);
		tmp171__ |= (pSrc->ac_vi_traffic_aval << 2);
		tmp171__ |= (pSrc->ac_vo_traffic_aval << 3);
		tmp171__ |= (pSrc->reserved << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 46;
		...
		++pBuf; ++(*pnConsumed);
		tmp172__ = 0U;
		tmp172__ |= (pSrc->count << 0);
		tmp172__ |= (pSrc->qack << 4);
		tmp172__ |= (pSrc->qreq << 5);
		tmp172__ |= (pSrc->txopreq << 6);
		tmp172__ |= (pSrc->reserved << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 46;
		...
		++pBuf; ++(*pnConsumed);
		tmp173__ = 0U;
		tmp173__ |= (pSrc->acvo_uapsd << 0);
		tmp173__ |= (pSrc->acvi_uapsd << 1);
		tmp173__ |= (pSrc->acbk_uapsd << 2);
		tmp173__ |= (pSrc->acbe_uapsd << 3);
		tmp173__ |= (pSrc->qack << 4);
		tmp173__ |= (pSrc->max_sp_length << 5);
		tmp173__ |= (pSrc->more_data_ack << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			     ...
			     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 4;
		pBuf += 4;
		tmp174__ = 0U;
		tmp174__ |= (pSrc->preauth << 0);
		tmp174__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp175__ = 0U;
		tmp175__ |= (pSrc->reserved << 0);
		tmp175__ |= (pSrc->qack << 4);
		tmp175__ |= (pSrc->queue_request << 5);
		tmp175__ |= (pSrc->txop_request << 6);
		tmp175__ |= (pSrc->more_ack << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp176__ = 0U;
		tmp176__ |= (pSrc->param_set_count << 0);
		tmp176__ |= (pSrc->reserved << 4);
		tmp176__ |= (pSrc->uapsd << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		...
		tmp177__ |= (pSrc->reserved1 << 4);
		tmp177__ |= (pSrc->max_sp_length << 5);
		tmp177__ |= (pSrc->reserved2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 159;
		...
		++pBuf; ++(*pnConsumed);
		tmp186__ = 0U;
		tmp186__ |= (pSrc->no_fragmentation << 0);
		tmp186__ |= (pSrc->he_frag_operation << 1);
		tmp186__ |= (pSrc->reserved << 3);
		tmp186__ |= (pSrc->extd_buff_size << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp187__ = 0U;
		tmp187__ |= (pSrc->new_color << 0);
		tmp187__ |= (pSrc->reserved << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					    ...
					    uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp188__ = 0U;
		tmp188__ |= (pSrc->prot_keep_alive_reqd << 0);
		tmp188__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 108;
		++pBuf; ++(*pnConsumed);
		tmp189__ = 0U;
		tmp189__ |= (pSrc->epcs_pri_access << 0);
		tmp189__ |= (pSrc->eht_om_ctl << 1);
		tmp189__ |= (pSrc->triggered_txop_sharing_mode1 << 2);
		tmp189__ |= (pSrc->triggered_txop_sharing_mode2 << 3);
		tmp189__ |= (pSrc->restricted_twt << 4);
		tmp189__ |= (pSrc->scs_traffic_desc << 5);
		tmp189__ |= (pSrc->max_mpdu_len << 6);
		tmp189__ |= (pSrc->max_a_mpdu_len_exponent_ext << 8);
		tmp189__ |= (pSrc->reserved << 9);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

		frameshtons(pCtx, pBuf, tmp189__, 0);
		*pnConsumed += 2;
		pBuf += 2;
		nBuf -=  2 ;
		tmp190__ = 0U;
		tmp190__ |= (pSrc->reserved2 << 0);
		tmp190__ |= (pSrc->support_320mhz_6ghz << 1);
		tmp190__ |= (pSrc->ru_242tone_wt_20mhz << 2);
		tmp190__ |= (pSrc->ndp_4x_eht_ltf_3dot2_us_gi << 3);
		tmp190__ |= (pSrc->partial_bw_mu_mimo << 4);
		tmp190__ |= (pSrc->su_beamformer << 5);
		tmp190__ |= (pSrc->su_beamformee << 6);
		tmp190__ |= (pSrc->bfee_ss_le_80mhz << 7);
		tmp190__ |= (pSrc->bfee_ss_160mhz << 10);
		tmp190__ |= (pSrc->bfee_ss_320mhz << 13);
		tmp190__ |= (pSrc->num_sounding_dim_le_80mhz << 16);
		tmp190__ |= (pSrc->num_sounding_dim_160mhz << 19);
		tmp190__ |= (pSrc->num_sounding_dim_320mhz << 22);
		tmp190__ |= (pSrc->ng_16_su_feedback << 25);
		tmp190__ |= (pSrc->ng_16_mu_feedback << 26);
		tmp190__ |= (pSrc->cb_sz_4_2_su_feedback << 27);
		tmp190__ |= (pSrc->cb_sz_7_5_su_feedback << 28);
		tmp190__ |= (pSrc->trig_su_bforming_feedback << 29);
		tmp190__ |= (pSrc->trig_mu_bforming_partial_bw_feedback << 30);
		tmp190__ |= (pSrc->triggered_cqi_feedback << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;

		frameshtonl(pCtx, pBuf, tmp190__, 0);
		*pnConsumed += 4;
		pBuf += 4;
		nBuf -=  4 ;
		tmp191__ = 0U;
		tmp191__ |= (pSrc->partial_bw_dl_mu_mimo << 0);
		tmp191__ |= (pSrc->psr_based_sr << 1);
		tmp191__ |= (pSrc->power_boost_factor << 2);
		tmp191__ |= (pSrc->eht_mu_ppdu_4x_ltf_0_8_us_gi << 3);
		tmp191__ |= (pSrc->max_nc << 4);
		tmp191__ |= (pSrc->non_trig_cqi_feedback << 8);
		tmp191__ |= (pSrc->tx_1024_4096_qam_lt_242_tone_ru << 9);
		tmp191__ |= (pSrc->rx_1024_4096_qam_lt_242_tone_ru << 10);
		tmp191__ |= (pSrc->ppet_present << 11);
		tmp191__ |= (pSrc->common_nominal_pkt_padding << 12);
		tmp191__ |= (pSrc->max_num_eht_ltf << 14);
		tmp191__ |= (pSrc->mcs_15 << 19);
		tmp191__ |= (pSrc->eht_dup_6ghz << 23);
		tmp191__ |= (pSrc->op_sta_rx_ndp_wider_bw_20mhz << 24);
		tmp191__ |= (pSrc->non_ofdma_ul_mu_mimo_le_80mhz << 25);
		tmp191__ |= (pSrc->non_ofdma_ul_mu_mimo_160mhz << 26);
		tmp191__ |= (pSrc->non_ofdma_ul_mu_mimo_320mhz << 27);
		tmp191__ |= (pSrc->mu_bformer_le_80mhz << 28);
		tmp191__ |= (pSrc->mu_bformer_160mhz << 29);
		tmp191__ |= (pSrc->mu_bformer_320mhz << 30);
		tmp191__ |= (pSrc->tb_sounding_feedback_rl << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;

		frameshtonl(pCtx, pBuf, tmp191__, 0);
		*pnConsumed += 4;
		pBuf += 4;
		nBuf -=  4 ;
		tmp192__ = 0U;
		tmp192__ |= (pSrc->rx_1k_qam_in_wider_bw_dl_ofdma << 0);
		tmp192__ |= (pSrc->rx_4k_qam_in_wider_bw_dl_ofdma << 1);
		tmp192__ |= (pSrc->reserved3 << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp193__ = 0U;
		tmp193__ |= (pSrc->bw_20_rx_max_nss_for_mcs_0_to_7 << 0);
		tmp193__ |= (pSrc->bw_20_tx_max_nss_for_mcs_0_to_7 << 4);
		tmp193__ |= (pSrc->bw_20_rx_max_nss_for_mcs_8_and_9 << 8);
		tmp193__ |= (pSrc->bw_20_tx_max_nss_for_mcs_8_and_9 << 12);
		tmp193__ |= (pSrc->bw_20_rx_max_nss_for_mcs_10_and_11 << 16);
		tmp193__ |= (pSrc->bw_20_tx_max_nss_for_mcs_10_and_11 << 20);
		tmp193__ |= (pSrc->bw_20_rx_max_nss_for_mcs_12_and_13 << 24);
		tmp193__ |= (pSrc->bw_20_tx_max_nss_for_mcs_12_and_13 << 28);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp194__ = 0U;
		tmp194__ |= (pSrc->bw_le_80_rx_max_nss_for_mcs_0_to_9 << 0);
		tmp194__ |= (pSrc->bw_le_80_tx_max_nss_for_mcs_0_to_9 << 4);
		tmp194__ |= (pSrc->bw_le_80_rx_max_nss_for_mcs_10_and_11 << 8);
		tmp194__ |= (pSrc->bw_le_80_tx_max_nss_for_mcs_10_and_11 << 12);
		tmp194__ |= (pSrc->bw_le_80_rx_max_nss_for_mcs_12_and_13 << 16);
		tmp194__ |= (pSrc->bw_le_80_tx_max_nss_for_mcs_12_and_13 << 20);
		tmp194__ |= (pSrc->bw_160_rx_max_nss_for_mcs_0_to_9 << 24);
		tmp194__ |= (pSrc->bw_160_tx_max_nss_for_mcs_0_to_9 << 28);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp195__ = 0U;
		tmp195__ |= (pSrc->bw_160_rx_max_nss_for_mcs_10_and_11 << 0);
		tmp195__ |= (pSrc->bw_160_tx_max_nss_for_mcs_10_and_11 << 4);
		tmp195__ |= (pSrc->bw_160_rx_max_nss_for_mcs_12_and_13 << 8);
		tmp195__ |= (pSrc->bw_160_tx_max_nss_for_mcs_12_and_13 << 12);
		tmp195__ |= (pSrc->bw_320_rx_max_nss_for_mcs_0_to_9 << 16);
		tmp195__ |= (pSrc->bw_320_tx_max_nss_for_mcs_0_to_9 << 20);
		tmp195__ |= (pSrc->bw_320_rx_max_nss_for_mcs_10_and_11 << 24);
		tmp195__ |= (pSrc->bw_320_tx_max_nss_for_mcs_10_and_11 << 28);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp196__ = 0U;
		tmp196__ |= (pSrc->bw_320_rx_max_nss_for_mcs_12_and_13 << 0);
		tmp196__ |= (pSrc->bw_320_tx_max_nss_for_mcs_12_and_13 << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 106;
		++pBuf; ++(*pnConsumed);
		tmp197__ = 0U;
		tmp197__ |= (pSrc->eht_op_information_present << 0);
		tmp197__ |= (pSrc->disabled_sub_chan_bitmap_present << 1);
		tmp197__ |= (pSrc->reserved << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp198__ = 0U;
		tmp198__ |= (pSrc->channel_width << 0);
		tmp198__ |= (pSrc->reserved_1 << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					...
					uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 240;
		...
		++pBuf; ++(*pnConsumed);
		tmp199__ = 0U;
		tmp199__ |= (pSrc->public_key_identifiers_cnt << 0);
		tmp199__ |= (pSrc->realm_identifiers_cnt << 3);
		tmp199__ |= (pSrc->is_ip_config_supported << 6);
		tmp199__ |= (pSrc->is_cache_id_present << 7);
		tmp199__ |= (pSrc->is_hessid_present << 8);
		tmp199__ |= (pSrc->is_fils_sk_auth_supported << 9);
		tmp199__ |= (pSrc->is_fils_sk_auth_pfs_supported << 10);
		tmp199__ |= (pSrc->is_pk_auth_supported << 11);
		tmp199__ |= (pSrc->reserved << 12);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

		frameshtons(pCtx, pBuf, tmp199__, 0);
		*pnConsumed += 2;
		pBuf += 2;
		nBuf -=  2 ;
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 59;
		++pBuf; ++(*pnConsumed);
		tmp200__ = 0U;
		tmp200__ |= (pSrc->min_mpdu_start_spacing << 0);
		tmp200__ |= (pSrc->max_ampdu_len_exp << 3);
		tmp200__ |= (pSrc->max_mpdu_len << 6);
		tmp200__ |= (pSrc->sm_pow_save << 9);
		tmp200__ |= (pSrc->rd_responder << 11);
		tmp200__ |= (pSrc->rx_ant_pattern_consistency << 12);
		tmp200__ |= (pSrc->tx_ant_pattern_consistency << 13);
		tmp200__ |= (pSrc->reserved << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

		frameshtons(pCtx, pBuf, tmp200__, 0);
		*pnConsumed += 2;
		/* fieldsEndFlag  = 1 */
		nBuf -=  2 ;
		break;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 35;
		++pBuf; ++(*pnConsumed);
		tmp201__ = 0U;
		tmp201__ |= (pSrc->htc_he << 0);
		tmp201__ |= (pSrc->twt_request << 1);
		tmp201__ |= (pSrc->twt_responder << 2);
		tmp201__ |= (pSrc->fragmentation << 3);
		tmp201__ |= (pSrc->max_num_frag_msdu_amsdu_exp << 5);
		tmp201__ |= (pSrc->min_frag_size << 8);
		tmp201__ |= (pSrc->trigger_frm_mac_pad << 10);
		tmp201__ |= (pSrc->multi_tid_aggr_rx_supp << 12);
		tmp201__ |= (pSrc->he_link_adaptation << 15);
		tmp201__ |= (pSrc->all_ack << 17);
		tmp201__ |= (pSrc->trigd_rsp_sched << 18);
		tmp201__ |= (pSrc->a_bsr << 19);
		tmp201__ |= (pSrc->broadcast_twt << 20);
		tmp201__ |= (pSrc->ba_32bit_bitmap << 21);
		tmp201__ |= (pSrc->mu_cascade << 22);
		tmp201__ |= (pSrc->ack_enabled_multitid << 23);
		tmp201__ |= (pSrc->reserved << 24);
		tmp201__ |= (pSrc->omi_a_ctrl << 25);
		tmp201__ |= (pSrc->ofdma_ra << 26);
		tmp201__ |= (pSrc->max_ampdu_len_exp_ext << 27);
		tmp201__ |= (pSrc->amsdu_frag << 29);
		tmp201__ |= (pSrc->flex_twt_sched << 30);
		tmp201__ |= (pSrc->rx_ctrl_frame << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp202__ = 0U;
		tmp202__ |= (pSrc->bsrp_ampdu_aggr << 0);
		tmp202__ |= (pSrc->qtp << 1);
		tmp202__ |= (pSrc->a_bqr << 2);
		tmp202__ |= (pSrc->spatial_reuse_param_rspder << 3);
		tmp202__ |= (pSrc->ndp_feedback_supp << 4);
		tmp202__ |= (pSrc->ops_supp << 5);
		tmp202__ |= (pSrc->amsdu_in_ampdu << 6);
		tmp202__ |= (pSrc->multi_tid_aggr_tx_supp << 7);
		tmp202__ |= (pSrc->he_sub_ch_sel_tx_supp << 10);
		tmp202__ |= (pSrc->ul_2x996_tone_ru_supp << 11);
		tmp202__ |= (pSrc->om_ctrl_ul_mu_data_dis_rx << 12);
		tmp202__ |= (pSrc->he_dynamic_smps << 13);
		tmp202__ |= (pSrc->punctured_sounding_supp << 14);
		tmp202__ |= (pSrc->ht_vht_trg_frm_rx_supp << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp203__ = 0U;
		tmp203__ |= (pSrc->reserved2 << 0);
		tmp203__ |= (pSrc->chan_width_0 << 1);
		tmp203__ |= (pSrc->chan_width_1 << 2);
		tmp203__ |= (pSrc->chan_width_2 << 3);
		tmp203__ |= (pSrc->chan_width_3 << 4);
		tmp203__ |= (pSrc->chan_width_4 << 5);
		tmp203__ |= (pSrc->chan_width_5 << 6);
		tmp203__ |= (pSrc->chan_width_6 << 7);
		tmp203__ |= (pSrc->rx_pream_puncturing << 8);
		tmp203__ |= (pSrc->device_class << 12);
		tmp203__ |= (pSrc->ldpc_coding << 13);
		tmp203__ |= (pSrc->he_1x_ltf_800_gi_ppdu << 14);
		tmp203__ |= (pSrc->midamble_tx_rx_max_nsts << 15);
		tmp203__ |= (pSrc->he_4x_ltf_3200_gi_ndp << 17);
		tmp203__ |= (pSrc->tb_ppdu_tx_stbc_lt_80mhz << 18);
		tmp203__ |= (pSrc->rx_stbc_lt_80mhz << 19);
		tmp203__ |= (pSrc->doppler << 20);
		tmp203__ |= (pSrc->ul_mu << 22);
		tmp203__ |= (pSrc->dcm_enc_tx << 24);
		tmp203__ |= (pSrc->dcm_enc_rx << 27);
		tmp203__ |= (pSrc->ul_he_mu << 30);
		tmp203__ |= (pSrc->su_beamformer << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp204__ = 0U;
		tmp204__ |= (pSrc->su_beamformee << 0);
		tmp204__ |= (pSrc->mu_beamformer << 1);
		tmp204__ |= (pSrc->bfee_sts_lt_80 << 2);
		tmp204__ |= (pSrc->bfee_sts_gt_80 << 5);
		tmp204__ |= (pSrc->num_sounding_lt_80 << 8);
		tmp204__ |= (pSrc->num_sounding_gt_80 << 11);
		tmp204__ |= (pSrc->su_feedback_tone16 << 14);
		tmp204__ |= (pSrc->mu_feedback_tone16 << 15);
		tmp204__ |= (pSrc->codebook_su << 16);
		tmp204__ |= (pSrc->codebook_mu << 17);
		tmp204__ |= (pSrc->beamforming_feedback << 18);
		tmp204__ |= (pSrc->he_er_su_ppdu << 21);
		tmp204__ |= (pSrc->dl_mu_mimo_part_bw << 22);
		tmp204__ |= (pSrc->ppet_present << 23);
		tmp204__ |= (pSrc->srp << 24);
		tmp204__ |= (pSrc->power_boost << 25);
		tmp204__ |= (pSrc->he_ltf_800_gi_4x << 26);
		tmp204__ |= (pSrc->max_nc << 27);
		tmp204__ |= (pSrc->tb_ppdu_tx_stbc_gt_80mhz << 30);
		tmp204__ |= (pSrc->rx_stbc_gt_80mhz << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp205__ = 0U;
		tmp205__ |= (pSrc->er_he_ltf_800_gi_4x << 0);
		tmp205__ |= (pSrc->he_ppdu_20_in_40Mhz_2G << 1);
		tmp205__ |= (pSrc->he_ppdu_20_in_160_80p80Mhz << 2);
		tmp205__ |= (pSrc->he_ppdu_80_in_160_80p80Mhz << 3);
		tmp205__ |= (pSrc->er_1x_he_ltf_gi << 4);
		tmp205__ |= (pSrc->midamble_tx_rx_1x_he_ltf << 5);
		tmp205__ |= (pSrc->dcm_max_bw << 6);
		tmp205__ |= (pSrc->longer_than_16_he_sigb_ofdm_sym << 8);
		tmp205__ |= (pSrc->non_trig_cqi_feedback << 9);
		tmp205__ |= (pSrc->tx_1024_qam_lt_242_tone_ru << 10);
		tmp205__ |= (pSrc->rx_1024_qam_lt_242_tone_ru << 11);
		tmp205__ |= (pSrc->rx_full_bw_su_he_mu_compress_sigb << 12);
		tmp205__ |= (pSrc->rx_full_bw_su_he_mu_non_cmpr_sigb << 13);
		tmp205__ |= (pSrc->reserved3 << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
			      ...
			      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 36;
		++pBuf; ++(*pnConsumed);
		tmp206__ = 0U;
		tmp206__ |= (pSrc->default_pe << 0);
		tmp206__ |= (pSrc->twt_required << 3);
		tmp206__ |= (pSrc->txop_rts_threshold << 4);
		tmp206__ |= (pSrc->vht_oper_present << 14);
		tmp206__ |= (pSrc->co_located_bss << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp207__ = 0U;
		tmp207__ |= (pSrc->er_su_disable << 0);
		tmp207__ |= (pSrc->oper_info_6g_present << 1);
		tmp207__ |= (pSrc->reserved2 << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp208__ = 0U;
		tmp208__ |= (pSrc->bss_color << 0);
		tmp208__ |= (pSrc->partial_bss_col << 6);
		tmp208__ |= (pSrc->bss_col_disabled << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->oper_info_6g_present) {
			...
			case 1:
				...
				*pnConsumed += 1;
				pBuf += 1;
				tmp209__ = 0U;
				tmp209__ |= (pSrc->oper_info_6g.info.ch_width << 0);
				tmp209__ |= (pSrc->oper_info_6g.info.dup_bcon << 2);
				tmp209__ |= (pSrc->oper_info_6g.info.reg_info << 3);
				tmp209__ |= (pSrc->oper_info_6g.info.reserved << 6);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp212__ = 0U;
		tmp212__ |= (pSrc->acbe_aifsn << 0);
		tmp212__ |= (pSrc->acbe_acm << 4);
		tmp212__ |= (pSrc->acbe_aci << 5);
		tmp212__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp213__ = 0U;
		tmp213__ |= (pSrc->acbe_acwmin << 0);
		tmp213__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp214__ = 0U;
		tmp214__ |= (pSrc->acbk_aifsn << 0);
		tmp214__ |= (pSrc->acbk_acm << 4);
		tmp214__ |= (pSrc->acbk_aci << 5);
		tmp214__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp215__ = 0U;
		tmp215__ |= (pSrc->acbk_acwmin << 0);
		tmp215__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp216__ = 0U;
		tmp216__ |= (pSrc->acvi_aifsn << 0);
		tmp216__ |= (pSrc->acvi_acm << 4);
		tmp216__ |= (pSrc->acvi_aci << 5);
		tmp216__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp217__ = 0U;
		tmp217__ |= (pSrc->acvi_acwmin << 0);
		tmp217__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp218__ = 0U;
		tmp218__ |= (pSrc->acvo_aifsn << 0);
		tmp218__ |= (pSrc->acvo_acm << 4);
		tmp218__ |= (pSrc->acvo_aci << 5);
		tmp218__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp219__ = 0U;
		tmp219__ |= (pSrc->acvo_acwmin << 0);
		tmp219__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
						...
						uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 201;
		...
		++pBuf; ++(*pnConsumed);
		tmp220__ = 0U;
		tmp220__ |= (pSrc->tbtt_type << 0);
		tmp220__ |= (pSrc->filtered_neighbor_ap << 2);
		tmp220__ |= (pSrc->reserved << 3);
		tmp220__ |= (pSrc->tbtt_info_count << 4);
		tmp220__ |= (pSrc->tbtt_info_len << 8);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

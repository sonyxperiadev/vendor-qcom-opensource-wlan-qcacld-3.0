					  ...
					  bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->public_key_identifiers_cnt = tmp88__ >> 0 & 0x7;
	pDst->realm_identifiers_cnt = tmp88__ >> 3 & 0x7;
	pDst->is_ip_config_supported = tmp88__ >> 6 & 0x1;
	pDst->is_cache_id_present = tmp88__ >> 7 & 0x1;
	pDst->is_hessid_present = tmp88__ >> 8 & 0x1;
	pDst->is_fils_sk_auth_supported = tmp88__ >> 9 & 0x1;
	pDst->is_fils_sk_auth_pfs_supported = tmp88__ >> 10 & 0x1;
	pDst->is_pk_auth_supported = tmp88__ >> 11 & 0x1;
	pDst->reserved = tmp88__ >> 12 & 0xf;
					   ...
					   bool append_ie)
{
	...
	pDst->min_mpdu_start_spacing = tmp89__ >> 0 & 0x7;
	pDst->max_ampdu_len_exp = tmp89__ >> 3 & 0x7;
	pDst->max_mpdu_len = tmp89__ >> 6 & 0x7;
	pDst->sm_pow_save = tmp89__ >> 9 & 0x3;
	pDst->rd_responder = tmp89__ >> 11 & 0x1;
	pDst->rx_ant_pattern_consistency = tmp89__ >> 12 & 0x1;
	pDst->tx_ant_pattern_consistency = tmp89__ >> 13 & 0x1;
	pDst->reserved = tmp89__ >> 14 & 0x3;
	(void)pCtx;
	return status;
				 ...
				 bool append_ie)
{
	...
	pBuf += 4;
	ielen -= 4;
	pDst->htc_he = tmp90__ >> 0 & 0x1;
	pDst->twt_request = tmp90__ >> 1 & 0x1;
	pDst->twt_responder = tmp90__ >> 2 & 0x1;
	pDst->fragmentation = tmp90__ >> 3 & 0x3;
	pDst->max_num_frag_msdu_amsdu_exp = tmp90__ >> 5 & 0x7;
	pDst->min_frag_size = tmp90__ >> 8 & 0x3;
	pDst->trigger_frm_mac_pad = tmp90__ >> 10 & 0x3;
	pDst->multi_tid_aggr_rx_supp = tmp90__ >> 12 & 0x7;
	pDst->he_link_adaptation = tmp90__ >> 15 & 0x3;
	pDst->all_ack = tmp90__ >> 17 & 0x1;
	pDst->trigd_rsp_sched = tmp90__ >> 18 & 0x1;
	pDst->a_bsr = tmp90__ >> 19 & 0x1;
	pDst->broadcast_twt = tmp90__ >> 20 & 0x1;
	pDst->ba_32bit_bitmap = tmp90__ >> 21 & 0x1;
	pDst->mu_cascade = tmp90__ >> 22 & 0x1;
	pDst->ack_enabled_multitid = tmp90__ >> 23 & 0x1;
	pDst->reserved = tmp90__ >> 24 & 0x1;
	pDst->omi_a_ctrl = tmp90__ >> 25 & 0x1;
	pDst->ofdma_ra = tmp90__ >> 26 & 0x1;
	pDst->max_ampdu_len_exp_ext = tmp90__ >> 27 & 0x3;
	pDst->amsdu_frag = tmp90__ >> 29 & 0x1;
	pDst->flex_twt_sched = tmp90__ >> 30 & 0x1;
	pDst->rx_ctrl_frame = tmp90__ >> 31 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 2;
	ielen -= 2;
	pDst->bsrp_ampdu_aggr = tmp91__ >> 0 & 0x1;
	pDst->qtp = tmp91__ >> 1 & 0x1;
	pDst->a_bqr = tmp91__ >> 2 & 0x1;
	pDst->spatial_reuse_param_rspder = tmp91__ >> 3 & 0x1;
	pDst->ndp_feedback_supp = tmp91__ >> 4 & 0x1;
	pDst->ops_supp = tmp91__ >> 5 & 0x1;
	pDst->amsdu_in_ampdu = tmp91__ >> 6 & 0x1;
	pDst->multi_tid_aggr_tx_supp = tmp91__ >> 7 & 0x7;
	pDst->he_sub_ch_sel_tx_supp = tmp91__ >> 10 & 0x1;
	pDst->ul_2x996_tone_ru_supp = tmp91__ >> 11 & 0x1;
	pDst->om_ctrl_ul_mu_data_dis_rx = tmp91__ >> 12 & 0x1;
	pDst->he_dynamic_smps = tmp91__ >> 13 & 0x1;
	pDst->punctured_sounding_supp = tmp91__ >> 14 & 0x1;
	pDst->ht_vht_trg_frm_rx_supp = tmp91__ >> 15 & 0x1;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->reserved2 = tmp92__ >> 0 & 0x1;
	pDst->chan_width_0 = tmp92__ >> 1 & 0x1;
	pDst->chan_width_1 = tmp92__ >> 2 & 0x1;
	pDst->chan_width_2 = tmp92__ >> 3 & 0x1;
	pDst->chan_width_3 = tmp92__ >> 4 & 0x1;
	pDst->chan_width_4 = tmp92__ >> 5 & 0x1;
	pDst->chan_width_5 = tmp92__ >> 6 & 0x1;
	pDst->chan_width_6 = tmp92__ >> 7 & 0x1;
	pDst->rx_pream_puncturing = tmp92__ >> 8 & 0xf;
	pDst->device_class = tmp92__ >> 12 & 0x1;
	pDst->ldpc_coding = tmp92__ >> 13 & 0x1;
	pDst->he_1x_ltf_800_gi_ppdu = tmp92__ >> 14 & 0x1;
	pDst->midamble_tx_rx_max_nsts = tmp92__ >> 15 & 0x3;
	pDst->he_4x_ltf_3200_gi_ndp = tmp92__ >> 17 & 0x1;
	pDst->tb_ppdu_tx_stbc_lt_80mhz = tmp92__ >> 18 & 0x1;
	pDst->rx_stbc_lt_80mhz = tmp92__ >> 19 & 0x1;
	pDst->doppler = tmp92__ >> 20 & 0x3;
	pDst->ul_mu = tmp92__ >> 22 & 0x3;
	pDst->dcm_enc_tx = tmp92__ >> 24 & 0x7;
	pDst->dcm_enc_rx = tmp92__ >> 27 & 0x7;
	pDst->ul_he_mu = tmp92__ >> 30 & 0x1;
	pDst->su_beamformer = tmp92__ >> 31 & 0x1;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->su_beamformee = tmp93__ >> 0 & 0x1;
	pDst->mu_beamformer = tmp93__ >> 1 & 0x1;
	pDst->bfee_sts_lt_80 = tmp93__ >> 2 & 0x7;
	pDst->bfee_sts_gt_80 = tmp93__ >> 5 & 0x7;
	pDst->num_sounding_lt_80 = tmp93__ >> 8 & 0x7;
	pDst->num_sounding_gt_80 = tmp93__ >> 11 & 0x7;
	pDst->su_feedback_tone16 = tmp93__ >> 14 & 0x1;
	pDst->mu_feedback_tone16 = tmp93__ >> 15 & 0x1;
	pDst->codebook_su = tmp93__ >> 16 & 0x1;
	pDst->codebook_mu = tmp93__ >> 17 & 0x1;
	pDst->beamforming_feedback = tmp93__ >> 18 & 0x7;
	pDst->he_er_su_ppdu = tmp93__ >> 21 & 0x1;
	pDst->dl_mu_mimo_part_bw = tmp93__ >> 22 & 0x1;
	pDst->ppet_present = tmp93__ >> 23 & 0x1;
	pDst->srp = tmp93__ >> 24 & 0x1;
	pDst->power_boost = tmp93__ >> 25 & 0x1;
	pDst->he_ltf_800_gi_4x = tmp93__ >> 26 & 0x1;
	pDst->max_nc = tmp93__ >> 27 & 0x7;
	pDst->tb_ppdu_tx_stbc_gt_80mhz = tmp93__ >> 30 & 0x1;
	pDst->rx_stbc_gt_80mhz = tmp93__ >> 31 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 2;
	ielen -= 2;
	pDst->er_he_ltf_800_gi_4x = tmp94__ >> 0 & 0x1;
	pDst->he_ppdu_20_in_40Mhz_2G = tmp94__ >> 1 & 0x1;
	pDst->he_ppdu_20_in_160_80p80Mhz = tmp94__ >> 2 & 0x1;
	pDst->he_ppdu_80_in_160_80p80Mhz = tmp94__ >> 3 & 0x1;
	pDst->er_1x_he_ltf_gi = tmp94__ >> 4 & 0x1;
	pDst->midamble_tx_rx_1x_he_ltf = tmp94__ >> 5 & 0x1;
	pDst->dcm_max_bw = tmp94__ >> 6 & 0x3;
	pDst->longer_than_16_he_sigb_ofdm_sym = tmp94__ >> 8 & 0x1;
	pDst->non_trig_cqi_feedback = tmp94__ >> 9 & 0x1;
	pDst->tx_1024_qam_lt_242_tone_ru = tmp94__ >> 10 & 0x1;
	pDst->rx_1024_qam_lt_242_tone_ru = tmp94__ >> 11 & 0x1;
	pDst->rx_full_bw_su_he_mu_compress_sigb = tmp94__ >> 12 & 0x1;
	pDst->rx_full_bw_su_he_mu_non_cmpr_sigb = tmp94__ >> 13 & 0x1;
	pDst->reserved3 = tmp94__ >> 14 & 0x3;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
				 ...
				 bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->default_pe = tmp95__ >> 0 & 0x7;
	pDst->twt_required = tmp95__ >> 3 & 0x1;
	pDst->txop_rts_threshold = tmp95__ >> 4 & 0x3ff;
	pDst->vht_oper_present = tmp95__ >> 14 & 0x1;
	pDst->co_located_bss = tmp95__ >> 15 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->er_su_disable = tmp96__ >> 0 & 0x1;
	pDst->oper_info_6g_present = tmp96__ >> 1 & 0x1;
	pDst->reserved2 = tmp96__ >> 2 & 0x3f;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->bss_color = tmp97__ >> 0 & 0x3f;
	pDst->partial_bss_col = tmp97__ >> 6 & 0x1;
	pDst->bss_col_disabled = tmp97__ >> 7 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	case 1:
		...
		pBuf += 1;
		ielen -= 1;
		pDst->oper_info_6g.info.ch_width = tmp98__ >> 0 & 0x3;
		pDst->oper_info_6g.info.dup_bcon = tmp98__ >> 2 & 0x1;
		pDst->oper_info_6g.info.reg_info = tmp98__ >> 3 & 0x7;
		pDst->oper_info_6g.info.reserved = tmp98__ >> 6 & 0x3;
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
			return DOT11F_INCOMPLETE_IE;
		}
					 ...
					 bool append_ie)
{
	...
	pBuf += 1;
	ielen -= 1;
	pDst->dgaf_dis = tmp99__ >> 0 & 0x1;
	pDst->hs_id_present = tmp99__ >> 1 & 0x3;
	pDst->reserved = tmp99__ >> 3 & 0x1;
	pDst->release_num = tmp99__ >> 4 & 0xf;
	if (!ielen) {
		return 0U;
	} else {
						 ...
						 bool append_ie)
{
	...
	tmp100__ = *pBuf;
	pDst->info_request = tmp100__ >> 0 & 0x1;
	pDst->forty_mhz_intolerant = tmp100__ >> 1 & 0x1;
	pDst->twenty_mhz_bsswidth_req = tmp100__ >> 2 & 0x1;
	pDst->obss_scan_exemption_req = tmp100__ >> 3 & 0x1;
	pDst->obss_scan_exemption_grant = tmp100__ >> 4 & 0x1;
	pDst->unused = tmp100__ >> 5 & 0x7;
	(void)pCtx;
	return status;
				 ...
				 bool append_ie)
{
	...
	framesntohs(pCtx, &tmp101__, pBuf, 0);
	pBuf += 2;
	ielen -= 2;
	...
	case 1:
		...
		pBuf += 1;
		ielen -= 1;
		pDst->link_id_info.info.link_id = tmp102__ >> 0 & 0xf;
		pDst->link_id_info.info.reserved = tmp102__ >> 4 & 0xf;
		break;
	}
	...
	case 1:
		...
		pBuf += 2;
		ielen -= 2;
		pDst->medium_sync_delay_info.info.medium_sync_duration = tmp103__ >> 0 & 0xff;
		pDst->medium_sync_delay_info.info.medium_sync_ofdm_ed_thresh = tmp103__ >> 8 & 0xf;
		pDst->medium_sync_delay_info.info.medium_sync_max_txop_num = tmp103__ >> 12 & 0xf;
		break;
	}
	...
	case 1:
		...
		framesntohs(pCtx, &tmp104__, pBuf, 0);
		pBuf += 2;
		ielen -= 2;
		...
		pBuf += 1;
		ielen -= 1;
		pDst->eml_capabilities.info.emlmr_rx_nss = tmp105__ >> 0 & 0xf;
		pDst->eml_capabilities.info.emlmr_tx_nss = tmp105__ >> 4 & 0xf;
		break;
	}
	...
	case 1:
		...
		framesntohs(pCtx, &tmp106__, pBuf, 0);
		pBuf += 2;
		ielen -= 2;
		pDst->mld_capabilities.info.max_simultaneous_link_num = tmp106__ >> 0 & 0xf;
					    ...
					    bool append_ie)
{
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbe_aifsn = tmp107__ >> 0 & 0xf;
	pDst->acbe_acm = tmp107__ >> 4 & 0x1;
	pDst->acbe_aci = tmp107__ >> 5 & 0x3;
	pDst->unused1 = tmp107__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbe_acwmin = tmp108__ >> 0 & 0xf;
	pDst->acbe_acwmax = tmp108__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbk_aifsn = tmp109__ >> 0 & 0xf;
	pDst->acbk_acm = tmp109__ >> 4 & 0x1;
	pDst->acbk_aci = tmp109__ >> 5 & 0x3;
	pDst->unused2 = tmp109__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbk_acwmin = tmp110__ >> 0 & 0xf;
	pDst->acbk_acwmax = tmp110__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvi_aifsn = tmp111__ >> 0 & 0xf;
	pDst->acvi_acm = tmp111__ >> 4 & 0x1;
	pDst->acvi_aci = tmp111__ >> 5 & 0x3;
	pDst->unused3 = tmp111__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvi_acwmin = tmp112__ >> 0 & 0xf;
	pDst->acvi_acwmax = tmp112__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvo_aifsn = tmp113__ >> 0 & 0xf;
	pDst->acvo_acm = tmp113__ >> 4 & 0x1;
	pDst->acvo_aci = tmp113__ >> 5 & 0x3;
	pDst->unused4 = tmp113__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvo_acwmin = tmp114__ >> 0 & 0xf;
	pDst->acvo_acwmax = tmp114__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
						  ...
						  bool append_ie)
{
	...
	framesntohs(pCtx, &tmp115__, pBuf, 0);
	pBuf += 2;
	ielen -= 2;
	pDst->tbtt_type = tmp115__ >> 0 & 0x3;
	pDst->filtered_neighbor_ap = tmp115__ >> 2 & 0x1;
	pDst->reserved = tmp115__ >> 3 & 0x1;
	pDst->tbtt_info_count = tmp115__ >> 4 & 0xf;
	pDst->tbtt_info_len = tmp115__ >> 8 & 0xff;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	case 16:
		...
		pBuf += 4;
		ielen -= 4;
		pDst->tbtt_info.tbtt_info_16.mld_id = tmp116__ >> 0 & 0xff;
		pDst->tbtt_info.tbtt_info_16.link_id = tmp116__ >> 8 & 0xf;
		pDst->tbtt_info.tbtt_info_16.bss_param_change_cnt = tmp116__ >> 12 & 0xff;
		pDst->tbtt_info.tbtt_info_16.reserved = tmp116__ >> 20 & 0xfff;
		break;
	}
	(void)pCtx;
	return status;
				 ...
				 uint8_t *pBuf)
{
	...
	tmp117__ = 0U;
	tmp117__ |= (pSrc->ess << 0);
	tmp117__ |= (pSrc->ibss << 1);
	tmp117__ |= (pSrc->cfPollable << 2);
	tmp117__ |= (pSrc->cfPollReq << 3);
	tmp117__ |= (pSrc->privacy << 4);
	tmp117__ |= (pSrc->shortPreamble << 5);
	tmp117__ |= (pSrc->criticalUpdateFlag << 6);
	tmp117__ |= (pSrc->channelAgility << 7);
	tmp117__ |= (pSrc->spectrumMgt << 8);
	tmp117__ |= (pSrc->qos << 9);
	tmp117__ |= (pSrc->shortSlotTime << 10);
	tmp117__ |= (pSrc->apsd << 11);
	tmp117__ |= (pSrc->rrm << 12);
	tmp117__ |= (pSrc->dsssOfdm << 13);
	tmp117__ |= (pSrc->delayedBA << 14);
	tmp117__ |= (pSrc->immediateBA << 15);
				  ...
				  uint8_t *pBuf)
{
	uint8_t tmp118__;
	tmp118__ = 0U;
	tmp118__ |= (pSrc->chanWidth << 0);
	tmp118__ |= (pSrc->reserved << 2);
	tmp118__ |= (pSrc->rxNSS << 4);
	tmp118__ |= (pSrc->rxNSSType << 7);
	*pBuf = tmp118__;
	(void)pCtx;
				   ...
				   uint8_t *pBuf)
{
	uint8_t tmp119__;
	tmp119__ = 0U;
	tmp119__ |= (pSrc->PowerSave_En << 0);
	tmp119__ |= (pSrc->Mode << 1);
			   ...
			   uint8_t *pBuf)
{
	...
	tmp120__ |= (pSrc->schedule << 16);
	tmp120__ |= (pSrc->unused << 17);
				    ...
				    uint8_t *pBuf)
{
	uint16_t tmp121__;
	tmp121__ = 0U;
	tmp121__ |= (pSrc->amsdu_supp << 0);
	tmp121__ |= (pSrc->policy << 1);
	tmp121__ |= (pSrc->tid << 2);
	tmp121__ |= (pSrc->buff_size << 6);
				    ...
				    uint8_t *pBuf)
{
	uint16_t tmp123__;
	tmp123__ = 0U;
	tmp123__ |= (pSrc->reserved << 0);
	tmp123__ |= (pSrc->initiator << 11);
	tmp123__ |= (pSrc->tid << 12);
					       ...
					       uint8_t *pBuf)
{
	uint32_t tmp124__;
	tmp124__ = 0U;
	tmp124__ |= (pSrc->switch_mode << 0);
	tmp124__ |= (pSrc->op_class << 8);
	tmp124__ |= (pSrc->new_channel << 16);
	tmp124__ |= (pSrc->switch_count << 24);
	frameshtonl(pCtx, pBuf, tmp124__, 0);
	(void)pCtx;
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 101;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp127__ = 0U;
		tmp127__ |= (pSrc->oce_release << 0);
		tmp127__ |= (pSrc->is_sta_cfon << 3);
		tmp127__ |= (pSrc->non_oce_ap_present << 4);
		tmp127__ |= (pSrc->reserved << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					     ...
					     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 103;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp128__ = 0U;
		tmp128__ |= (pSrc->downlink_av_cap << 0);
		tmp128__ |= (pSrc->uplink_av_cap << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 70;
		...
		++pBuf; ++(*pnConsumed);
		tmp130__ = 0U;
		tmp130__ |= (pSrc->LinkMeasurement << 0);
		tmp130__ |= (pSrc->NeighborRpt << 1);
		tmp130__ |= (pSrc->parallel << 2);
		tmp130__ |= (pSrc->repeated << 3);
		tmp130__ |= (pSrc->BeaconPassive << 4);
		tmp130__ |= (pSrc->BeaconActive << 5);
		tmp130__ |= (pSrc->BeaconTable << 6);
		tmp130__ |= (pSrc->BeaconRepCond << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp131__ = 0U;
		tmp131__ |= (pSrc->FrameMeasurement << 0);
		tmp131__ |= (pSrc->ChannelLoad << 1);
		tmp131__ |= (pSrc->NoiseHistogram << 2);
		tmp131__ |= (pSrc->statistics << 3);
		tmp131__ |= (pSrc->LCIMeasurement << 4);
		tmp131__ |= (pSrc->LCIAzimuth << 5);
		tmp131__ |= (pSrc->TCMCapability << 6);
		tmp131__ |= (pSrc->triggeredTCM << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp132__ = 0U;
		tmp132__ |= (pSrc->APChanReport << 0);
		tmp132__ |= (pSrc->RRMMIBEnabled << 1);
		tmp132__ |= (pSrc->operatingChanMax << 2);
		tmp132__ |= (pSrc->nonOperatinChanMax << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp133__ = 0U;
		tmp133__ |= (pSrc->MeasurementPilot << 0);
		tmp133__ |= (pSrc->MeasurementPilotEnabled << 3);
		tmp133__ |= (pSrc->NeighborTSFOffset << 4);
		tmp133__ |= (pSrc->RCPIMeasurement << 5);
		tmp133__ |= (pSrc->RSNIMeasurement << 6);
		tmp133__ |= (pSrc->BssAvgAccessDelay << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp134__ = 0U;
		tmp134__ |= (pSrc->BSSAvailAdmission << 0);
		tmp134__ |= (pSrc->AntennaInformation << 1);
		tmp134__ |= (pSrc->fine_time_meas_rpt << 2);
		tmp134__ |= (pSrc->lci_capability << 3);
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 15;
		...
		++pBuf; ++(*pnConsumed);
		tmp135__ = 0U;
		tmp135__ |= (pSrc->aggregation << 0);
		tmp135__ |= (pSrc->tsid << 1);
		tmp135__ |= (pSrc->direction << 5);
		tmp135__ |= (pSrc->reserved << 7);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
			      ...
			      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 13;
		...
		++pBuf; ++(*pnConsumed);
		tmp136__ = 0U;
		tmp136__ |= (pSrc->traffic_type << 0);
		tmp136__ |= (pSrc->tsid << 1);
		tmp136__ |= (pSrc->direction << 5);
		tmp136__ |= (pSrc->access_policy << 7);
		tmp136__ |= (pSrc->aggregation << 9);
		tmp136__ |= (pSrc->psb << 10);
		tmp136__ |= (pSrc->user_priority << 11);
		tmp136__ |= (pSrc->tsinfo_ack_pol << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp137__ = 0U;
		tmp137__ |= (pSrc->schedule << 0);
		tmp137__ |= (pSrc->unused << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp138__ = 0U;
		tmp138__ |= (pSrc->size << 0);
		tmp138__ |= (pSrc->fixed << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 191;
		...
		tmp139__ |= (pSrc->extended_nss_bw_supp << 30);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		tmp140__ |= (pSrc->max_nsts_total << 13);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		tmp141__ |= (pSrc->vht_extended_nss_bw_cap << 13);
		tmp141__ |= (pSrc->reserved << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				    ...
				    uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp142__ = 0U;
		tmp142__ |= (pSrc->aggregation << 0);
		tmp142__ |= (pSrc->tsid << 1);
		tmp142__ |= (pSrc->direction << 5);
		tmp142__ |= (pSrc->reserved << 7);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp143__ = 0U;
		tmp143__ |= (pSrc->traffic_type << 0);
		tmp143__ |= (pSrc->tsid << 1);
		tmp143__ |= (pSrc->direction << 5);
		tmp143__ |= (pSrc->access_policy << 7);
		tmp143__ |= (pSrc->aggregation << 9);
		tmp143__ |= (pSrc->psb << 10);
		tmp143__ |= (pSrc->user_priority << 11);
		tmp143__ |= (pSrc->tsinfo_ack_pol << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp144__ = 0U;
		tmp144__ |= (pSrc->tsinfo_rsvd << 0);
		tmp144__ |= (pSrc->burst_size_defn << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp145__ = 0U;
		tmp145__ |= (pSrc->size << 0);
		tmp145__ |= (pSrc->fixed << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
							   ...
							   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 2;
		...
		++pBuf; ++(*pnConsumed);
		tmp146__ = 0U;
		tmp146__ |= (pSrc->beacon_report_id << 0);
		tmp146__ |= (pSrc->fragment_id_number << 8);
		tmp146__ |= (pSrc->more_fragments << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 195;
		...
		++pBuf; ++(*pnConsumed);
		tmp149__ = 0U;
		tmp149__ |= (pSrc->max_tx_pwr_count << 0);
		tmp149__ |= (pSrc->max_tx_pwr_interpret << 3);
		tmp149__ |= (pSrc->max_tx_pwr_category << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				     ...
				     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp150__ = 0U;
		tmp150__ |= (pSrc->acbe_aifsn << 0);
		tmp150__ |= (pSrc->acbe_acm << 4);
		tmp150__ |= (pSrc->acbe_aci << 5);
		tmp150__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp151__ = 0U;
		tmp151__ |= (pSrc->acbe_acwmin << 0);
		tmp151__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp152__ = 0U;
		tmp152__ |= (pSrc->acbk_aifsn << 0);
		tmp152__ |= (pSrc->acbk_acm << 4);
		tmp152__ |= (pSrc->acbk_aci << 5);
		tmp152__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp153__ = 0U;
		tmp153__ |= (pSrc->acbk_acwmin << 0);
		tmp153__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp154__ = 0U;
		tmp154__ |= (pSrc->acvi_aifsn << 0);
		tmp154__ |= (pSrc->acvi_acm << 4);
		tmp154__ |= (pSrc->acvi_aci << 5);
		tmp154__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp155__ = 0U;
		tmp155__ |= (pSrc->acvi_acwmin << 0);
		tmp155__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp156__ = 0U;
		tmp156__ |= (pSrc->acvo_aifsn << 0);
		tmp156__ |= (pSrc->acvo_acm << 4);
		tmp156__ |= (pSrc->acvo_aci << 5);
		tmp156__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp157__ = 0U;
		tmp157__ |= (pSrc->acvo_acwmin << 0);
		tmp157__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 42;
		...
		++pBuf; ++(*pnConsumed);
		tmp158__ = 0U;
		tmp158__ |= (pSrc->non_erp_present << 0);
		tmp158__ |= (pSrc->use_prot << 1);
		tmp158__ |= (pSrc->barker_preamble << 2);
		tmp158__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 45;
		...
		++pBuf; ++(*pnConsumed);
		tmp161__ = 0U;
		tmp161__ |= (pSrc->advCodingCap << 0);
		tmp161__ |= (pSrc->supportedChannelWidthSet << 1);
		tmp161__ |= (pSrc->mimoPowerSave << 2);
		tmp161__ |= (pSrc->greenField << 4);
		tmp161__ |= (pSrc->shortGI20MHz << 5);
		tmp161__ |= (pSrc->shortGI40MHz << 6);
		tmp161__ |= (pSrc->txSTBC << 7);
		tmp161__ |= (pSrc->rxSTBC << 8);
		tmp161__ |= (pSrc->delayedBA << 10);
		tmp161__ |= (pSrc->maximalAMSDUsize << 11);
		tmp161__ |= (pSrc->dsssCckMode40MHz << 12);
		tmp161__ |= (pSrc->psmp << 13);
		tmp161__ |= (pSrc->stbcControlFrame << 14);
		tmp161__ |= (pSrc->lsigTXOPProtection << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp162__ = 0U;
		tmp162__ |= (pSrc->maxRxAMPDUFactor << 0);
		tmp162__ |= (pSrc->mpduDensity << 2);
		tmp162__ |= (pSrc->reserved1 << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 16;
		...
		tmp163__ = 0U;
		tmp163__ |= (pSrc->pco << 0);
		tmp163__ |= (pSrc->transitionTime << 1);
		tmp163__ |= (pSrc->reserved2 << 3);
		tmp163__ |= (pSrc->mcsFeedback << 8);
		tmp163__ |= (pSrc->reserved3 << 10);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp164__ = 0U;
		tmp164__ |= (pSrc->txBF << 0);
		tmp164__ |= (pSrc->rxStaggeredSounding << 1);
		tmp164__ |= (pSrc->txStaggeredSounding << 2);
		tmp164__ |= (pSrc->rxZLF << 3);
		tmp164__ |= (pSrc->txZLF << 4);
		tmp164__ |= (pSrc->implicitTxBF << 5);
		tmp164__ |= (pSrc->calibration << 6);
		tmp164__ |= (pSrc->explicitCSITxBF << 8);
		tmp164__ |= (pSrc->explicitUncompressedSteeringMatrix << 9);
		tmp164__ |= (pSrc->explicitBFCSIFeedback << 10);
		tmp164__ |= (pSrc->explicitUncompressedSteeringMatrixFeedback << 13);
		tmp164__ |= (pSrc->explicitCompressedSteeringMatrixFeedback << 16);
		tmp164__ |= (pSrc->csiNumBFAntennae << 19);
		tmp164__ |= (pSrc->uncompressedSteeringMatrixBFAntennae << 21);
		tmp164__ |= (pSrc->compressedSteeringMatrixBFAntennae << 23);
		tmp164__ |= (pSrc->reserved4 << 25);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;

		frameshtonl(pCtx, pBuf, tmp164__, 0);
		*pnConsumed += 4;
		pBuf += 4;
		nBuf -=  4 ;
		tmp165__ = 0U;
		tmp165__ |= (pSrc->antennaSelection << 0);
		tmp165__ |= (pSrc->explicitCSIFeedbackTx << 1);
		tmp165__ |= (pSrc->antennaIndicesFeedbackTx << 2);
		tmp165__ |= (pSrc->explicitCSIFeedback << 3);
		tmp165__ |= (pSrc->antennaIndicesFeedback << 4);
		tmp165__ |= (pSrc->rxAS << 5);
		tmp165__ |= (pSrc->txSoundingPPDUs << 6);
		tmp165__ |= (pSrc->reserved5 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp166__ = 0U;
		tmp166__ |= (pSrc->secondaryChannelOffset << 0);
		tmp166__ |= (pSrc->recommendedTxWidthSet << 2);
		tmp166__ |= (pSrc->rifsMode << 3);
		tmp166__ |= (pSrc->controlledAccessOnly << 4);
		tmp166__ |= (pSrc->serviceIntervalGranularity << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp167__ = 0U;
		tmp167__ |= (pSrc->opMode << 0);
		tmp167__ |= (pSrc->nonGFDevicesPresent << 2);
		tmp167__ |= (pSrc->transmitBurstLimit << 3);
		tmp167__ |= (pSrc->obssNonHTStaPresent << 4);
		tmp167__ |= (pSrc->chan_center_freq_seg2 << 5);
		tmp167__ |= (pSrc->reserved << 13);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp168__ = 0U;
		tmp168__ |= (pSrc->basicSTBCMCS << 0);
		tmp168__ |= (pSrc->dualCTSProtection << 7);
		tmp168__ |= (pSrc->secondaryBeacon << 8);
		tmp168__ |= (pSrc->lsigTXOPProtectionFullSupport << 9);
		tmp168__ |= (pSrc->pcoActive << 10);
		tmp168__ |= (pSrc->pcoPhase << 11);
		tmp168__ |= (pSrc->reserved2 << 12);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp169__ = 0U;
		tmp169__ |= (pSrc->late << 0);
		tmp169__ |= (pSrc->incapable << 1);
		tmp169__ |= (pSrc->refused << 2);
		tmp169__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->type) {
			...
			case 0:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp170__ = 0U;
				tmp170__ |= (pSrc->report.Basic.bss << 0);
				tmp170__ |= (pSrc->report.Basic.ofdm_preamble << 1);
				tmp170__ |= (pSrc->report.Basic.unid_signal << 2);
				tmp170__ |= (pSrc->report.Basic.rader << 3);
				tmp170__ |= (pSrc->report.Basic.unmeasured << 4);
				tmp170__ |= (pSrc->report.Basic.unused << 5);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
			...
			case 5:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp171__ = 0U;
				tmp171__ |= (pSrc->report.Beacon.condensed_PHY << 0);
				tmp171__ |= (pSrc->report.Beacon.reported_frame_type << 7);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp172__ = 0U;
		tmp172__ |= (pSrc->parallel << 0);
		tmp172__ |= (pSrc->enable << 1);
		tmp172__ |= (pSrc->request << 2);
		tmp172__ |= (pSrc->report << 3);
		tmp172__ |= (pSrc->durationMandatory << 4);
		tmp172__ |= (pSrc->unused << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp173__ = 0U;
		tmp173__ |= (pSrc->overDSCap << 0);
		tmp173__ |= (pSrc->resourceReqCap << 1);
		tmp173__ |= (pSrc->reserved << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 6;
		pBuf += 6;
		tmp174__ = 0U;
		tmp174__ |= (pSrc->APReachability << 0);
		tmp174__ |= (pSrc->Security << 2);
		tmp174__ |= (pSrc->KeyScope << 3);
		tmp174__ |= (pSrc->SpecMgmtCap << 4);
		tmp174__ |= (pSrc->QosCap << 5);
		tmp174__ |= (pSrc->apsd << 6);
		tmp174__ |= (pSrc->rrm << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp175__ = 0U;
		tmp175__ |= (pSrc->DelayedBA << 0);
		tmp175__ |= (pSrc->ImmBA << 1);
		tmp175__ |= (pSrc->MobilityDomain << 2);
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 199;
		...
		++pBuf; ++(*pnConsumed);
		tmp176__ = 0U;
		tmp176__ |= (pSrc->chanWidth << 0);
		tmp176__ |= (pSrc->vht_160_80p80_supp << 2);
		tmp176__ |= (pSrc->no_ldpc << 3);
		tmp176__ |= (pSrc->rxNSS << 4);
		tmp176__ |= (pSrc->rxNSSType << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 106;
		...
		++pBuf; ++(*pnConsumed);
		tmp177__ = 0U;
		tmp177__ |= (pSrc->ac_bk_traffic_aval << 0);
		tmp177__ |= (pSrc->ac_be_traffic_aval << 1);
		tmp177__ |= (pSrc->ac_vi_traffic_aval << 2);
		tmp177__ |= (pSrc->ac_vo_traffic_aval << 3);
		tmp177__ |= (pSrc->reserved << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 46;
		...
		++pBuf; ++(*pnConsumed);
		tmp178__ = 0U;
		tmp178__ |= (pSrc->count << 0);
		tmp178__ |= (pSrc->qack << 4);
		tmp178__ |= (pSrc->qreq << 5);
		tmp178__ |= (pSrc->txopreq << 6);
		tmp178__ |= (pSrc->reserved << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			     ...
			     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 4;
		pBuf += 4;
		tmp180__ = 0U;
		tmp180__ |= (pSrc->preauth << 0);
		tmp180__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp181__ = 0U;
		tmp181__ |= (pSrc->reserved << 0);
		tmp181__ |= (pSrc->qack << 4);
		tmp181__ |= (pSrc->queue_request << 5);
		tmp181__ |= (pSrc->txop_request << 6);
		tmp181__ |= (pSrc->more_ack << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp182__ = 0U;
		tmp182__ |= (pSrc->param_set_count << 0);
		tmp182__ |= (pSrc->reserved << 4);
		tmp182__ |= (pSrc->uapsd << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp183__ = 0U;
		tmp183__ |= (pSrc->acvo_uapsd << 0);
		tmp183__ |= (pSrc->acvi_uapsd << 1);
		tmp183__ |= (pSrc->acbk_uapsd << 2);
		tmp183__ |= (pSrc->acbe_uapsd << 3);
		tmp183__ |= (pSrc->reserved1 << 4);
		tmp183__ |= (pSrc->max_sp_length << 5);
		tmp183__ |= (pSrc->reserved2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp184__ = 0U;
		tmp184__ |= (pSrc->acbe_aifsn << 0);
		tmp184__ |= (pSrc->acbe_acm << 4);
		tmp184__ |= (pSrc->acbe_aci << 5);
		tmp184__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp185__ = 0U;
		tmp185__ |= (pSrc->acbe_acwmin << 0);
		tmp185__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp186__ = 0U;
		tmp186__ |= (pSrc->acbk_aifsn << 0);
		tmp186__ |= (pSrc->acbk_acm << 4);
		tmp186__ |= (pSrc->acbk_aci << 5);
		tmp186__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp187__ = 0U;
		tmp187__ |= (pSrc->acbk_acwmin << 0);
		tmp187__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp188__ = 0U;
		tmp188__ |= (pSrc->acvi_aifsn << 0);
		tmp188__ |= (pSrc->acvi_acm << 4);
		tmp188__ |= (pSrc->acvi_aci << 5);
		tmp188__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp189__ = 0U;
		tmp189__ |= (pSrc->acvi_acwmin << 0);
		tmp189__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp190__ = 0U;
		tmp190__ |= (pSrc->acvo_aifsn << 0);
		tmp190__ |= (pSrc->acvo_acm << 4);
		tmp190__ |= (pSrc->acvo_aci << 5);
		tmp190__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp191__ = 0U;
		tmp191__ |= (pSrc->acvo_acwmin << 0);
		tmp191__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp193__ = 0U;
		tmp193__ |= (pSrc->new_color << 0);
		tmp193__ |= (pSrc->reserved << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					    ...
					    uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp194__ = 0U;
		tmp194__ |= (pSrc->prot_keep_alive_reqd << 0);
		tmp194__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 108;
		++pBuf; ++(*pnConsumed);
		tmp195__ = 0U;
		tmp195__ |= (pSrc->epcs_pri_access << 0);
		tmp195__ |= (pSrc->eht_om_ctl << 1);
		tmp195__ |= (pSrc->triggered_txop_sharing_mode1 << 2);
		tmp195__ |= (pSrc->triggered_txop_sharing_mode2 << 3);
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp196__ = 0U;
		tmp196__ |= (pSrc->reserved2 << 0);
		tmp196__ |= (pSrc->support_320mhz_6ghz << 1);
		tmp196__ |= (pSrc->ru_242tone_wt_20mhz << 2);
		tmp196__ |= (pSrc->ndp_4x_eht_ltf_3dot2_us_gi << 3);
		tmp196__ |= (pSrc->partial_bw_mu_mimo << 4);
		tmp196__ |= (pSrc->su_beamformer << 5);
		tmp196__ |= (pSrc->su_beamformee << 6);
		tmp196__ |= (pSrc->bfee_ss_le_80mhz << 7);
		tmp196__ |= (pSrc->bfee_ss_160mhz << 10);
		tmp196__ |= (pSrc->bfee_ss_320mhz << 13);
		tmp196__ |= (pSrc->num_sounding_dim_le_80mhz << 16);
		tmp196__ |= (pSrc->num_sounding_dim_160mhz << 19);
		tmp196__ |= (pSrc->num_sounding_dim_320mhz << 22);
		tmp196__ |= (pSrc->ng_16_su_feedback << 25);
		tmp196__ |= (pSrc->ng_16_mu_feedback << 26);
		tmp196__ |= (pSrc->cb_sz_4_2_su_feedback << 27);
		tmp196__ |= (pSrc->cb_sz_7_5_su_feedback << 28);
		tmp196__ |= (pSrc->trig_su_bforming_feedback << 29);
		tmp196__ |= (pSrc->trig_mu_bforming_partial_bw_feedback << 30);
		tmp196__ |= (pSrc->triggered_cqi_feedback << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp197__ = 0U;
		tmp197__ |= (pSrc->partial_bw_dl_mu_mimo << 0);
		tmp197__ |= (pSrc->psr_based_sr << 1);
		tmp197__ |= (pSrc->power_boost_factor << 2);
		tmp197__ |= (pSrc->eht_mu_ppdu_4x_ltf_0_8_us_gi << 3);
		tmp197__ |= (pSrc->max_nc << 4);
		tmp197__ |= (pSrc->non_trig_cqi_feedback << 8);
		tmp197__ |= (pSrc->tx_1024_4096_qam_lt_242_tone_ru << 9);
		tmp197__ |= (pSrc->rx_1024_4096_qam_lt_242_tone_ru << 10);
		tmp197__ |= (pSrc->ppet_present << 11);
		tmp197__ |= (pSrc->common_nominal_pkt_padding << 12);
		tmp197__ |= (pSrc->max_num_eht_ltf << 14);
		tmp197__ |= (pSrc->mcs_15 << 19);
		tmp197__ |= (pSrc->eht_dup_6ghz << 23);
		tmp197__ |= (pSrc->op_sta_rx_ndp_wider_bw_20mhz << 24);
		tmp197__ |= (pSrc->non_ofdma_ul_mu_mimo_le_80mhz << 25);
		tmp197__ |= (pSrc->non_ofdma_ul_mu_mimo_160mhz << 26);
		tmp197__ |= (pSrc->non_ofdma_ul_mu_mimo_320mhz << 27);
		tmp197__ |= (pSrc->mu_bformer_le_80mhz << 28);
		tmp197__ |= (pSrc->mu_bformer_160mhz << 29);
		tmp197__ |= (pSrc->mu_bformer_320mhz << 30);
		tmp197__ |= (pSrc->tb_sounding_feedback_rl << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp198__ = 0U;
		tmp198__ |= (pSrc->rx_1k_qam_in_wider_bw_dl_ofdma << 0);
		tmp198__ |= (pSrc->rx_4k_qam_in_wider_bw_dl_ofdma << 1);
		tmp198__ |= (pSrc->reserved3 << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 107;
		...
		tmp218__ |= (pSrc->link_id_info_present << 4);
		tmp218__ |= (pSrc->bss_param_change_cnt_present << 5);
		tmp218__ |= (pSrc->medium_sync_delay_info_present << 6);
		tmp218__ |= (pSrc->eml_capab_present << 7);
		tmp218__ |= (pSrc->mld_capab_present << 8);
		tmp218__ |= (pSrc->reserved_1 << 9);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 6;
		...
		if (pSrc->eml_capab_present) {
			...
			case 1:
				...
				tmp221__ |= (pSrc->eml_capabilities.info.emlsr_padding_delay << 1);
				tmp221__ |= (pSrc->eml_capabilities.info.emlsr_transition_delay << 4);
				tmp221__ |= (pSrc->eml_capabilities.info.emlmr_support << 7);
				tmp221__ |= (pSrc->eml_capabilities.info.emlmr_delay << 8);
				tmp221__ |= (pSrc->eml_capabilities.info.transition_timeout << 11);
				tmp221__ |= (pSrc->eml_capabilities.info.reserved << 15);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->mld_capab_present) {
			...
			case 1:
				...
				tmp223__ |= (pSrc->mld_capabilities.info.aar_support << 12);
				tmp223__ |= (pSrc->mld_capabilities.info.reserved << 13);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		case 16:
			...
			*pnConsumed += 1;
			pBuf += 1;
			tmp233__ = 0U;
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_16.mld_id << 0);
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_16.link_id << 8);
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_16.bss_param_change_cnt << 12);
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_16.reserved << 20);
			if (unlikely(nBuf < 4))
				return DOT11F_INCOMPLETE_IE;

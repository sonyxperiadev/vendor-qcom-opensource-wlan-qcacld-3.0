				 ...
				 bool append_ie)
{
	...
	pBuf += 1;
	ielen -= 1;
	pDst->disable_sub_chan_bitmap_present = tmp82__ >> 0 & 0x1;
	pDst->reserved2 = tmp82__ >> 1 & 0x7f;
					  ...
					  bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->public_key_identifiers_cnt = tmp83__ >> 0 & 0x7;
	pDst->realm_identifiers_cnt = tmp83__ >> 3 & 0x7;
	pDst->is_ip_config_supported = tmp83__ >> 6 & 0x1;
	pDst->is_cache_id_present = tmp83__ >> 7 & 0x1;
	pDst->is_hessid_present = tmp83__ >> 8 & 0x1;
	pDst->is_fils_sk_auth_supported = tmp83__ >> 9 & 0x1;
	pDst->is_fils_sk_auth_pfs_supported = tmp83__ >> 10 & 0x1;
	pDst->is_pk_auth_supported = tmp83__ >> 11 & 0x1;
	pDst->reserved = tmp83__ >> 12 & 0xf;
					   ...
					   bool append_ie)
{
	...
	pDst->min_mpdu_start_spacing = tmp84__ >> 0 & 0x7;
	pDst->max_ampdu_len_exp = tmp84__ >> 3 & 0x7;
	pDst->max_mpdu_len = tmp84__ >> 6 & 0x7;
	pDst->sm_pow_save = tmp84__ >> 9 & 0x3;
	pDst->rd_responder = tmp84__ >> 11 & 0x1;
	pDst->rx_ant_pattern_consistency = tmp84__ >> 12 & 0x1;
	pDst->tx_ant_pattern_consistency = tmp84__ >> 13 & 0x1;
	pDst->reserved = tmp84__ >> 14 & 0x3;
	(void)pCtx;
	return status;
				 ...
				 bool append_ie)
{
	...
	pBuf += 4;
	ielen -= 4;
	pDst->htc_he = tmp85__ >> 0 & 0x1;
	pDst->twt_request = tmp85__ >> 1 & 0x1;
	pDst->twt_responder = tmp85__ >> 2 & 0x1;
	pDst->fragmentation = tmp85__ >> 3 & 0x3;
	pDst->max_num_frag_msdu_amsdu_exp = tmp85__ >> 5 & 0x7;
	pDst->min_frag_size = tmp85__ >> 8 & 0x3;
	pDst->trigger_frm_mac_pad = tmp85__ >> 10 & 0x3;
	pDst->multi_tid_aggr_rx_supp = tmp85__ >> 12 & 0x7;
	pDst->he_link_adaptation = tmp85__ >> 15 & 0x3;
	pDst->all_ack = tmp85__ >> 17 & 0x1;
	pDst->trigd_rsp_sched = tmp85__ >> 18 & 0x1;
	pDst->a_bsr = tmp85__ >> 19 & 0x1;
	pDst->broadcast_twt = tmp85__ >> 20 & 0x1;
	pDst->ba_32bit_bitmap = tmp85__ >> 21 & 0x1;
	pDst->mu_cascade = tmp85__ >> 22 & 0x1;
	pDst->ack_enabled_multitid = tmp85__ >> 23 & 0x1;
	pDst->reserved = tmp85__ >> 24 & 0x1;
	pDst->omi_a_ctrl = tmp85__ >> 25 & 0x1;
	pDst->ofdma_ra = tmp85__ >> 26 & 0x1;
	pDst->max_ampdu_len_exp_ext = tmp85__ >> 27 & 0x3;
	pDst->amsdu_frag = tmp85__ >> 29 & 0x1;
	pDst->flex_twt_sched = tmp85__ >> 30 & 0x1;
	pDst->rx_ctrl_frame = tmp85__ >> 31 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 2;
	ielen -= 2;
	pDst->bsrp_ampdu_aggr = tmp86__ >> 0 & 0x1;
	pDst->qtp = tmp86__ >> 1 & 0x1;
	pDst->a_bqr = tmp86__ >> 2 & 0x1;
	pDst->spatial_reuse_param_rspder = tmp86__ >> 3 & 0x1;
	pDst->ndp_feedback_supp = tmp86__ >> 4 & 0x1;
	pDst->ops_supp = tmp86__ >> 5 & 0x1;
	pDst->amsdu_in_ampdu = tmp86__ >> 6 & 0x1;
	pDst->multi_tid_aggr_tx_supp = tmp86__ >> 7 & 0x7;
	pDst->he_sub_ch_sel_tx_supp = tmp86__ >> 10 & 0x1;
	pDst->ul_2x996_tone_ru_supp = tmp86__ >> 11 & 0x1;
	pDst->om_ctrl_ul_mu_data_dis_rx = tmp86__ >> 12 & 0x1;
	pDst->he_dynamic_smps = tmp86__ >> 13 & 0x1;
	pDst->punctured_sounding_supp = tmp86__ >> 14 & 0x1;
	pDst->ht_vht_trg_frm_rx_supp = tmp86__ >> 15 & 0x1;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->reserved2 = tmp87__ >> 0 & 0x1;
	pDst->chan_width_0 = tmp87__ >> 1 & 0x1;
	pDst->chan_width_1 = tmp87__ >> 2 & 0x1;
	pDst->chan_width_2 = tmp87__ >> 3 & 0x1;
	pDst->chan_width_3 = tmp87__ >> 4 & 0x1;
	pDst->chan_width_4 = tmp87__ >> 5 & 0x1;
	pDst->chan_width_5 = tmp87__ >> 6 & 0x1;
	pDst->chan_width_6 = tmp87__ >> 7 & 0x1;
	pDst->rx_pream_puncturing = tmp87__ >> 8 & 0xf;
	pDst->device_class = tmp87__ >> 12 & 0x1;
	pDst->ldpc_coding = tmp87__ >> 13 & 0x1;
	pDst->he_1x_ltf_800_gi_ppdu = tmp87__ >> 14 & 0x1;
	pDst->midamble_tx_rx_max_nsts = tmp87__ >> 15 & 0x3;
	pDst->he_4x_ltf_3200_gi_ndp = tmp87__ >> 17 & 0x1;
	pDst->tb_ppdu_tx_stbc_lt_80mhz = tmp87__ >> 18 & 0x1;
	pDst->rx_stbc_lt_80mhz = tmp87__ >> 19 & 0x1;
	pDst->doppler = tmp87__ >> 20 & 0x3;
	pDst->ul_mu = tmp87__ >> 22 & 0x3;
	pDst->dcm_enc_tx = tmp87__ >> 24 & 0x7;
	pDst->dcm_enc_rx = tmp87__ >> 27 & 0x7;
	pDst->ul_he_mu = tmp87__ >> 30 & 0x1;
	pDst->su_beamformer = tmp87__ >> 31 & 0x1;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->su_beamformee = tmp88__ >> 0 & 0x1;
	pDst->mu_beamformer = tmp88__ >> 1 & 0x1;
	pDst->bfee_sts_lt_80 = tmp88__ >> 2 & 0x7;
	pDst->bfee_sts_gt_80 = tmp88__ >> 5 & 0x7;
	pDst->num_sounding_lt_80 = tmp88__ >> 8 & 0x7;
	pDst->num_sounding_gt_80 = tmp88__ >> 11 & 0x7;
	pDst->su_feedback_tone16 = tmp88__ >> 14 & 0x1;
	pDst->mu_feedback_tone16 = tmp88__ >> 15 & 0x1;
	pDst->codebook_su = tmp88__ >> 16 & 0x1;
	pDst->codebook_mu = tmp88__ >> 17 & 0x1;
	pDst->beamforming_feedback = tmp88__ >> 18 & 0x7;
	pDst->he_er_su_ppdu = tmp88__ >> 21 & 0x1;
	pDst->dl_mu_mimo_part_bw = tmp88__ >> 22 & 0x1;
	pDst->ppet_present = tmp88__ >> 23 & 0x1;
	pDst->srp = tmp88__ >> 24 & 0x1;
	pDst->power_boost = tmp88__ >> 25 & 0x1;
	pDst->he_ltf_800_gi_4x = tmp88__ >> 26 & 0x1;
	pDst->max_nc = tmp88__ >> 27 & 0x7;
	pDst->tb_ppdu_tx_stbc_gt_80mhz = tmp88__ >> 30 & 0x1;
	pDst->rx_stbc_gt_80mhz = tmp88__ >> 31 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 2;
	ielen -= 2;
	pDst->er_he_ltf_800_gi_4x = tmp89__ >> 0 & 0x1;
	pDst->he_ppdu_20_in_40Mhz_2G = tmp89__ >> 1 & 0x1;
	pDst->he_ppdu_20_in_160_80p80Mhz = tmp89__ >> 2 & 0x1;
	pDst->he_ppdu_80_in_160_80p80Mhz = tmp89__ >> 3 & 0x1;
	pDst->er_1x_he_ltf_gi = tmp89__ >> 4 & 0x1;
	pDst->midamble_tx_rx_1x_he_ltf = tmp89__ >> 5 & 0x1;
	pDst->dcm_max_bw = tmp89__ >> 6 & 0x3;
	pDst->longer_than_16_he_sigb_ofdm_sym = tmp89__ >> 8 & 0x1;
	pDst->non_trig_cqi_feedback = tmp89__ >> 9 & 0x1;
	pDst->tx_1024_qam_lt_242_tone_ru = tmp89__ >> 10 & 0x1;
	pDst->rx_1024_qam_lt_242_tone_ru = tmp89__ >> 11 & 0x1;
	pDst->rx_full_bw_su_he_mu_compress_sigb = tmp89__ >> 12 & 0x1;
	pDst->rx_full_bw_su_he_mu_non_cmpr_sigb = tmp89__ >> 13 & 0x1;
	pDst->reserved3 = tmp89__ >> 14 & 0x3;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
				 ...
				 bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->default_pe = tmp90__ >> 0 & 0x7;
	pDst->twt_required = tmp90__ >> 3 & 0x1;
	pDst->txop_rts_threshold = tmp90__ >> 4 & 0x3ff;
	pDst->vht_oper_present = tmp90__ >> 14 & 0x1;
	pDst->co_located_bss = tmp90__ >> 15 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->er_su_disable = tmp91__ >> 0 & 0x1;
	pDst->oper_info_6g_present = tmp91__ >> 1 & 0x1;
	pDst->reserved2 = tmp91__ >> 2 & 0x3f;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->bss_color = tmp92__ >> 0 & 0x3f;
	pDst->partial_bss_col = tmp92__ >> 6 & 0x1;
	pDst->bss_col_disabled = tmp92__ >> 7 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	case 1:
		...
		pBuf += 1;
		ielen -= 1;
		pDst->oper_info_6g.info.ch_width = tmp93__ >> 0 & 0x3;
		pDst->oper_info_6g.info.dup_bcon = tmp93__ >> 2 & 0x1;
		pDst->oper_info_6g.info.reg_info = tmp93__ >> 3 & 0x7;
		pDst->oper_info_6g.info.reserved = tmp93__ >> 6 & 0x3;
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
			return DOT11F_INCOMPLETE_IE;
		}
					 ...
					 bool append_ie)
{
	...
	pBuf += 1;
	ielen -= 1;
	pDst->dgaf_dis = tmp94__ >> 0 & 0x1;
	pDst->hs_id_present = tmp94__ >> 1 & 0x3;
	pDst->reserved = tmp94__ >> 3 & 0x1;
	pDst->release_num = tmp94__ >> 4 & 0xf;
	if (!ielen) {
		return 0U;
	} else {
						 ...
						 bool append_ie)
{
	...
	tmp95__ = *pBuf;
	pDst->info_request = tmp95__ >> 0 & 0x1;
	pDst->forty_mhz_intolerant = tmp95__ >> 1 & 0x1;
	pDst->twenty_mhz_bsswidth_req = tmp95__ >> 2 & 0x1;
	pDst->obss_scan_exemption_req = tmp95__ >> 3 & 0x1;
	pDst->obss_scan_exemption_grant = tmp95__ >> 4 & 0x1;
	pDst->unused = tmp95__ >> 5 & 0x7;
	(void)pCtx;
	return status;
				 ...
				 bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->type = tmp96__ >> 0 & 0x7;
	pDst->reserved = tmp96__ >> 3 & 0x1;
	pDst->mld_mac_addr_present = tmp96__ >> 4 & 0x1;
	pDst->link_id_info_present = tmp96__ >> 5 & 0x1;
	pDst->bss_param_change_cnt_present = tmp96__ >> 6 & 0x1;
	pDst->medium_sync_delay_info_present = tmp96__ >> 7 & 0x1;
	pDst->eml_capab_present = tmp96__ >> 8 & 0x1;
	pDst->mld_capab_present = tmp96__ >> 9 & 0x1;
	pDst->reserved_1 = tmp96__ >> 10 & 0x3f;
	...
	case 1:
		...
		pBuf += 1;
		ielen -= 1;
		pDst->link_id_info.info.link_id = tmp97__ >> 0 & 0xf;
		pDst->link_id_info.info.reserved = tmp97__ >> 4 & 0xf;
		break;
	}
	...
	case 1:
		...
		pBuf += 2;
		ielen -= 2;
		pDst->medium_sync_delay_info.info.medium_sync_duration = tmp98__ >> 0 & 0xff;
		pDst->medium_sync_delay_info.info.medium_sync_ofdm_ed_thresh = tmp98__ >> 8 & 0xf;
		pDst->medium_sync_delay_info.info.medium_sync_max_txop_num = tmp98__ >> 12 & 0xf;
		break;
	}
	...
	case 1:
		...
		pBuf += 2;
		ielen -= 2;
		pDst->eml_capabilities.info.emlsr_support = tmp99__ >> 0 & 0x1;
		pDst->eml_capabilities.info.emlsr_delay = tmp99__ >> 1 & 0x7;
		pDst->eml_capabilities.info.emlmr_support = tmp99__ >> 4 & 0x1;
		pDst->eml_capabilities.info.emlmr_delay = tmp99__ >> 5 & 0x7;
		pDst->eml_capabilities.info.transition_timeout = tmp99__ >> 8 & 0xf;
		pDst->eml_capabilities.info.reserved = tmp99__ >> 12 & 0xf;
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
			return DOT11F_INCOMPLETE_IE;
		}
		...
		pBuf += 1;
		ielen -= 1;
		pDst->eml_capabilities.info.emlmr_rx_nss = tmp100__ >> 0 & 0xf;
		pDst->eml_capabilities.info.emlmr_tx_nss = tmp100__ >> 4 & 0xf;
		break;
	}
	...
	case 1:
		...
		pBuf += 2;
		ielen -= 2;
		pDst->mld_capabilities.info.max_simultaneous_link_num = tmp101__ >> 0 & 0xf;
		pDst->mld_capabilities.info.srs_support = tmp101__ >> 4 & 0x1;
		pDst->mld_capabilities.info.tid_link_map_supported = tmp101__ >> 5 & 0x3;
		pDst->mld_capabilities.info.str_freq_separation = tmp101__ >> 7 & 0x1f;
		pDst->mld_capabilities.info.reserved = tmp101__ >> 12 & 0xf;
		break;
	}
	(void)pCtx;
	status |= unpack_core(pCtx,
						  ...
						  bool append_ie)
{
	...
	case 4:
		...
		pBuf += 4;
		ielen -= 4;
		pDst->tbtt_info.tbtt_info_4.mld_id = tmp111__ >> 0 & 0xff;
		pDst->tbtt_info.tbtt_info_4.link_id = tmp111__ >> 8 & 0xf;
		pDst->tbtt_info.tbtt_info_4.bss_param_change_cnt = tmp111__ >> 12 & 0xff;
		pDst->tbtt_info.tbtt_info_4.reserved = tmp111__ >> 20 & 0xfff;
		break;
	case 5:
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
	...
	case 10:
		...
		pBuf += 4;
		ielen -= 4;
		pDst->tbtt_info.tbtt_info_10.mld_id = tmp112__ >> 0 & 0xff;
		pDst->tbtt_info.tbtt_info_10.link_id = tmp112__ >> 8 & 0xf;
		pDst->tbtt_info.tbtt_info_10.bss_param_change_cnt = tmp112__ >> 12 & 0xff;
		pDst->tbtt_info.tbtt_info_10.reserved = tmp112__ >> 20 & 0xfff;
		break;
	case 11:
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
	...
	case 16:
		...
		pBuf += 4;
		ielen -= 4;
		pDst->tbtt_info.tbtt_info_16.mld_id = tmp113__ >> 0 & 0xff;
		pDst->tbtt_info.tbtt_info_16.link_id = tmp113__ >> 8 & 0xf;
		pDst->tbtt_info.tbtt_info_16.bss_param_change_cnt = tmp113__ >> 12 & 0xff;
		pDst->tbtt_info.tbtt_info_16.reserved = tmp113__ >> 20 & 0xfff;
		break;
	}
	(void)pCtx;
	return status;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 195;
		...
		++pBuf; ++(*pnConsumed);
		tmp146__ = 0U;
		tmp146__ |= (pSrc->max_tx_pwr_count << 0);
		tmp146__ |= (pSrc->max_tx_pwr_interpret << 3);
		tmp146__ |= (pSrc->max_tx_pwr_category << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				     ...
				     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp147__ = 0U;
		tmp147__ |= (pSrc->acbe_aifsn << 0);
		tmp147__ |= (pSrc->acbe_acm << 4);
		tmp147__ |= (pSrc->acbe_aci << 5);
		tmp147__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp148__ = 0U;
		tmp148__ |= (pSrc->acbe_acwmin << 0);
		tmp148__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp149__ = 0U;
		tmp149__ |= (pSrc->acbk_aifsn << 0);
		tmp149__ |= (pSrc->acbk_acm << 4);
		tmp149__ |= (pSrc->acbk_aci << 5);
		tmp149__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp150__ = 0U;
		tmp150__ |= (pSrc->acbk_acwmin << 0);
		tmp150__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp151__ = 0U;
		tmp151__ |= (pSrc->acvi_aifsn << 0);
		tmp151__ |= (pSrc->acvi_acm << 4);
		tmp151__ |= (pSrc->acvi_aci << 5);
		tmp151__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp152__ = 0U;
		tmp152__ |= (pSrc->acvi_acwmin << 0);
		tmp152__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp153__ = 0U;
		tmp153__ |= (pSrc->acvo_aifsn << 0);
		tmp153__ |= (pSrc->acvo_acm << 4);
		tmp153__ |= (pSrc->acvo_aci << 5);
		tmp153__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp154__ = 0U;
		tmp154__ |= (pSrc->acvo_acwmin << 0);
		tmp154__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 42;
		...
		++pBuf; ++(*pnConsumed);
		tmp155__ = 0U;
		tmp155__ |= (pSrc->non_erp_present << 0);
		tmp155__ |= (pSrc->use_prot << 1);
		tmp155__ |= (pSrc->barker_preamble << 2);
		tmp155__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 45;
		...
		++pBuf; ++(*pnConsumed);
		tmp158__ = 0U;
		tmp158__ |= (pSrc->advCodingCap << 0);
		tmp158__ |= (pSrc->supportedChannelWidthSet << 1);
		tmp158__ |= (pSrc->mimoPowerSave << 2);
		tmp158__ |= (pSrc->greenField << 4);
		tmp158__ |= (pSrc->shortGI20MHz << 5);
		tmp158__ |= (pSrc->shortGI40MHz << 6);
		tmp158__ |= (pSrc->txSTBC << 7);
		tmp158__ |= (pSrc->rxSTBC << 8);
		tmp158__ |= (pSrc->delayedBA << 10);
		tmp158__ |= (pSrc->maximalAMSDUsize << 11);
		tmp158__ |= (pSrc->dsssCckMode40MHz << 12);
		tmp158__ |= (pSrc->psmp << 13);
		tmp158__ |= (pSrc->stbcControlFrame << 14);
		tmp158__ |= (pSrc->lsigTXOPProtection << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp159__ = 0U;
		tmp159__ |= (pSrc->maxRxAMPDUFactor << 0);
		tmp159__ |= (pSrc->mpduDensity << 2);
		tmp159__ |= (pSrc->reserved1 << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 16;
		...
		tmp160__ = 0U;
		tmp160__ |= (pSrc->pco << 0);
		tmp160__ |= (pSrc->transitionTime << 1);
		tmp160__ |= (pSrc->reserved2 << 3);
		tmp160__ |= (pSrc->mcsFeedback << 8);
		tmp160__ |= (pSrc->reserved3 << 10);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp161__ = 0U;
		tmp161__ |= (pSrc->txBF << 0);
		tmp161__ |= (pSrc->rxStaggeredSounding << 1);
		tmp161__ |= (pSrc->txStaggeredSounding << 2);
		tmp161__ |= (pSrc->rxZLF << 3);
		tmp161__ |= (pSrc->txZLF << 4);
		tmp161__ |= (pSrc->implicitTxBF << 5);
		tmp161__ |= (pSrc->calibration << 6);
		tmp161__ |= (pSrc->explicitCSITxBF << 8);
		tmp161__ |= (pSrc->explicitUncompressedSteeringMatrix << 9);
		tmp161__ |= (pSrc->explicitBFCSIFeedback << 10);
		tmp161__ |= (pSrc->explicitUncompressedSteeringMatrixFeedback << 13);
		tmp161__ |= (pSrc->explicitCompressedSteeringMatrixFeedback << 16);
		tmp161__ |= (pSrc->csiNumBFAntennae << 19);
		tmp161__ |= (pSrc->uncompressedSteeringMatrixBFAntennae << 21);
		tmp161__ |= (pSrc->compressedSteeringMatrixBFAntennae << 23);
		tmp161__ |= (pSrc->reserved4 << 25);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp162__ = 0U;
		tmp162__ |= (pSrc->antennaSelection << 0);
		tmp162__ |= (pSrc->explicitCSIFeedbackTx << 1);
		tmp162__ |= (pSrc->antennaIndicesFeedbackTx << 2);
		tmp162__ |= (pSrc->explicitCSIFeedback << 3);
		tmp162__ |= (pSrc->antennaIndicesFeedback << 4);
		tmp162__ |= (pSrc->rxAS << 5);
		tmp162__ |= (pSrc->txSoundingPPDUs << 6);
		tmp162__ |= (pSrc->reserved5 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp163__ = 0U;
		tmp163__ |= (pSrc->secondaryChannelOffset << 0);
		tmp163__ |= (pSrc->recommendedTxWidthSet << 2);
		tmp163__ |= (pSrc->rifsMode << 3);
		tmp163__ |= (pSrc->controlledAccessOnly << 4);
		tmp163__ |= (pSrc->serviceIntervalGranularity << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp164__ = 0U;
		tmp164__ |= (pSrc->opMode << 0);
		tmp164__ |= (pSrc->nonGFDevicesPresent << 2);
		tmp164__ |= (pSrc->transmitBurstLimit << 3);
		tmp164__ |= (pSrc->obssNonHTStaPresent << 4);
		tmp164__ |= (pSrc->chan_center_freq_seg2 << 5);
		tmp164__ |= (pSrc->reserved << 13);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp165__ = 0U;
		tmp165__ |= (pSrc->basicSTBCMCS << 0);
		tmp165__ |= (pSrc->dualCTSProtection << 7);
		tmp165__ |= (pSrc->secondaryBeacon << 8);
		tmp165__ |= (pSrc->lsigTXOPProtectionFullSupport << 9);
		tmp165__ |= (pSrc->pcoActive << 10);
		tmp165__ |= (pSrc->pcoPhase << 11);
		tmp165__ |= (pSrc->reserved2 << 12);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp166__ = 0U;
		tmp166__ |= (pSrc->late << 0);
		tmp166__ |= (pSrc->incapable << 1);
		tmp166__ |= (pSrc->refused << 2);
		tmp166__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->type) {
			...
			case 0:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp167__ = 0U;
				tmp167__ |= (pSrc->report.Basic.bss << 0);
				tmp167__ |= (pSrc->report.Basic.ofdm_preamble << 1);
				tmp167__ |= (pSrc->report.Basic.unid_signal << 2);
				tmp167__ |= (pSrc->report.Basic.rader << 3);
				tmp167__ |= (pSrc->report.Basic.unmeasured << 4);
				tmp167__ |= (pSrc->report.Basic.unused << 5);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
			...
			case 5:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp168__ = 0U;
				tmp168__ |= (pSrc->report.Beacon.condensed_PHY << 0);
				tmp168__ |= (pSrc->report.Beacon.reported_frame_type << 7);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp169__ = 0U;
		tmp169__ |= (pSrc->parallel << 0);
		tmp169__ |= (pSrc->enable << 1);
		tmp169__ |= (pSrc->request << 2);
		tmp169__ |= (pSrc->report << 3);
		tmp169__ |= (pSrc->durationMandatory << 4);
		tmp169__ |= (pSrc->unused << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp170__ = 0U;
		tmp170__ |= (pSrc->overDSCap << 0);
		tmp170__ |= (pSrc->resourceReqCap << 1);
		tmp170__ |= (pSrc->reserved << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 6;
		pBuf += 6;
		tmp171__ = 0U;
		tmp171__ |= (pSrc->APReachability << 0);
		tmp171__ |= (pSrc->Security << 2);
		tmp171__ |= (pSrc->KeyScope << 3);
		tmp171__ |= (pSrc->SpecMgmtCap << 4);
		tmp171__ |= (pSrc->QosCap << 5);
		tmp171__ |= (pSrc->apsd << 6);
		tmp171__ |= (pSrc->rrm << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp172__ = 0U;
		tmp172__ |= (pSrc->DelayedBA << 0);
		tmp172__ |= (pSrc->ImmBA << 1);
		tmp172__ |= (pSrc->MobilityDomain << 2);
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 199;
		...
		++pBuf; ++(*pnConsumed);
		tmp173__ = 0U;
		tmp173__ |= (pSrc->chanWidth << 0);
		tmp173__ |= (pSrc->vht_160_80p80_supp << 2);
		tmp173__ |= (pSrc->no_ldpc << 3);
		tmp173__ |= (pSrc->rxNSS << 4);
		tmp173__ |= (pSrc->rxNSSType << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 106;
		...
		++pBuf; ++(*pnConsumed);
		tmp174__ = 0U;
		tmp174__ |= (pSrc->ac_bk_traffic_aval << 0);
		tmp174__ |= (pSrc->ac_be_traffic_aval << 1);
		tmp174__ |= (pSrc->ac_vi_traffic_aval << 2);
		tmp174__ |= (pSrc->ac_vo_traffic_aval << 3);
		tmp174__ |= (pSrc->reserved << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 46;
		...
		++pBuf; ++(*pnConsumed);
		tmp175__ = 0U;
		tmp175__ |= (pSrc->count << 0);
		tmp175__ |= (pSrc->qack << 4);
		tmp175__ |= (pSrc->qreq << 5);
		tmp175__ |= (pSrc->txopreq << 6);
		tmp175__ |= (pSrc->reserved << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 46;
		...
		++pBuf; ++(*pnConsumed);
		tmp176__ = 0U;
		tmp176__ |= (pSrc->acvo_uapsd << 0);
		tmp176__ |= (pSrc->acvi_uapsd << 1);
		tmp176__ |= (pSrc->acbk_uapsd << 2);
		tmp176__ |= (pSrc->acbe_uapsd << 3);
		tmp176__ |= (pSrc->qack << 4);
		tmp176__ |= (pSrc->max_sp_length << 5);
		tmp176__ |= (pSrc->more_data_ack << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			     ...
			     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 4;
		pBuf += 4;
		tmp177__ = 0U;
		tmp177__ |= (pSrc->preauth << 0);
		tmp177__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp178__ = 0U;
		tmp178__ |= (pSrc->reserved << 0);
		tmp178__ |= (pSrc->qack << 4);
		tmp178__ |= (pSrc->queue_request << 5);
		tmp178__ |= (pSrc->txop_request << 6);
		tmp178__ |= (pSrc->more_ack << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp179__ = 0U;
		tmp179__ |= (pSrc->param_set_count << 0);
		tmp179__ |= (pSrc->reserved << 4);
		tmp179__ |= (pSrc->uapsd << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		...
		tmp180__ |= (pSrc->reserved1 << 4);
		tmp180__ |= (pSrc->max_sp_length << 5);
		tmp180__ |= (pSrc->reserved2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp181__ = 0U;
		tmp181__ |= (pSrc->acbe_aifsn << 0);
		tmp181__ |= (pSrc->acbe_acm << 4);
		tmp181__ |= (pSrc->acbe_aci << 5);
		tmp181__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp182__ = 0U;
		tmp182__ |= (pSrc->acbe_acwmin << 0);
		tmp182__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp183__ = 0U;
		tmp183__ |= (pSrc->acbk_aifsn << 0);
		tmp183__ |= (pSrc->acbk_acm << 4);
		tmp183__ |= (pSrc->acbk_aci << 5);
		tmp183__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp184__ = 0U;
		tmp184__ |= (pSrc->acbk_acwmin << 0);
		tmp184__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp185__ = 0U;
		tmp185__ |= (pSrc->acvi_aifsn << 0);
		tmp185__ |= (pSrc->acvi_acm << 4);
		tmp185__ |= (pSrc->acvi_aci << 5);
		tmp185__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp186__ = 0U;
		tmp186__ |= (pSrc->acvi_acwmin << 0);
		tmp186__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp187__ = 0U;
		tmp187__ |= (pSrc->acvo_aifsn << 0);
		tmp187__ |= (pSrc->acvo_acm << 4);
		tmp187__ |= (pSrc->acvo_aci << 5);
		tmp187__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp188__ = 0U;
		tmp188__ |= (pSrc->acvo_acwmin << 0);
		tmp188__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 159;
		...
		++pBuf; ++(*pnConsumed);
		tmp189__ = 0U;
		tmp189__ |= (pSrc->no_fragmentation << 0);
		tmp189__ |= (pSrc->he_frag_operation << 1);
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp190__ = 0U;
		tmp190__ |= (pSrc->new_color << 0);
		tmp190__ |= (pSrc->reserved << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					    ...
					    uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp191__ = 0U;
		tmp191__ |= (pSrc->prot_keep_alive_reqd << 0);
		tmp191__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 108;
		++pBuf; ++(*pnConsumed);
		tmp192__ = 0U;
		tmp192__ |= (pSrc->nsep_pri_access << 0);
		tmp192__ |= (pSrc->eht_om_ctl << 1);
		tmp192__ |= (pSrc->triggered_txop_sharing << 2);
		tmp192__ |= (pSrc->reserved << 3);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

		frameshtons(pCtx, pBuf, tmp192__, 0);
		*pnConsumed += 2;
		pBuf += 2;
		nBuf -=  2 ;
		tmp193__ = 0U;
		tmp193__ |= (pSrc->reserved2 << 0);
		tmp193__ |= (pSrc->support_320mhz_6ghz << 1);
		tmp193__ |= (pSrc->ru_242tone_wt_20mhz << 2);
		tmp193__ |= (pSrc->ndp_4x_eht_ltf_3dot2_us_gi << 3);
		tmp193__ |= (pSrc->partial_bw_mu_mimo << 4);
		tmp193__ |= (pSrc->su_beamformer << 5);
		tmp193__ |= (pSrc->su_beamformee << 6);
		tmp193__ |= (pSrc->bfee_ss_le_80mhz << 7);
		tmp193__ |= (pSrc->bfee_ss_160mhz << 10);
		tmp193__ |= (pSrc->bfee_ss_320mhz << 13);
		tmp193__ |= (pSrc->num_sounding_dim_le_80mhz << 16);
		tmp193__ |= (pSrc->num_sounding_dim_160mhz << 19);
		tmp193__ |= (pSrc->num_sounding_dim_320mhz << 22);
		tmp193__ |= (pSrc->ng_16_su_feedback << 25);
		tmp193__ |= (pSrc->ng_16_mu_feedback << 26);
		tmp193__ |= (pSrc->cb_sz_4_2_su_feedback << 27);
		tmp193__ |= (pSrc->cb_sz_7_5_su_feedback << 28);
		tmp193__ |= (pSrc->trig_su_bforming_feedback << 29);
		tmp193__ |= (pSrc->trig_mu_bforming_partial_bw_feedback << 30);
		tmp193__ |= (pSrc->triggered_cqi_feedback << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp194__ = 0U;
		tmp194__ |= (pSrc->partial_bw_dl_mu_mimo << 0);
		tmp194__ |= (pSrc->psr_based_sr << 1);
		tmp194__ |= (pSrc->power_boost_factor << 2);
		tmp194__ |= (pSrc->eht_mu_ppdu_4x_ltf_0_8_us_gi << 3);
		tmp194__ |= (pSrc->max_nc << 4);
		tmp194__ |= (pSrc->non_trig_cqi_feedback << 8);
		tmp194__ |= (pSrc->tx_1024_4096_qam_lt_242_tone_ru << 9);
		tmp194__ |= (pSrc->rx_1024_4096_qam_lt_242_tone_ru << 10);
		tmp194__ |= (pSrc->ppet_present << 11);
		tmp194__ |= (pSrc->common_nominal_pkt_padding << 12);
		tmp194__ |= (pSrc->max_num_eht_ltf << 14);
		tmp194__ |= (pSrc->mcs_15 << 19);
		tmp194__ |= (pSrc->eht_dup_6ghz << 23);
		tmp194__ |= (pSrc->op_sta_rx_ndp_wider_bw_20mhz << 24);
		tmp194__ |= (pSrc->non_ofdma_ul_mu_mimo_le_80mhz << 25);
		tmp194__ |= (pSrc->non_ofdma_ul_mu_mimo_160mhz << 26);
		tmp194__ |= (pSrc->non_ofdma_ul_mu_mimo_320mhz << 27);
		tmp194__ |= (pSrc->mu_bformer_le_80mhz << 28);
		tmp194__ |= (pSrc->mu_bformer_160mhz << 29);
		tmp194__ |= (pSrc->mu_bformer_320mhz << 30);
		tmp194__ |= (pSrc->reserved3 << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 106;
		++pBuf; ++(*pnConsumed);
		tmp195__ = 0U;
		tmp195__ |= (pSrc->width << 0);
		tmp195__ |= (pSrc->reserved << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp196__ = 0U;
		tmp196__ |= (pSrc->disable_sub_chan_bitmap_present << 0);
		tmp196__ |= (pSrc->reserved2 << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					...
					uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 240;
		...
		++pBuf; ++(*pnConsumed);
		tmp197__ = 0U;
		tmp197__ |= (pSrc->public_key_identifiers_cnt << 0);
		tmp197__ |= (pSrc->realm_identifiers_cnt << 3);
		tmp197__ |= (pSrc->is_ip_config_supported << 6);
		tmp197__ |= (pSrc->is_cache_id_present << 7);
		tmp197__ |= (pSrc->is_hessid_present << 8);
		tmp197__ |= (pSrc->is_fils_sk_auth_supported << 9);
		tmp197__ |= (pSrc->is_fils_sk_auth_pfs_supported << 10);
		tmp197__ |= (pSrc->is_pk_auth_supported << 11);
		tmp197__ |= (pSrc->reserved << 12);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 59;
		++pBuf; ++(*pnConsumed);
		tmp198__ = 0U;
		tmp198__ |= (pSrc->min_mpdu_start_spacing << 0);
		tmp198__ |= (pSrc->max_ampdu_len_exp << 3);
		tmp198__ |= (pSrc->max_mpdu_len << 6);
		tmp198__ |= (pSrc->sm_pow_save << 9);
		tmp198__ |= (pSrc->rd_responder << 11);
		tmp198__ |= (pSrc->rx_ant_pattern_consistency << 12);
		tmp198__ |= (pSrc->tx_ant_pattern_consistency << 13);
		tmp198__ |= (pSrc->reserved << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 35;
		++pBuf; ++(*pnConsumed);
		tmp199__ = 0U;
		tmp199__ |= (pSrc->htc_he << 0);
		tmp199__ |= (pSrc->twt_request << 1);
		tmp199__ |= (pSrc->twt_responder << 2);
		tmp199__ |= (pSrc->fragmentation << 3);
		tmp199__ |= (pSrc->max_num_frag_msdu_amsdu_exp << 5);
		tmp199__ |= (pSrc->min_frag_size << 8);
		tmp199__ |= (pSrc->trigger_frm_mac_pad << 10);
		tmp199__ |= (pSrc->multi_tid_aggr_rx_supp << 12);
		tmp199__ |= (pSrc->he_link_adaptation << 15);
		tmp199__ |= (pSrc->all_ack << 17);
		tmp199__ |= (pSrc->trigd_rsp_sched << 18);
		tmp199__ |= (pSrc->a_bsr << 19);
		tmp199__ |= (pSrc->broadcast_twt << 20);
		tmp199__ |= (pSrc->ba_32bit_bitmap << 21);
		tmp199__ |= (pSrc->mu_cascade << 22);
		tmp199__ |= (pSrc->ack_enabled_multitid << 23);
		tmp199__ |= (pSrc->reserved << 24);
		tmp199__ |= (pSrc->omi_a_ctrl << 25);
		tmp199__ |= (pSrc->ofdma_ra << 26);
		tmp199__ |= (pSrc->max_ampdu_len_exp_ext << 27);
		tmp199__ |= (pSrc->amsdu_frag << 29);
		tmp199__ |= (pSrc->flex_twt_sched << 30);
		tmp199__ |= (pSrc->rx_ctrl_frame << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp200__ = 0U;
		tmp200__ |= (pSrc->bsrp_ampdu_aggr << 0);
		tmp200__ |= (pSrc->qtp << 1);
		tmp200__ |= (pSrc->a_bqr << 2);
		tmp200__ |= (pSrc->spatial_reuse_param_rspder << 3);
		tmp200__ |= (pSrc->ndp_feedback_supp << 4);
		tmp200__ |= (pSrc->ops_supp << 5);
		tmp200__ |= (pSrc->amsdu_in_ampdu << 6);
		tmp200__ |= (pSrc->multi_tid_aggr_tx_supp << 7);
		tmp200__ |= (pSrc->he_sub_ch_sel_tx_supp << 10);
		tmp200__ |= (pSrc->ul_2x996_tone_ru_supp << 11);
		tmp200__ |= (pSrc->om_ctrl_ul_mu_data_dis_rx << 12);
		tmp200__ |= (pSrc->he_dynamic_smps << 13);
		tmp200__ |= (pSrc->punctured_sounding_supp << 14);
		tmp200__ |= (pSrc->ht_vht_trg_frm_rx_supp << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp201__ = 0U;
		tmp201__ |= (pSrc->reserved2 << 0);
		tmp201__ |= (pSrc->chan_width_0 << 1);
		tmp201__ |= (pSrc->chan_width_1 << 2);
		tmp201__ |= (pSrc->chan_width_2 << 3);
		tmp201__ |= (pSrc->chan_width_3 << 4);
		tmp201__ |= (pSrc->chan_width_4 << 5);
		tmp201__ |= (pSrc->chan_width_5 << 6);
		tmp201__ |= (pSrc->chan_width_6 << 7);
		tmp201__ |= (pSrc->rx_pream_puncturing << 8);
		tmp201__ |= (pSrc->device_class << 12);
		tmp201__ |= (pSrc->ldpc_coding << 13);
		tmp201__ |= (pSrc->he_1x_ltf_800_gi_ppdu << 14);
		tmp201__ |= (pSrc->midamble_tx_rx_max_nsts << 15);
		tmp201__ |= (pSrc->he_4x_ltf_3200_gi_ndp << 17);
		tmp201__ |= (pSrc->tb_ppdu_tx_stbc_lt_80mhz << 18);
		tmp201__ |= (pSrc->rx_stbc_lt_80mhz << 19);
		tmp201__ |= (pSrc->doppler << 20);
		tmp201__ |= (pSrc->ul_mu << 22);
		tmp201__ |= (pSrc->dcm_enc_tx << 24);
		tmp201__ |= (pSrc->dcm_enc_rx << 27);
		tmp201__ |= (pSrc->ul_he_mu << 30);
		tmp201__ |= (pSrc->su_beamformer << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp202__ = 0U;
		tmp202__ |= (pSrc->su_beamformee << 0);
		tmp202__ |= (pSrc->mu_beamformer << 1);
		tmp202__ |= (pSrc->bfee_sts_lt_80 << 2);
		tmp202__ |= (pSrc->bfee_sts_gt_80 << 5);
		tmp202__ |= (pSrc->num_sounding_lt_80 << 8);
		tmp202__ |= (pSrc->num_sounding_gt_80 << 11);
		tmp202__ |= (pSrc->su_feedback_tone16 << 14);
		tmp202__ |= (pSrc->mu_feedback_tone16 << 15);
		tmp202__ |= (pSrc->codebook_su << 16);
		tmp202__ |= (pSrc->codebook_mu << 17);
		tmp202__ |= (pSrc->beamforming_feedback << 18);
		tmp202__ |= (pSrc->he_er_su_ppdu << 21);
		tmp202__ |= (pSrc->dl_mu_mimo_part_bw << 22);
		tmp202__ |= (pSrc->ppet_present << 23);
		tmp202__ |= (pSrc->srp << 24);
		tmp202__ |= (pSrc->power_boost << 25);
		tmp202__ |= (pSrc->he_ltf_800_gi_4x << 26);
		tmp202__ |= (pSrc->max_nc << 27);
		tmp202__ |= (pSrc->tb_ppdu_tx_stbc_gt_80mhz << 30);
		tmp202__ |= (pSrc->rx_stbc_gt_80mhz << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp203__ = 0U;
		tmp203__ |= (pSrc->er_he_ltf_800_gi_4x << 0);
		tmp203__ |= (pSrc->he_ppdu_20_in_40Mhz_2G << 1);
		tmp203__ |= (pSrc->he_ppdu_20_in_160_80p80Mhz << 2);
		tmp203__ |= (pSrc->he_ppdu_80_in_160_80p80Mhz << 3);
		tmp203__ |= (pSrc->er_1x_he_ltf_gi << 4);
		tmp203__ |= (pSrc->midamble_tx_rx_1x_he_ltf << 5);
		tmp203__ |= (pSrc->dcm_max_bw << 6);
		tmp203__ |= (pSrc->longer_than_16_he_sigb_ofdm_sym << 8);
		tmp203__ |= (pSrc->non_trig_cqi_feedback << 9);
		tmp203__ |= (pSrc->tx_1024_qam_lt_242_tone_ru << 10);
		tmp203__ |= (pSrc->rx_1024_qam_lt_242_tone_ru << 11);
		tmp203__ |= (pSrc->rx_full_bw_su_he_mu_compress_sigb << 12);
		tmp203__ |= (pSrc->rx_full_bw_su_he_mu_non_cmpr_sigb << 13);
		tmp203__ |= (pSrc->reserved3 << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
			      ...
			      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 36;
		++pBuf; ++(*pnConsumed);
		tmp204__ = 0U;
		tmp204__ |= (pSrc->default_pe << 0);
		tmp204__ |= (pSrc->twt_required << 3);
		tmp204__ |= (pSrc->txop_rts_threshold << 4);
		tmp204__ |= (pSrc->vht_oper_present << 14);
		tmp204__ |= (pSrc->co_located_bss << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp205__ = 0U;
		tmp205__ |= (pSrc->er_su_disable << 0);
		tmp205__ |= (pSrc->oper_info_6g_present << 1);
		tmp205__ |= (pSrc->reserved2 << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp206__ = 0U;
		tmp206__ |= (pSrc->bss_color << 0);
		tmp206__ |= (pSrc->partial_bss_col << 6);
		tmp206__ |= (pSrc->bss_col_disabled << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->oper_info_6g_present) {
			...
			case 1:
				...
				*pnConsumed += 1;
				pBuf += 1;
				tmp207__ = 0U;
				tmp207__ |= (pSrc->oper_info_6g.info.ch_width << 0);
				tmp207__ |= (pSrc->oper_info_6g.info.dup_bcon << 2);
				tmp207__ |= (pSrc->oper_info_6g.info.reg_info << 3);
				tmp207__ |= (pSrc->oper_info_6g.info.reserved << 6);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 0x10;
		++pBuf; ++(*pnConsumed);
		tmp208__ = 0U;
		tmp208__ |= (pSrc->dgaf_dis << 0);
		tmp208__ |= (pSrc->hs_id_present << 1);
		tmp208__ |= (pSrc->reserved << 3);
		tmp208__ |= (pSrc->release_num << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					       ...
					       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 72;
		...
		++pBuf; ++(*pnConsumed);
		tmp209__ = 0U;
		tmp209__ |= (pSrc->info_request << 0);
		tmp209__ |= (pSrc->forty_mhz_intolerant << 1);
		tmp209__ |= (pSrc->twenty_mhz_bsswidth_req << 2);
		tmp209__ |= (pSrc->obss_scan_exemption_req << 3);
		tmp209__ |= (pSrc->obss_scan_exemption_grant << 4);
		tmp209__ |= (pSrc->unused << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 107;
		++pBuf; --nBuf; ++(*pnConsumed);
		tmp210__ = 0U;
		tmp210__ |= (pSrc->type << 0);
		tmp210__ |= (pSrc->reserved << 3);
		tmp210__ |= (pSrc->mld_mac_addr_present << 4);
		tmp210__ |= (pSrc->link_id_info_present << 5);
		tmp210__ |= (pSrc->bss_param_change_cnt_present << 6);
		tmp210__ |= (pSrc->medium_sync_delay_info_present << 7);
		tmp210__ |= (pSrc->eml_capab_present << 8);
		tmp210__ |= (pSrc->mld_capab_present << 9);
		tmp210__ |= (pSrc->reserved_1 << 10);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		if (pSrc->link_id_info_present) {
			...
			case 1:
				tmp211__ = 0U;
				tmp211__ |= (pSrc->link_id_info.info.link_id << 0);
				tmp211__ |= (pSrc->link_id_info.info.reserved << 4);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->medium_sync_delay_info_present) {
			...
			case 1:
				tmp212__ = 0U;
				tmp212__ |= (pSrc->medium_sync_delay_info.info.medium_sync_duration << 0);
				tmp212__ |= (pSrc->medium_sync_delay_info.info.medium_sync_ofdm_ed_thresh << 8);
				tmp212__ |= (pSrc->medium_sync_delay_info.info.medium_sync_max_txop_num << 12);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->eml_capab_present) {
			...
			case 1:
				tmp213__ = 0U;
				tmp213__ |= (pSrc->eml_capabilities.info.emlsr_support << 0);
				tmp213__ |= (pSrc->eml_capabilities.info.emlsr_delay << 1);
				tmp213__ |= (pSrc->eml_capabilities.info.emlmr_support << 4);
				tmp213__ |= (pSrc->eml_capabilities.info.emlmr_delay << 5);
				tmp213__ |= (pSrc->eml_capabilities.info.transition_timeout << 8);
				tmp213__ |= (pSrc->eml_capabilities.info.reserved << 12);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;
				...
				*pnConsumed += 2;
				...
				nBuf -=  2 ;
				tmp214__ = 0U;
				tmp214__ |= (pSrc->eml_capabilities.info.emlmr_rx_nss << 0);
				tmp214__ |= (pSrc->eml_capabilities.info.emlmr_tx_nss << 4);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->mld_capab_present) {
			...
			case 1:
				tmp215__ = 0U;
				tmp215__ |= (pSrc->mld_capabilities.info.max_simultaneous_link_num << 0);
				tmp215__ |= (pSrc->mld_capabilities.info.srs_support << 4);
				tmp215__ |= (pSrc->mld_capabilities.info.tid_link_map_supported << 5);
				tmp215__ |= (pSrc->mld_capabilities.info.str_freq_separation << 7);
				tmp215__ |= (pSrc->mld_capabilities.info.reserved << 12);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp216__ = 0U;
		tmp216__ |= (pSrc->acbe_aifsn << 0);
		tmp216__ |= (pSrc->acbe_acm << 4);
		tmp216__ |= (pSrc->acbe_aci << 5);
		tmp216__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp217__ = 0U;
		tmp217__ |= (pSrc->acbe_acwmin << 0);
		tmp217__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp218__ = 0U;
		tmp218__ |= (pSrc->acbk_aifsn << 0);
		tmp218__ |= (pSrc->acbk_acm << 4);
		tmp218__ |= (pSrc->acbk_aci << 5);
		tmp218__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp219__ = 0U;
		tmp219__ |= (pSrc->acbk_acwmin << 0);
		tmp219__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp220__ = 0U;
		tmp220__ |= (pSrc->acvi_aifsn << 0);
		tmp220__ |= (pSrc->acvi_acm << 4);
		tmp220__ |= (pSrc->acvi_aci << 5);
		tmp220__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp221__ = 0U;
		tmp221__ |= (pSrc->acvi_acwmin << 0);
		tmp221__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp222__ = 0U;
		tmp222__ |= (pSrc->acvo_aifsn << 0);
		tmp222__ |= (pSrc->acvo_acm << 4);
		tmp222__ |= (pSrc->acvo_aci << 5);
		tmp222__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp223__ = 0U;
		tmp223__ |= (pSrc->acvo_acwmin << 0);
		tmp223__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
						...
						uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 201;
		...
		++pBuf; ++(*pnConsumed);
		tmp224__ = 0U;
		tmp224__ |= (pSrc->tbtt_type << 0);
		tmp224__ |= (pSrc->filtered_neighbor_ap << 2);
		tmp224__ |= (pSrc->reserved << 3);
		tmp224__ |= (pSrc->tbtt_info_count << 4);
		tmp224__ |= (pSrc->tbtt_info_len << 8);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		case 4:
			...
			*pnConsumed += 1;
			pBuf += 1;
			tmp225__ = 0U;
			tmp225__ |= (pSrc->tbtt_info.tbtt_info_4.mld_id << 0);
			tmp225__ |= (pSrc->tbtt_info.tbtt_info_4.link_id << 8);
			tmp225__ |= (pSrc->tbtt_info.tbtt_info_4.bss_param_change_cnt << 12);
			tmp225__ |= (pSrc->tbtt_info.tbtt_info_4.reserved << 20);
			if (unlikely(nBuf < 4))
				return DOT11F_INCOMPLETE_IE;
		...
		case 10:
			...
			*pnConsumed += 6;
			pBuf += 6;
			tmp226__ = 0U;
			tmp226__ |= (pSrc->tbtt_info.tbtt_info_10.mld_id << 0);
			tmp226__ |= (pSrc->tbtt_info.tbtt_info_10.link_id << 8);
			tmp226__ |= (pSrc->tbtt_info.tbtt_info_10.bss_param_change_cnt << 12);
			tmp226__ |= (pSrc->tbtt_info.tbtt_info_10.reserved << 20);
			if (unlikely(nBuf < 4))
				return DOT11F_INCOMPLETE_IE;

			frameshtonl(pCtx, pBuf, tmp226__, 0);
			*pnConsumed += 4;
			/* fieldsEndFlag  = 1 */
			nBuf -=  4 ;
			break;
		...
		case 16:
			...
			*pnConsumed += 1;
			pBuf += 1;
			tmp227__ = 0U;
			tmp227__ |= (pSrc->tbtt_info.tbtt_info_16.mld_id << 0);
			tmp227__ |= (pSrc->tbtt_info.tbtt_info_16.link_id << 8);
			tmp227__ |= (pSrc->tbtt_info.tbtt_info_16.bss_param_change_cnt << 12);
			tmp227__ |= (pSrc->tbtt_info.tbtt_info_16.reserved << 20);
			if (unlikely(nBuf < 4))
				return DOT11F_INCOMPLETE_IE;

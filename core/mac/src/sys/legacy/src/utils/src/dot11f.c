				  ...
				  bool append_ie)
{
	...
	pBuf += 4;
	ielen -= 4;
	pDst->bw_20_rx_max_nss_for_mcs_0_to_7 = tmp81__ >> 0 & 0xf;
	pDst->bw_20_tx_max_nss_for_mcs_0_to_7 = tmp81__ >> 4 & 0xf;
	pDst->bw_20_rx_max_nss_for_mcs_8_and_9 = tmp81__ >> 8 & 0xf;
	pDst->bw_20_tx_max_nss_for_mcs_8_and_9 = tmp81__ >> 12 & 0xf;
	pDst->bw_20_rx_max_nss_for_mcs_10_and_11 = tmp81__ >> 16 & 0xf;
	pDst->bw_20_tx_max_nss_for_mcs_10_and_11 = tmp81__ >> 20 & 0xf;
	pDst->bw_20_rx_max_nss_for_mcs_12_and_13 = tmp81__ >> 24 & 0xf;
	pDst->bw_20_tx_max_nss_for_mcs_12_and_13 = tmp81__ >> 28 & 0xf;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->bw_le_80_rx_max_nss_for_mcs_0_to_9 = tmp82__ >> 0 & 0xf;
	pDst->bw_le_80_tx_max_nss_for_mcs_0_to_9 = tmp82__ >> 4 & 0xf;
	pDst->bw_le_80_rx_max_nss_for_mcs_10_and_11 = tmp82__ >> 8 & 0xf;
	pDst->bw_le_80_tx_max_nss_for_mcs_10_and_11 = tmp82__ >> 12 & 0xf;
	pDst->bw_le_80_rx_max_nss_for_mcs_12_and_13 = tmp82__ >> 16 & 0xf;
	pDst->bw_le_80_tx_max_nss_for_mcs_12_and_13 = tmp82__ >> 20 & 0xf;
	pDst->bw_160_rx_max_nss_for_mcs_0_to_9 = tmp82__ >> 24 & 0xf;
	pDst->bw_160_tx_max_nss_for_mcs_0_to_9 = tmp82__ >> 28 & 0xf;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->bw_160_rx_max_nss_for_mcs_10_and_11 = tmp83__ >> 0 & 0xf;
	pDst->bw_160_tx_max_nss_for_mcs_10_and_11 = tmp83__ >> 4 & 0xf;
	pDst->bw_160_rx_max_nss_for_mcs_12_and_13 = tmp83__ >> 8 & 0xf;
	pDst->bw_160_tx_max_nss_for_mcs_12_and_13 = tmp83__ >> 12 & 0xf;
	pDst->bw_320_rx_max_nss_for_mcs_0_to_9 = tmp83__ >> 16 & 0xf;
	pDst->bw_320_tx_max_nss_for_mcs_0_to_9 = tmp83__ >> 20 & 0xf;
	pDst->bw_320_rx_max_nss_for_mcs_10_and_11 = tmp83__ >> 24 & 0xf;
	pDst->bw_320_tx_max_nss_for_mcs_10_and_11 = tmp83__ >> 28 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->bw_320_rx_max_nss_for_mcs_12_and_13 = tmp84__ >> 0 & 0xf;
	pDst->bw_320_tx_max_nss_for_mcs_12_and_13 = tmp84__ >> 4 & 0xf;
				 ...
				 bool append_ie)
{
	...
	pBuf += 1;
	ielen -= 1;
	pDst->width = tmp85__ >> 0 & 0x7;
	pDst->reserved = tmp85__ >> 3 & 0x1f;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->disable_sub_chan_bitmap_present = tmp86__ >> 0 & 0x1;
	pDst->reserved2 = tmp86__ >> 1 & 0x7f;
					  ...
					  bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->public_key_identifiers_cnt = tmp87__ >> 0 & 0x7;
	pDst->realm_identifiers_cnt = tmp87__ >> 3 & 0x7;
	pDst->is_ip_config_supported = tmp87__ >> 6 & 0x1;
	pDst->is_cache_id_present = tmp87__ >> 7 & 0x1;
	pDst->is_hessid_present = tmp87__ >> 8 & 0x1;
	pDst->is_fils_sk_auth_supported = tmp87__ >> 9 & 0x1;
	pDst->is_fils_sk_auth_pfs_supported = tmp87__ >> 10 & 0x1;
	pDst->is_pk_auth_supported = tmp87__ >> 11 & 0x1;
	pDst->reserved = tmp87__ >> 12 & 0xf;
					   ...
					   bool append_ie)
{
	...
	pDst->min_mpdu_start_spacing = tmp88__ >> 0 & 0x7;
	pDst->max_ampdu_len_exp = tmp88__ >> 3 & 0x7;
	pDst->max_mpdu_len = tmp88__ >> 6 & 0x7;
	pDst->sm_pow_save = tmp88__ >> 9 & 0x3;
	pDst->rd_responder = tmp88__ >> 11 & 0x1;
	pDst->rx_ant_pattern_consistency = tmp88__ >> 12 & 0x1;
	pDst->tx_ant_pattern_consistency = tmp88__ >> 13 & 0x1;
	pDst->reserved = tmp88__ >> 14 & 0x3;
	(void)pCtx;
	return status;
				 ...
				 bool append_ie)
{
	...
	framesntohl(pCtx, &tmp89__, pBuf, 0);
	pBuf += 4;
	ielen -= 4;
	pDst->htc_he = tmp89__ >> 0 & 0x1;
	pDst->twt_request = tmp89__ >> 1 & 0x1;
	pDst->twt_responder = tmp89__ >> 2 & 0x1;
	pDst->fragmentation = tmp89__ >> 3 & 0x3;
	pDst->max_num_frag_msdu_amsdu_exp = tmp89__ >> 5 & 0x7;
	pDst->min_frag_size = tmp89__ >> 8 & 0x3;
	pDst->trigger_frm_mac_pad = tmp89__ >> 10 & 0x3;
	pDst->multi_tid_aggr_rx_supp = tmp89__ >> 12 & 0x7;
	pDst->he_link_adaptation = tmp89__ >> 15 & 0x3;
	pDst->all_ack = tmp89__ >> 17 & 0x1;
	pDst->trigd_rsp_sched = tmp89__ >> 18 & 0x1;
	pDst->a_bsr = tmp89__ >> 19 & 0x1;
	pDst->broadcast_twt = tmp89__ >> 20 & 0x1;
	pDst->ba_32bit_bitmap = tmp89__ >> 21 & 0x1;
	pDst->mu_cascade = tmp89__ >> 22 & 0x1;
	pDst->ack_enabled_multitid = tmp89__ >> 23 & 0x1;
	pDst->reserved = tmp89__ >> 24 & 0x1;
	pDst->omi_a_ctrl = tmp89__ >> 25 & 0x1;
	pDst->ofdma_ra = tmp89__ >> 26 & 0x1;
	pDst->max_ampdu_len_exp_ext = tmp89__ >> 27 & 0x3;
	pDst->amsdu_frag = tmp89__ >> 29 & 0x1;
	pDst->flex_twt_sched = tmp89__ >> 30 & 0x1;
	pDst->rx_ctrl_frame = tmp89__ >> 31 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 2;
	ielen -= 2;
	pDst->bsrp_ampdu_aggr = tmp90__ >> 0 & 0x1;
	pDst->qtp = tmp90__ >> 1 & 0x1;
	pDst->a_bqr = tmp90__ >> 2 & 0x1;
	pDst->spatial_reuse_param_rspder = tmp90__ >> 3 & 0x1;
	pDst->ndp_feedback_supp = tmp90__ >> 4 & 0x1;
	pDst->ops_supp = tmp90__ >> 5 & 0x1;
	pDst->amsdu_in_ampdu = tmp90__ >> 6 & 0x1;
	pDst->multi_tid_aggr_tx_supp = tmp90__ >> 7 & 0x7;
	pDst->he_sub_ch_sel_tx_supp = tmp90__ >> 10 & 0x1;
	pDst->ul_2x996_tone_ru_supp = tmp90__ >> 11 & 0x1;
	pDst->om_ctrl_ul_mu_data_dis_rx = tmp90__ >> 12 & 0x1;
	pDst->he_dynamic_smps = tmp90__ >> 13 & 0x1;
	pDst->punctured_sounding_supp = tmp90__ >> 14 & 0x1;
	pDst->ht_vht_trg_frm_rx_supp = tmp90__ >> 15 & 0x1;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->reserved2 = tmp91__ >> 0 & 0x1;
	pDst->chan_width_0 = tmp91__ >> 1 & 0x1;
	pDst->chan_width_1 = tmp91__ >> 2 & 0x1;
	pDst->chan_width_2 = tmp91__ >> 3 & 0x1;
	pDst->chan_width_3 = tmp91__ >> 4 & 0x1;
	pDst->chan_width_4 = tmp91__ >> 5 & 0x1;
	pDst->chan_width_5 = tmp91__ >> 6 & 0x1;
	pDst->chan_width_6 = tmp91__ >> 7 & 0x1;
	pDst->rx_pream_puncturing = tmp91__ >> 8 & 0xf;
	pDst->device_class = tmp91__ >> 12 & 0x1;
	pDst->ldpc_coding = tmp91__ >> 13 & 0x1;
	pDst->he_1x_ltf_800_gi_ppdu = tmp91__ >> 14 & 0x1;
	pDst->midamble_tx_rx_max_nsts = tmp91__ >> 15 & 0x3;
	pDst->he_4x_ltf_3200_gi_ndp = tmp91__ >> 17 & 0x1;
	pDst->tb_ppdu_tx_stbc_lt_80mhz = tmp91__ >> 18 & 0x1;
	pDst->rx_stbc_lt_80mhz = tmp91__ >> 19 & 0x1;
	pDst->doppler = tmp91__ >> 20 & 0x3;
	pDst->ul_mu = tmp91__ >> 22 & 0x3;
	pDst->dcm_enc_tx = tmp91__ >> 24 & 0x7;
	pDst->dcm_enc_rx = tmp91__ >> 27 & 0x7;
	pDst->ul_he_mu = tmp91__ >> 30 & 0x1;
	pDst->su_beamformer = tmp91__ >> 31 & 0x1;
	if (unlikely(ielen < 4)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 4;
	ielen -= 4;
	pDst->su_beamformee = tmp92__ >> 0 & 0x1;
	pDst->mu_beamformer = tmp92__ >> 1 & 0x1;
	pDst->bfee_sts_lt_80 = tmp92__ >> 2 & 0x7;
	pDst->bfee_sts_gt_80 = tmp92__ >> 5 & 0x7;
	pDst->num_sounding_lt_80 = tmp92__ >> 8 & 0x7;
	pDst->num_sounding_gt_80 = tmp92__ >> 11 & 0x7;
	pDst->su_feedback_tone16 = tmp92__ >> 14 & 0x1;
	pDst->mu_feedback_tone16 = tmp92__ >> 15 & 0x1;
	pDst->codebook_su = tmp92__ >> 16 & 0x1;
	pDst->codebook_mu = tmp92__ >> 17 & 0x1;
	pDst->beamforming_feedback = tmp92__ >> 18 & 0x7;
	pDst->he_er_su_ppdu = tmp92__ >> 21 & 0x1;
	pDst->dl_mu_mimo_part_bw = tmp92__ >> 22 & 0x1;
	pDst->ppet_present = tmp92__ >> 23 & 0x1;
	pDst->srp = tmp92__ >> 24 & 0x1;
	pDst->power_boost = tmp92__ >> 25 & 0x1;
	pDst->he_ltf_800_gi_4x = tmp92__ >> 26 & 0x1;
	pDst->max_nc = tmp92__ >> 27 & 0x7;
	pDst->tb_ppdu_tx_stbc_gt_80mhz = tmp92__ >> 30 & 0x1;
	pDst->rx_stbc_gt_80mhz = tmp92__ >> 31 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 2;
	ielen -= 2;
	pDst->er_he_ltf_800_gi_4x = tmp93__ >> 0 & 0x1;
	pDst->he_ppdu_20_in_40Mhz_2G = tmp93__ >> 1 & 0x1;
	pDst->he_ppdu_20_in_160_80p80Mhz = tmp93__ >> 2 & 0x1;
	pDst->he_ppdu_80_in_160_80p80Mhz = tmp93__ >> 3 & 0x1;
	pDst->er_1x_he_ltf_gi = tmp93__ >> 4 & 0x1;
	pDst->midamble_tx_rx_1x_he_ltf = tmp93__ >> 5 & 0x1;
	pDst->dcm_max_bw = tmp93__ >> 6 & 0x3;
	pDst->longer_than_16_he_sigb_ofdm_sym = tmp93__ >> 8 & 0x1;
	pDst->non_trig_cqi_feedback = tmp93__ >> 9 & 0x1;
	pDst->tx_1024_qam_lt_242_tone_ru = tmp93__ >> 10 & 0x1;
	pDst->rx_1024_qam_lt_242_tone_ru = tmp93__ >> 11 & 0x1;
	pDst->rx_full_bw_su_he_mu_compress_sigb = tmp93__ >> 12 & 0x1;
	pDst->rx_full_bw_su_he_mu_non_cmpr_sigb = tmp93__ >> 13 & 0x1;
	pDst->reserved3 = tmp93__ >> 14 & 0x3;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
				 ...
				 bool append_ie)
{
	...
	framesntohs(pCtx, &tmp94__, pBuf, 0);
	pBuf += 2;
	ielen -= 2;
	pDst->default_pe = tmp94__ >> 0 & 0x7;
	pDst->twt_required = tmp94__ >> 3 & 0x1;
	pDst->txop_rts_threshold = tmp94__ >> 4 & 0x3ff;
	pDst->vht_oper_present = tmp94__ >> 14 & 0x1;
	pDst->co_located_bss = tmp94__ >> 15 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->er_su_disable = tmp95__ >> 0 & 0x1;
	pDst->oper_info_6g_present = tmp95__ >> 1 & 0x1;
	pDst->reserved2 = tmp95__ >> 2 & 0x3f;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->bss_color = tmp96__ >> 0 & 0x3f;
	pDst->partial_bss_col = tmp96__ >> 6 & 0x1;
	pDst->bss_col_disabled = tmp96__ >> 7 & 0x1;
	if (unlikely(ielen < 2)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	case 1:
		...
		pBuf += 1;
		ielen -= 1;
		pDst->oper_info_6g.info.ch_width = tmp97__ >> 0 & 0x3;
		pDst->oper_info_6g.info.dup_bcon = tmp97__ >> 2 & 0x1;
		pDst->oper_info_6g.info.reg_info = tmp97__ >> 3 & 0x7;
		pDst->oper_info_6g.info.reserved = tmp97__ >> 6 & 0x3;
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
			return DOT11F_INCOMPLETE_IE;
		}
					 ...
					 bool append_ie)
{
	...
	pBuf += 1;
	ielen -= 1;
	pDst->dgaf_dis = tmp98__ >> 0 & 0x1;
	pDst->hs_id_present = tmp98__ >> 1 & 0x3;
	pDst->reserved = tmp98__ >> 3 & 0x1;
	pDst->release_num = tmp98__ >> 4 & 0xf;
	if (!ielen) {
		return 0U;
	} else {
						 ...
						 bool append_ie)
{
	...
	tmp99__ = *pBuf;
	pDst->info_request = tmp99__ >> 0 & 0x1;
	pDst->forty_mhz_intolerant = tmp99__ >> 1 & 0x1;
	pDst->twenty_mhz_bsswidth_req = tmp99__ >> 2 & 0x1;
	pDst->obss_scan_exemption_req = tmp99__ >> 3 & 0x1;
	pDst->obss_scan_exemption_grant = tmp99__ >> 4 & 0x1;
	pDst->unused = tmp99__ >> 5 & 0x7;
	(void)pCtx;
	return status;
				 ...
				 bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->type = tmp100__ >> 0 & 0x7;
	pDst->reserved = tmp100__ >> 3 & 0x1;
	pDst->mld_mac_addr_present = tmp100__ >> 4 & 0x1;
	pDst->link_id_info_present = tmp100__ >> 5 & 0x1;
	pDst->bss_param_change_cnt_present = tmp100__ >> 6 & 0x1;
	pDst->medium_sync_delay_info_present = tmp100__ >> 7 & 0x1;
	pDst->eml_capab_present = tmp100__ >> 8 & 0x1;
	pDst->mld_capab_present = tmp100__ >> 9 & 0x1;
	pDst->reserved_1 = tmp100__ >> 10 & 0x3f;
	...
	case 1:
		...
		pBuf += 1;
		ielen -= 1;
		pDst->link_id_info.info.link_id = tmp101__ >> 0 & 0xf;
		pDst->link_id_info.info.reserved = tmp101__ >> 4 & 0xf;
		break;
	}
	...
	case 1:
		...
		pBuf += 2;
		ielen -= 2;
		pDst->medium_sync_delay_info.info.medium_sync_duration = tmp102__ >> 0 & 0xff;
		pDst->medium_sync_delay_info.info.medium_sync_ofdm_ed_thresh = tmp102__ >> 8 & 0xf;
		pDst->medium_sync_delay_info.info.medium_sync_max_txop_num = tmp102__ >> 12 & 0xf;
		break;
	}
	...
	case 1:
		...
		framesntohs(pCtx, &tmp103__, pBuf, 0);
		pBuf += 2;
		ielen -= 2;
		pDst->eml_capabilities.info.emlsr_support = tmp103__ >> 0 & 0x1;
		pDst->eml_capabilities.info.emlsr_delay = tmp103__ >> 1 & 0x7;
		pDst->eml_capabilities.info.emlmr_support = tmp103__ >> 4 & 0x1;
		pDst->eml_capabilities.info.emlmr_delay = tmp103__ >> 5 & 0x7;
		pDst->eml_capabilities.info.transition_timeout = tmp103__ >> 8 & 0xf;
		pDst->eml_capabilities.info.reserved = tmp103__ >> 12 & 0xf;
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
			return DOT11F_INCOMPLETE_IE;
		}
		...
		pBuf += 1;
		ielen -= 1;
		pDst->eml_capabilities.info.emlmr_rx_nss = tmp104__ >> 0 & 0xf;
		pDst->eml_capabilities.info.emlmr_tx_nss = tmp104__ >> 4 & 0xf;
		break;
	}
	...
	case 1:
		...
		framesntohs(pCtx, &tmp105__, pBuf, 0);
		pBuf += 2;
		ielen -= 2;
		pDst->mld_capabilities.info.max_simultaneous_link_num = tmp105__ >> 0 & 0xf;
		pDst->mld_capabilities.info.srs_support = tmp105__ >> 4 & 0x1;
		pDst->mld_capabilities.info.tid_link_map_supported = tmp105__ >> 5 & 0x3;
		pDst->mld_capabilities.info.str_freq_separation = tmp105__ >> 7 & 0x1f;
		pDst->mld_capabilities.info.reserved = tmp105__ >> 12 & 0xf;
		break;
	}
	(void)pCtx;
	status |= unpack_core(pCtx,
					    ...
					    bool append_ie)
{
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbe_aifsn = tmp106__ >> 0 & 0xf;
	pDst->acbe_acm = tmp106__ >> 4 & 0x1;
	pDst->acbe_aci = tmp106__ >> 5 & 0x3;
	pDst->unused1 = tmp106__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbe_acwmin = tmp107__ >> 0 & 0xf;
	pDst->acbe_acwmax = tmp107__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbk_aifsn = tmp108__ >> 0 & 0xf;
	pDst->acbk_acm = tmp108__ >> 4 & 0x1;
	pDst->acbk_aci = tmp108__ >> 5 & 0x3;
	pDst->unused2 = tmp108__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acbk_acwmin = tmp109__ >> 0 & 0xf;
	pDst->acbk_acwmax = tmp109__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvi_aifsn = tmp110__ >> 0 & 0xf;
	pDst->acvi_acm = tmp110__ >> 4 & 0x1;
	pDst->acvi_aci = tmp110__ >> 5 & 0x3;
	pDst->unused3 = tmp110__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvi_acwmin = tmp111__ >> 0 & 0xf;
	pDst->acvi_acwmax = tmp111__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvo_aifsn = tmp112__ >> 0 & 0xf;
	pDst->acvo_acm = tmp112__ >> 4 & 0x1;
	pDst->acvo_aci = tmp112__ >> 5 & 0x3;
	pDst->unused4 = tmp112__ >> 7 & 0x1;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	pBuf += 1;
	ielen -= 1;
	pDst->acvo_acwmin = tmp113__ >> 0 & 0xf;
	pDst->acvo_acwmax = tmp113__ >> 4 & 0xf;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
						  ...
						  bool append_ie)
{
	...
	pBuf += 2;
	ielen -= 2;
	pDst->tbtt_type = tmp114__ >> 0 & 0x3;
	pDst->filtered_neighbor_ap = tmp114__ >> 2 & 0x1;
	pDst->reserved = tmp114__ >> 3 & 0x1;
	pDst->tbtt_info_count = tmp114__ >> 4 & 0xf;
	pDst->tbtt_info_len = tmp114__ >> 8 & 0xff;
	if (unlikely(ielen < 1)) {
		pDst->present = 0;
		return DOT11F_INCOMPLETE_IE;
	}
	...
	case 4:
		...
		framesntohl(pCtx, &tmp115__, pBuf, 0);
		pBuf += 4;
		ielen -= 4;
		pDst->tbtt_info.tbtt_info_4.mld_id = tmp115__ >> 0 & 0xff;
		pDst->tbtt_info.tbtt_info_4.link_id = tmp115__ >> 8 & 0xf;
		pDst->tbtt_info.tbtt_info_4.bss_param_change_cnt = tmp115__ >> 12 & 0xff;
		pDst->tbtt_info.tbtt_info_4.reserved = tmp115__ >> 20 & 0xfff;
		break;
	case 5:
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
	...
	case 10:
		...
		framesntohl(pCtx, &tmp116__, pBuf, 0);
		pBuf += 4;
		ielen -= 4;
		pDst->tbtt_info.tbtt_info_10.mld_id = tmp116__ >> 0 & 0xff;
		pDst->tbtt_info.tbtt_info_10.link_id = tmp116__ >> 8 & 0xf;
		pDst->tbtt_info.tbtt_info_10.bss_param_change_cnt = tmp116__ >> 12 & 0xff;
		pDst->tbtt_info.tbtt_info_10.reserved = tmp116__ >> 20 & 0xfff;
		break;
	case 11:
		if (unlikely(ielen < 1)) {
			pDst->present = 0;
	...
	case 16:
		...
		framesntohl(pCtx, &tmp117__, pBuf, 0);
		pBuf += 4;
		ielen -= 4;
		pDst->tbtt_info.tbtt_info_16.mld_id = tmp117__ >> 0 & 0xff;
		pDst->tbtt_info.tbtt_info_16.link_id = tmp117__ >> 8 & 0xf;
		pDst->tbtt_info.tbtt_info_16.bss_param_change_cnt = tmp117__ >> 12 & 0xff;
		pDst->tbtt_info.tbtt_info_16.reserved = tmp117__ >> 20 & 0xfff;
		break;
	}
	(void)pCtx;
	return status;
...
static const tIEDefn IES_AssocRequest[] = {
	...
	present), 0, "eht_cap", 0, 25, 87, SigIeeht_cap, {0, 0, 0, 0, 0},
...
static const tIEDefn IES_Beacon[] = {
	...
	"eht_cap", 0, 25, 87, SigIeeht_cap, {0, 0, 0, 0, 0},
	0, DOT11F_EID_EHT_CAP, 108, 0, },
...
static const tIEDefn IES_Beacon2[] = {
	...
	0, "eht_cap", 0, 25, 87, SigIeeht_cap, {0, 0, 0, 0, 0},
	0, DOT11F_EID_EHT_CAP, 108, 0, },
				 ...
				 uint8_t *pBuf)
{
	...
	tmp118__ = 0U;
	tmp118__ |= (pSrc->ess << 0);
	tmp118__ |= (pSrc->ibss << 1);
	tmp118__ |= (pSrc->cfPollable << 2);
	tmp118__ |= (pSrc->cfPollReq << 3);
	tmp118__ |= (pSrc->privacy << 4);
	tmp118__ |= (pSrc->shortPreamble << 5);
	tmp118__ |= (pSrc->criticalUpdateFlag << 6);
	tmp118__ |= (pSrc->channelAgility << 7);
	tmp118__ |= (pSrc->spectrumMgt << 8);
	tmp118__ |= (pSrc->qos << 9);
	tmp118__ |= (pSrc->shortSlotTime << 10);
	tmp118__ |= (pSrc->apsd << 11);
	tmp118__ |= (pSrc->rrm << 12);
	tmp118__ |= (pSrc->dsssOfdm << 13);
	tmp118__ |= (pSrc->delayedBA << 14);
	tmp118__ |= (pSrc->immediateBA << 15);
				   ...
				   uint8_t *pBuf)
{
	uint8_t tmp120__;
	tmp120__ = 0U;
	tmp120__ |= (pSrc->PowerSave_En << 0);
	tmp120__ |= (pSrc->Mode << 1);
			   ...
			   uint8_t *pBuf)
{
	...
	tmp121__ |= (pSrc->schedule << 16);
	tmp121__ |= (pSrc->unused << 17);
				    ...
				    uint8_t *pBuf)
{
	uint16_t tmp122__;
	tmp122__ = 0U;
	tmp122__ |= (pSrc->amsdu_supp << 0);
	tmp122__ |= (pSrc->policy << 1);
	tmp122__ |= (pSrc->tid << 2);
	tmp122__ |= (pSrc->buff_size << 6);
				    ...
				    uint8_t *pBuf)
{
	uint16_t tmp124__;
	tmp124__ = 0U;
	tmp124__ |= (pSrc->reserved << 0);
	tmp124__ |= (pSrc->initiator << 11);
	tmp124__ |= (pSrc->tid << 12);
					       ...
					       uint8_t *pBuf)
{
	uint32_t tmp125__;
	tmp125__ = 0U;
	tmp125__ |= (pSrc->switch_mode << 0);
	tmp125__ |= (pSrc->op_class << 8);
	tmp125__ |= (pSrc->new_channel << 16);
	tmp125__ |= (pSrc->switch_count << 24);
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 0;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp126__ = 0U;
		tmp126__ |= (pSrc->minor << 0);
		tmp126__ |= (pSrc->major << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		pBuf += 2; *pnConsumed += 2;
		tmp127__ = 0U;
		tmp127__ |= (pSrc->minor << 0);
		tmp127__ |= (pSrc->major << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 101;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp128__ = 0U;
		tmp128__ |= (pSrc->oce_release << 0);
		tmp128__ |= (pSrc->is_sta_cfon << 3);
		tmp128__ |= (pSrc->non_oce_ap_present << 4);
					     ...
					     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		*pBuf = 103;
		...
		pBuf += 1; *pnConsumed += 1;
		tmp129__ = 0U;
		tmp129__ |= (pSrc->downlink_av_cap << 0);
		tmp129__ |= (pSrc->uplink_av_cap << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			    ...
			    uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 2;
		...
		++pBuf; ++(*pnConsumed);
		tmp130__ = 0U;
		tmp130__ |= (pSrc->keyId << 0);
		tmp130__ |= (pSrc->reserved << 2);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 70;
		...
		++pBuf; ++(*pnConsumed);
		tmp131__ = 0U;
		tmp131__ |= (pSrc->LinkMeasurement << 0);
		tmp131__ |= (pSrc->NeighborRpt << 1);
		tmp131__ |= (pSrc->parallel << 2);
		tmp131__ |= (pSrc->repeated << 3);
		tmp131__ |= (pSrc->BeaconPassive << 4);
		tmp131__ |= (pSrc->BeaconActive << 5);
		tmp131__ |= (pSrc->BeaconTable << 6);
		tmp131__ |= (pSrc->BeaconRepCond << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp132__ = 0U;
		tmp132__ |= (pSrc->FrameMeasurement << 0);
		tmp132__ |= (pSrc->ChannelLoad << 1);
		tmp132__ |= (pSrc->NoiseHistogram << 2);
		tmp132__ |= (pSrc->statistics << 3);
		tmp132__ |= (pSrc->LCIMeasurement << 4);
		tmp132__ |= (pSrc->LCIAzimuth << 5);
		tmp132__ |= (pSrc->TCMCapability << 6);
		tmp132__ |= (pSrc->triggeredTCM << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp133__ = 0U;
		tmp133__ |= (pSrc->APChanReport << 0);
		tmp133__ |= (pSrc->RRMMIBEnabled << 1);
		tmp133__ |= (pSrc->operatingChanMax << 2);
		tmp133__ |= (pSrc->nonOperatinChanMax << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp134__ = 0U;
		tmp134__ |= (pSrc->MeasurementPilot << 0);
		tmp134__ |= (pSrc->MeasurementPilotEnabled << 3);
		tmp134__ |= (pSrc->NeighborTSFOffset << 4);
		tmp134__ |= (pSrc->RCPIMeasurement << 5);
		tmp134__ |= (pSrc->RSNIMeasurement << 6);
		tmp134__ |= (pSrc->BssAvgAccessDelay << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp135__ = 0U;
		tmp135__ |= (pSrc->BSSAvailAdmission << 0);
		tmp135__ |= (pSrc->AntennaInformation << 1);
		tmp135__ |= (pSrc->fine_time_meas_rpt << 2);
		tmp135__ |= (pSrc->lci_capability << 3);
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 15;
		...
		++pBuf; ++(*pnConsumed);
		tmp136__ = 0U;
		tmp136__ |= (pSrc->aggregation << 0);
		tmp136__ |= (pSrc->tsid << 1);
		tmp136__ |= (pSrc->direction << 5);
		tmp136__ |= (pSrc->reserved << 7);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
			      ...
			      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 13;
		...
		++pBuf; ++(*pnConsumed);
		tmp137__ = 0U;
		tmp137__ |= (pSrc->traffic_type << 0);
		tmp137__ |= (pSrc->tsid << 1);
		tmp137__ |= (pSrc->direction << 5);
		tmp137__ |= (pSrc->access_policy << 7);
		tmp137__ |= (pSrc->aggregation << 9);
		tmp137__ |= (pSrc->psb << 10);
		tmp137__ |= (pSrc->user_priority << 11);
		tmp137__ |= (pSrc->tsinfo_ack_pol << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp138__ = 0U;
		tmp138__ |= (pSrc->schedule << 0);
		tmp138__ |= (pSrc->unused << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp139__ = 0U;
		tmp139__ |= (pSrc->size << 0);
		tmp139__ |= (pSrc->fixed << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 191;
		...
		++pBuf; ++(*pnConsumed);
		tmp140__ = 0U;
		tmp140__ |= (pSrc->maxMPDULen << 0);
		tmp140__ |= (pSrc->supportedChannelWidthSet << 2);
		tmp140__ |= (pSrc->ldpcCodingCap << 4);
		tmp140__ |= (pSrc->shortGI80MHz << 5);
		tmp140__ |= (pSrc->shortGI160and80plus80MHz << 6);
		tmp140__ |= (pSrc->txSTBC << 7);
		tmp140__ |= (pSrc->rxSTBC << 8);
		tmp140__ |= (pSrc->suBeamFormerCap << 11);
		tmp140__ |= (pSrc->suBeamformeeCap << 12);
		tmp140__ |= (pSrc->csnofBeamformerAntSup << 13);
		tmp140__ |= (pSrc->numSoundingDim << 16);
		tmp140__ |= (pSrc->muBeamformerCap << 19);
		tmp140__ |= (pSrc->muBeamformeeCap << 20);
		tmp140__ |= (pSrc->vhtTXOPPS << 21);
		tmp140__ |= (pSrc->htcVHTCap << 22);
		tmp140__ |= (pSrc->maxAMPDULenExp << 23);
		tmp140__ |= (pSrc->vhtLinkAdaptCap << 26);
		tmp140__ |= (pSrc->rxAntPattern << 28);
		tmp140__ |= (pSrc->txAntPattern << 29);
		tmp140__ |= (pSrc->extended_nss_bw_supp << 30);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;

		frameshtonl(pCtx, pBuf, tmp140__, 0);
		*pnConsumed += 4;
		pBuf += 4;
		nBuf -=  4 ;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp141__ = 0U;
		tmp141__ |= (pSrc->rxHighSupDataRate << 0);
		tmp141__ |= (pSrc->max_nsts_total << 13);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp142__ = 0U;
		tmp142__ |= (pSrc->txSupDataRate << 0);
		tmp142__ |= (pSrc->vht_extended_nss_bw_cap << 13);
		tmp142__ |= (pSrc->reserved << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				    ...
				    uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp143__ = 0U;
		tmp143__ |= (pSrc->aggregation << 0);
		tmp143__ |= (pSrc->tsid << 1);
		tmp143__ |= (pSrc->direction << 5);
				 ...
				 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp144__ = 0U;
		tmp144__ |= (pSrc->traffic_type << 0);
		tmp144__ |= (pSrc->tsid << 1);
		tmp144__ |= (pSrc->direction << 5);
		tmp144__ |= (pSrc->access_policy << 7);
		tmp144__ |= (pSrc->aggregation << 9);
		tmp144__ |= (pSrc->psb << 10);
		tmp144__ |= (pSrc->user_priority << 11);
		tmp144__ |= (pSrc->tsinfo_ack_pol << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp145__ = 0U;
		tmp145__ |= (pSrc->tsinfo_rsvd << 0);
		tmp145__ |= (pSrc->burst_size_defn << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp146__ = 0U;
		tmp146__ |= (pSrc->size << 0);
		tmp146__ |= (pSrc->fixed << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
							   ...
							   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 2;
		...
		++pBuf; ++(*pnConsumed);
		tmp147__ = 0U;
		tmp147__ |= (pSrc->beacon_report_id << 0);
		tmp147__ |= (pSrc->fragment_id_number << 8);
		tmp147__ |= (pSrc->more_fragments << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 195;
		...
		++pBuf; ++(*pnConsumed);
		tmp150__ = 0U;
		tmp150__ |= (pSrc->max_tx_pwr_count << 0);
		tmp150__ |= (pSrc->max_tx_pwr_interpret << 3);
		tmp150__ |= (pSrc->max_tx_pwr_category << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				     ...
				     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp151__ = 0U;
		tmp151__ |= (pSrc->acbe_aifsn << 0);
		tmp151__ |= (pSrc->acbe_acm << 4);
		tmp151__ |= (pSrc->acbe_aci << 5);
		tmp151__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp152__ = 0U;
		tmp152__ |= (pSrc->acbe_acwmin << 0);
		tmp152__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp153__ = 0U;
		tmp153__ |= (pSrc->acbk_aifsn << 0);
		tmp153__ |= (pSrc->acbk_acm << 4);
		tmp153__ |= (pSrc->acbk_aci << 5);
		tmp153__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp154__ = 0U;
		tmp154__ |= (pSrc->acbk_acwmin << 0);
		tmp154__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp155__ = 0U;
		tmp155__ |= (pSrc->acvi_aifsn << 0);
		tmp155__ |= (pSrc->acvi_acm << 4);
		tmp155__ |= (pSrc->acvi_aci << 5);
		tmp155__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp156__ = 0U;
		tmp156__ |= (pSrc->acvi_acwmin << 0);
		tmp156__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp157__ = 0U;
		tmp157__ |= (pSrc->acvo_aifsn << 0);
		tmp157__ |= (pSrc->acvo_acm << 4);
		tmp157__ |= (pSrc->acvo_aci << 5);
		tmp157__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp158__ = 0U;
		tmp158__ |= (pSrc->acvo_acwmin << 0);
		tmp158__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 42;
		...
		++pBuf; ++(*pnConsumed);
		tmp159__ = 0U;
		tmp159__ |= (pSrc->non_erp_present << 0);
		tmp159__ |= (pSrc->use_prot << 1);
		tmp159__ |= (pSrc->barker_preamble << 2);
		tmp159__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp160__ = 0U;
		tmp160__ |= (pSrc->mbssid_mask << 0);
		tmp160__ |= (pSrc->reserved << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 45;
		...
		++pBuf; ++(*pnConsumed);
		tmp162__ = 0U;
		tmp162__ |= (pSrc->advCodingCap << 0);
		tmp162__ |= (pSrc->supportedChannelWidthSet << 1);
		tmp162__ |= (pSrc->mimoPowerSave << 2);
		tmp162__ |= (pSrc->greenField << 4);
		tmp162__ |= (pSrc->shortGI20MHz << 5);
		tmp162__ |= (pSrc->shortGI40MHz << 6);
		tmp162__ |= (pSrc->txSTBC << 7);
		tmp162__ |= (pSrc->rxSTBC << 8);
		tmp162__ |= (pSrc->delayedBA << 10);
		tmp162__ |= (pSrc->maximalAMSDUsize << 11);
		tmp162__ |= (pSrc->dsssCckMode40MHz << 12);
		tmp162__ |= (pSrc->psmp << 13);
		tmp162__ |= (pSrc->stbcControlFrame << 14);
		tmp162__ |= (pSrc->lsigTXOPProtection << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp163__ = 0U;
		tmp163__ |= (pSrc->maxRxAMPDUFactor << 0);
		tmp163__ |= (pSrc->mpduDensity << 2);
		tmp163__ |= (pSrc->reserved1 << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 16;
		...
		tmp164__ = 0U;
		tmp164__ |= (pSrc->pco << 0);
		tmp164__ |= (pSrc->transitionTime << 1);
		tmp164__ |= (pSrc->reserved2 << 3);
		tmp164__ |= (pSrc->mcsFeedback << 8);
		tmp164__ |= (pSrc->reserved3 << 10);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp165__ = 0U;
		tmp165__ |= (pSrc->txBF << 0);
		tmp165__ |= (pSrc->rxStaggeredSounding << 1);
		tmp165__ |= (pSrc->txStaggeredSounding << 2);
		tmp165__ |= (pSrc->rxZLF << 3);
		tmp165__ |= (pSrc->txZLF << 4);
		tmp165__ |= (pSrc->implicitTxBF << 5);
		tmp165__ |= (pSrc->calibration << 6);
		tmp165__ |= (pSrc->explicitCSITxBF << 8);
		tmp165__ |= (pSrc->explicitUncompressedSteeringMatrix << 9);
		tmp165__ |= (pSrc->explicitBFCSIFeedback << 10);
		tmp165__ |= (pSrc->explicitUncompressedSteeringMatrixFeedback << 13);
		tmp165__ |= (pSrc->explicitCompressedSteeringMatrixFeedback << 16);
		tmp165__ |= (pSrc->csiNumBFAntennae << 19);
		tmp165__ |= (pSrc->uncompressedSteeringMatrixBFAntennae << 21);
		tmp165__ |= (pSrc->compressedSteeringMatrixBFAntennae << 23);
		tmp165__ |= (pSrc->reserved4 << 25);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;

		frameshtonl(pCtx, pBuf, tmp165__, 0);
		*pnConsumed += 4;
		pBuf += 4;
		nBuf -=  4 ;
		tmp166__ = 0U;
		tmp166__ |= (pSrc->antennaSelection << 0);
		tmp166__ |= (pSrc->explicitCSIFeedbackTx << 1);
		tmp166__ |= (pSrc->antennaIndicesFeedbackTx << 2);
		tmp166__ |= (pSrc->explicitCSIFeedback << 3);
		tmp166__ |= (pSrc->antennaIndicesFeedback << 4);
		tmp166__ |= (pSrc->rxAS << 5);
		tmp166__ |= (pSrc->txSoundingPPDUs << 6);
		tmp166__ |= (pSrc->reserved5 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp167__ = 0U;
		tmp167__ |= (pSrc->secondaryChannelOffset << 0);
		tmp167__ |= (pSrc->recommendedTxWidthSet << 2);
		tmp167__ |= (pSrc->rifsMode << 3);
		tmp167__ |= (pSrc->controlledAccessOnly << 4);
		tmp167__ |= (pSrc->serviceIntervalGranularity << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp168__ = 0U;
		tmp168__ |= (pSrc->opMode << 0);
		tmp168__ |= (pSrc->nonGFDevicesPresent << 2);
		tmp168__ |= (pSrc->transmitBurstLimit << 3);
		tmp168__ |= (pSrc->obssNonHTStaPresent << 4);
		tmp168__ |= (pSrc->chan_center_freq_seg2 << 5);
		tmp168__ |= (pSrc->reserved << 13);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp169__ = 0U;
		tmp169__ |= (pSrc->basicSTBCMCS << 0);
		tmp169__ |= (pSrc->dualCTSProtection << 7);
		tmp169__ |= (pSrc->secondaryBeacon << 8);
		tmp169__ |= (pSrc->lsigTXOPProtectionFullSupport << 9);
		tmp169__ |= (pSrc->pcoActive << 10);
		tmp169__ |= (pSrc->pcoPhase << 11);
		tmp169__ |= (pSrc->reserved2 << 12);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp170__ = 0U;
		tmp170__ |= (pSrc->late << 0);
		tmp170__ |= (pSrc->incapable << 1);
		tmp170__ |= (pSrc->refused << 2);
		tmp170__ |= (pSrc->unused << 3);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->type) {
			...
			case 0:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp171__ = 0U;
				tmp171__ |= (pSrc->report.Basic.bss << 0);
				tmp171__ |= (pSrc->report.Basic.ofdm_preamble << 1);
				tmp171__ |= (pSrc->report.Basic.unid_signal << 2);
				tmp171__ |= (pSrc->report.Basic.rader << 3);
				tmp171__ |= (pSrc->report.Basic.unmeasured << 4);
				tmp171__ |= (pSrc->report.Basic.unused << 5);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
			...
			case 5:
				...
				*pnConsumed += 2;
				pBuf += 2;
				tmp172__ = 0U;
				tmp172__ |= (pSrc->report.Beacon.condensed_PHY << 0);
				tmp172__ |= (pSrc->report.Beacon.reported_frame_type << 7);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp173__ = 0U;
		tmp173__ |= (pSrc->parallel << 0);
		tmp173__ |= (pSrc->enable << 1);
		tmp173__ |= (pSrc->request << 2);
		tmp173__ |= (pSrc->report << 3);
		tmp173__ |= (pSrc->durationMandatory << 4);
		tmp173__ |= (pSrc->unused << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp174__ = 0U;
		tmp174__ |= (pSrc->overDSCap << 0);
		tmp174__ |= (pSrc->resourceReqCap << 1);
		tmp174__ |= (pSrc->reserved << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 6;
		pBuf += 6;
		tmp175__ = 0U;
		tmp175__ |= (pSrc->APReachability << 0);
		tmp175__ |= (pSrc->Security << 2);
		tmp175__ |= (pSrc->KeyScope << 3);
		tmp175__ |= (pSrc->SpecMgmtCap << 4);
		tmp175__ |= (pSrc->QosCap << 5);
		tmp175__ |= (pSrc->apsd << 6);
		tmp175__ |= (pSrc->rrm << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp176__ = 0U;
		tmp176__ |= (pSrc->DelayedBA << 0);
		tmp176__ |= (pSrc->ImmBA << 1);
		tmp176__ |= (pSrc->MobilityDomain << 2);
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 199;
		...
		++pBuf; ++(*pnConsumed);
		tmp177__ = 0U;
		tmp177__ |= (pSrc->chanWidth << 0);
		tmp177__ |= (pSrc->vht_160_80p80_supp << 2);
		tmp177__ |= (pSrc->no_ldpc << 3);
		tmp177__ |= (pSrc->rxNSS << 4);
		tmp177__ |= (pSrc->rxNSSType << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 106;
		...
		++pBuf; ++(*pnConsumed);
		tmp178__ = 0U;
		tmp178__ |= (pSrc->ac_bk_traffic_aval << 0);
		tmp178__ |= (pSrc->ac_be_traffic_aval << 1);
		tmp178__ |= (pSrc->ac_vi_traffic_aval << 2);
		tmp178__ |= (pSrc->ac_vo_traffic_aval << 3);
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 46;
		...
		++pBuf; ++(*pnConsumed);
		tmp179__ = 0U;
		tmp179__ |= (pSrc->count << 0);
		tmp179__ |= (pSrc->qack << 4);
		tmp179__ |= (pSrc->qreq << 5);
		tmp179__ |= (pSrc->txopreq << 6);
		tmp179__ |= (pSrc->reserved << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 46;
		...
		++pBuf; ++(*pnConsumed);
		tmp180__ = 0U;
		tmp180__ |= (pSrc->acvo_uapsd << 0);
		tmp180__ |= (pSrc->acvi_uapsd << 1);
		tmp180__ |= (pSrc->acbk_uapsd << 2);
		tmp180__ |= (pSrc->acbe_uapsd << 3);
		tmp180__ |= (pSrc->qack << 4);
		tmp180__ |= (pSrc->max_sp_length << 5);
		tmp180__ |= (pSrc->more_data_ack << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			     ...
			     uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 4;
		pBuf += 4;
		tmp181__ = 0U;
		tmp181__ |= (pSrc->preauth << 0);
		tmp181__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp182__ = 0U;
		tmp182__ |= (pSrc->reserved << 0);
		tmp182__ |= (pSrc->qack << 4);
		tmp182__ |= (pSrc->queue_request << 5);
		tmp182__ |= (pSrc->txop_request << 6);
		tmp182__ |= (pSrc->more_ack << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp183__ = 0U;
		tmp183__ |= (pSrc->param_set_count << 0);
		tmp183__ |= (pSrc->reserved << 4);
		tmp183__ |= (pSrc->uapsd << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				       ...
				       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp184__ = 0U;
		tmp184__ |= (pSrc->acvo_uapsd << 0);
		tmp184__ |= (pSrc->acvi_uapsd << 1);
		tmp184__ |= (pSrc->acbk_uapsd << 2);
		tmp184__ |= (pSrc->acbe_uapsd << 3);
		tmp184__ |= (pSrc->reserved1 << 4);
		tmp184__ |= (pSrc->max_sp_length << 5);
		tmp184__ |= (pSrc->reserved2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				  ...
				  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp185__ = 0U;
		tmp185__ |= (pSrc->acbe_aifsn << 0);
		tmp185__ |= (pSrc->acbe_acm << 4);
		tmp185__ |= (pSrc->acbe_aci << 5);
		tmp185__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp186__ = 0U;
		tmp186__ |= (pSrc->acbe_acwmin << 0);
		tmp186__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp187__ = 0U;
		tmp187__ |= (pSrc->acbk_aifsn << 0);
		tmp187__ |= (pSrc->acbk_acm << 4);
		tmp187__ |= (pSrc->acbk_aci << 5);
		tmp187__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp188__ = 0U;
		tmp188__ |= (pSrc->acbk_acwmin << 0);
		tmp188__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp189__ = 0U;
		tmp189__ |= (pSrc->acvi_aifsn << 0);
		tmp189__ |= (pSrc->acvi_acm << 4);
		tmp189__ |= (pSrc->acvi_aci << 5);
		tmp189__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp190__ = 0U;
		tmp190__ |= (pSrc->acvi_acwmin << 0);
		tmp190__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp191__ = 0U;
		tmp191__ |= (pSrc->acvo_aifsn << 0);
		tmp191__ |= (pSrc->acvo_acm << 4);
		tmp191__ |= (pSrc->acvo_aci << 5);
		tmp191__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp192__ = 0U;
		tmp192__ |= (pSrc->acvo_acwmin << 0);
		tmp192__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					   ...
					   uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 159;
		...
		++pBuf; ++(*pnConsumed);
		tmp193__ = 0U;
		tmp193__ |= (pSrc->no_fragmentation << 0);
		tmp193__ |= (pSrc->he_frag_operation << 1);
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp194__ = 0U;
		tmp194__ |= (pSrc->new_color << 0);
		tmp194__ |= (pSrc->reserved << 6);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					    ...
					    uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 2;
		pBuf += 2;
		tmp195__ = 0U;
		tmp195__ |= (pSrc->prot_keep_alive_reqd << 0);
		tmp195__ |= (pSrc->reserved << 1);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
				...
				uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 108;
		++pBuf; ++(*pnConsumed);
		tmp196__ = 0U;
		tmp196__ |= (pSrc->nsep_pri_access << 0);
		tmp196__ |= (pSrc->eht_om_ctl << 1);
		tmp196__ |= (pSrc->triggered_txop_sharing_mode1 << 2);
		tmp196__ |= (pSrc->triggered_txop_sharing_mode2 << 3);
		tmp196__ |= (pSrc->restricted_twt << 4);
		tmp196__ |= (pSrc->scs_traffic_desc << 5);
		tmp196__ |= (pSrc->max_mpdu_len << 6);
		tmp196__ |= (pSrc->reserved << 8);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp197__ = 0U;
		tmp197__ |= (pSrc->reserved2 << 0);
		tmp197__ |= (pSrc->support_320mhz_6ghz << 1);
		tmp197__ |= (pSrc->ru_242tone_wt_20mhz << 2);
		tmp197__ |= (pSrc->ndp_4x_eht_ltf_3dot2_us_gi << 3);
		tmp197__ |= (pSrc->partial_bw_mu_mimo << 4);
		tmp197__ |= (pSrc->su_beamformer << 5);
		tmp197__ |= (pSrc->su_beamformee << 6);
		tmp197__ |= (pSrc->bfee_ss_le_80mhz << 7);
		tmp197__ |= (pSrc->bfee_ss_160mhz << 10);
		tmp197__ |= (pSrc->bfee_ss_320mhz << 13);
		tmp197__ |= (pSrc->num_sounding_dim_le_80mhz << 16);
		tmp197__ |= (pSrc->num_sounding_dim_160mhz << 19);
		tmp197__ |= (pSrc->num_sounding_dim_320mhz << 22);
		tmp197__ |= (pSrc->ng_16_su_feedback << 25);
		tmp197__ |= (pSrc->ng_16_mu_feedback << 26);
		tmp197__ |= (pSrc->cb_sz_4_2_su_feedback << 27);
		tmp197__ |= (pSrc->cb_sz_7_5_su_feedback << 28);
		tmp197__ |= (pSrc->trig_su_bforming_feedback << 29);
		tmp197__ |= (pSrc->trig_mu_bforming_partial_bw_feedback << 30);
		tmp197__ |= (pSrc->triggered_cqi_feedback << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp198__ = 0U;
		tmp198__ |= (pSrc->partial_bw_dl_mu_mimo << 0);
		tmp198__ |= (pSrc->psr_based_sr << 1);
		tmp198__ |= (pSrc->power_boost_factor << 2);
		tmp198__ |= (pSrc->eht_mu_ppdu_4x_ltf_0_8_us_gi << 3);
		tmp198__ |= (pSrc->max_nc << 4);
		tmp198__ |= (pSrc->non_trig_cqi_feedback << 8);
		tmp198__ |= (pSrc->tx_1024_4096_qam_lt_242_tone_ru << 9);
		tmp198__ |= (pSrc->rx_1024_4096_qam_lt_242_tone_ru << 10);
		tmp198__ |= (pSrc->ppet_present << 11);
		tmp198__ |= (pSrc->common_nominal_pkt_padding << 12);
		tmp198__ |= (pSrc->max_num_eht_ltf << 14);
		tmp198__ |= (pSrc->mcs_15 << 19);
		tmp198__ |= (pSrc->eht_dup_6ghz << 23);
		tmp198__ |= (pSrc->op_sta_rx_ndp_wider_bw_20mhz << 24);
		tmp198__ |= (pSrc->non_ofdma_ul_mu_mimo_le_80mhz << 25);
		tmp198__ |= (pSrc->non_ofdma_ul_mu_mimo_160mhz << 26);
		tmp198__ |= (pSrc->non_ofdma_ul_mu_mimo_320mhz << 27);
		tmp198__ |= (pSrc->mu_bformer_le_80mhz << 28);
		tmp198__ |= (pSrc->mu_bformer_160mhz << 29);
		tmp198__ |= (pSrc->mu_bformer_320mhz << 30);
		tmp198__ |= (pSrc->tb_sounding_feedback_rl << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp199__ = 0U;
		tmp199__ |= (pSrc->bw_20_rx_max_nss_for_mcs_0_to_7 << 0);
		tmp199__ |= (pSrc->bw_20_tx_max_nss_for_mcs_0_to_7 << 4);
		tmp199__ |= (pSrc->bw_20_rx_max_nss_for_mcs_8_and_9 << 8);
		tmp199__ |= (pSrc->bw_20_tx_max_nss_for_mcs_8_and_9 << 12);
		tmp199__ |= (pSrc->bw_20_rx_max_nss_for_mcs_10_and_11 << 16);
		tmp199__ |= (pSrc->bw_20_tx_max_nss_for_mcs_10_and_11 << 20);
		tmp199__ |= (pSrc->bw_20_rx_max_nss_for_mcs_12_and_13 << 24);
		tmp199__ |= (pSrc->bw_20_tx_max_nss_for_mcs_12_and_13 << 28);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp200__ = 0U;
		tmp200__ |= (pSrc->bw_le_80_rx_max_nss_for_mcs_0_to_9 << 0);
		tmp200__ |= (pSrc->bw_le_80_tx_max_nss_for_mcs_0_to_9 << 4);
		tmp200__ |= (pSrc->bw_le_80_rx_max_nss_for_mcs_10_and_11 << 8);
		tmp200__ |= (pSrc->bw_le_80_tx_max_nss_for_mcs_10_and_11 << 12);
		tmp200__ |= (pSrc->bw_le_80_rx_max_nss_for_mcs_12_and_13 << 16);
		tmp200__ |= (pSrc->bw_le_80_tx_max_nss_for_mcs_12_and_13 << 20);
		tmp200__ |= (pSrc->bw_160_rx_max_nss_for_mcs_0_to_9 << 24);
		tmp200__ |= (pSrc->bw_160_tx_max_nss_for_mcs_0_to_9 << 28);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp201__ = 0U;
		tmp201__ |= (pSrc->bw_160_rx_max_nss_for_mcs_10_and_11 << 0);
		tmp201__ |= (pSrc->bw_160_tx_max_nss_for_mcs_10_and_11 << 4);
		tmp201__ |= (pSrc->bw_160_rx_max_nss_for_mcs_12_and_13 << 8);
		tmp201__ |= (pSrc->bw_160_tx_max_nss_for_mcs_12_and_13 << 12);
		tmp201__ |= (pSrc->bw_320_rx_max_nss_for_mcs_0_to_9 << 16);
		tmp201__ |= (pSrc->bw_320_tx_max_nss_for_mcs_0_to_9 << 20);
		tmp201__ |= (pSrc->bw_320_rx_max_nss_for_mcs_10_and_11 << 24);
		tmp201__ |= (pSrc->bw_320_tx_max_nss_for_mcs_10_and_11 << 28);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp202__ = 0U;
		tmp202__ |= (pSrc->bw_320_rx_max_nss_for_mcs_12_and_13 << 0);
		tmp202__ |= (pSrc->bw_320_tx_max_nss_for_mcs_12_and_13 << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					...
					uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 240;
		...
		++pBuf; ++(*pnConsumed);
		tmp205__ = 0U;
		tmp205__ |= (pSrc->public_key_identifiers_cnt << 0);
		tmp205__ |= (pSrc->realm_identifiers_cnt << 3);
		tmp205__ |= (pSrc->is_ip_config_supported << 6);
		tmp205__ |= (pSrc->is_cache_id_present << 7);
		tmp205__ |= (pSrc->is_hessid_present << 8);
		tmp205__ |= (pSrc->is_fils_sk_auth_supported << 9);
		tmp205__ |= (pSrc->is_fils_sk_auth_pfs_supported << 10);
		tmp205__ |= (pSrc->is_pk_auth_supported << 11);
		tmp205__ |= (pSrc->reserved << 12);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
					 ...
					 uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 59;
		++pBuf; ++(*pnConsumed);
		tmp206__ = 0U;
		tmp206__ |= (pSrc->min_mpdu_start_spacing << 0);
		tmp206__ |= (pSrc->max_ampdu_len_exp << 3);
		tmp206__ |= (pSrc->max_mpdu_len << 6);
		tmp206__ |= (pSrc->sm_pow_save << 9);
		tmp206__ |= (pSrc->rd_responder << 11);
		tmp206__ |= (pSrc->rx_ant_pattern_consistency << 12);
		tmp206__ |= (pSrc->tx_ant_pattern_consistency << 13);
		tmp206__ |= (pSrc->reserved << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 35;
		++pBuf; ++(*pnConsumed);
		tmp207__ = 0U;
		tmp207__ |= (pSrc->htc_he << 0);
		tmp207__ |= (pSrc->twt_request << 1);
		tmp207__ |= (pSrc->twt_responder << 2);
		tmp207__ |= (pSrc->fragmentation << 3);
		tmp207__ |= (pSrc->max_num_frag_msdu_amsdu_exp << 5);
		tmp207__ |= (pSrc->min_frag_size << 8);
		tmp207__ |= (pSrc->trigger_frm_mac_pad << 10);
		tmp207__ |= (pSrc->multi_tid_aggr_rx_supp << 12);
		tmp207__ |= (pSrc->he_link_adaptation << 15);
		tmp207__ |= (pSrc->all_ack << 17);
		tmp207__ |= (pSrc->trigd_rsp_sched << 18);
		tmp207__ |= (pSrc->a_bsr << 19);
		tmp207__ |= (pSrc->broadcast_twt << 20);
		tmp207__ |= (pSrc->ba_32bit_bitmap << 21);
		tmp207__ |= (pSrc->mu_cascade << 22);
		tmp207__ |= (pSrc->ack_enabled_multitid << 23);
		tmp207__ |= (pSrc->reserved << 24);
		tmp207__ |= (pSrc->omi_a_ctrl << 25);
		tmp207__ |= (pSrc->ofdma_ra << 26);
		tmp207__ |= (pSrc->max_ampdu_len_exp_ext << 27);
		tmp207__ |= (pSrc->amsdu_frag << 29);
		tmp207__ |= (pSrc->flex_twt_sched << 30);
		tmp207__ |= (pSrc->rx_ctrl_frame << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp208__ = 0U;
		tmp208__ |= (pSrc->bsrp_ampdu_aggr << 0);
		tmp208__ |= (pSrc->qtp << 1);
		tmp208__ |= (pSrc->a_bqr << 2);
		tmp208__ |= (pSrc->spatial_reuse_param_rspder << 3);
		tmp208__ |= (pSrc->ndp_feedback_supp << 4);
		tmp208__ |= (pSrc->ops_supp << 5);
		tmp208__ |= (pSrc->amsdu_in_ampdu << 6);
		tmp208__ |= (pSrc->multi_tid_aggr_tx_supp << 7);
		tmp208__ |= (pSrc->he_sub_ch_sel_tx_supp << 10);
		tmp208__ |= (pSrc->ul_2x996_tone_ru_supp << 11);
		tmp208__ |= (pSrc->om_ctrl_ul_mu_data_dis_rx << 12);
		tmp208__ |= (pSrc->he_dynamic_smps << 13);
		tmp208__ |= (pSrc->punctured_sounding_supp << 14);
		tmp208__ |= (pSrc->ht_vht_trg_frm_rx_supp << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp209__ = 0U;
		tmp209__ |= (pSrc->reserved2 << 0);
		tmp209__ |= (pSrc->chan_width_0 << 1);
		tmp209__ |= (pSrc->chan_width_1 << 2);
		tmp209__ |= (pSrc->chan_width_2 << 3);
		tmp209__ |= (pSrc->chan_width_3 << 4);
		tmp209__ |= (pSrc->chan_width_4 << 5);
		tmp209__ |= (pSrc->chan_width_5 << 6);
		tmp209__ |= (pSrc->chan_width_6 << 7);
		tmp209__ |= (pSrc->rx_pream_puncturing << 8);
		tmp209__ |= (pSrc->device_class << 12);
		tmp209__ |= (pSrc->ldpc_coding << 13);
		tmp209__ |= (pSrc->he_1x_ltf_800_gi_ppdu << 14);
		tmp209__ |= (pSrc->midamble_tx_rx_max_nsts << 15);
		tmp209__ |= (pSrc->he_4x_ltf_3200_gi_ndp << 17);
		tmp209__ |= (pSrc->tb_ppdu_tx_stbc_lt_80mhz << 18);
		tmp209__ |= (pSrc->rx_stbc_lt_80mhz << 19);
		tmp209__ |= (pSrc->doppler << 20);
		tmp209__ |= (pSrc->ul_mu << 22);
		tmp209__ |= (pSrc->dcm_enc_tx << 24);
		tmp209__ |= (pSrc->dcm_enc_rx << 27);
		tmp209__ |= (pSrc->ul_he_mu << 30);
		tmp209__ |= (pSrc->su_beamformer << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp210__ = 0U;
		tmp210__ |= (pSrc->su_beamformee << 0);
		tmp210__ |= (pSrc->mu_beamformer << 1);
		tmp210__ |= (pSrc->bfee_sts_lt_80 << 2);
		tmp210__ |= (pSrc->bfee_sts_gt_80 << 5);
		tmp210__ |= (pSrc->num_sounding_lt_80 << 8);
		tmp210__ |= (pSrc->num_sounding_gt_80 << 11);
		tmp210__ |= (pSrc->su_feedback_tone16 << 14);
		tmp210__ |= (pSrc->mu_feedback_tone16 << 15);
		tmp210__ |= (pSrc->codebook_su << 16);
		tmp210__ |= (pSrc->codebook_mu << 17);
		tmp210__ |= (pSrc->beamforming_feedback << 18);
		tmp210__ |= (pSrc->he_er_su_ppdu << 21);
		tmp210__ |= (pSrc->dl_mu_mimo_part_bw << 22);
		tmp210__ |= (pSrc->ppet_present << 23);
		tmp210__ |= (pSrc->srp << 24);
		tmp210__ |= (pSrc->power_boost << 25);
		tmp210__ |= (pSrc->he_ltf_800_gi_4x << 26);
		tmp210__ |= (pSrc->max_nc << 27);
		tmp210__ |= (pSrc->tb_ppdu_tx_stbc_gt_80mhz << 30);
		tmp210__ |= (pSrc->rx_stbc_gt_80mhz << 31);
		if (unlikely(nBuf < 4))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 4;
		...
		nBuf -=  4 ;
		tmp211__ = 0U;
		tmp211__ |= (pSrc->er_he_ltf_800_gi_4x << 0);
		tmp211__ |= (pSrc->he_ppdu_20_in_40Mhz_2G << 1);
		tmp211__ |= (pSrc->he_ppdu_20_in_160_80p80Mhz << 2);
		tmp211__ |= (pSrc->he_ppdu_80_in_160_80p80Mhz << 3);
		tmp211__ |= (pSrc->er_1x_he_ltf_gi << 4);
		tmp211__ |= (pSrc->midamble_tx_rx_1x_he_ltf << 5);
		tmp211__ |= (pSrc->dcm_max_bw << 6);
		tmp211__ |= (pSrc->longer_than_16_he_sigb_ofdm_sym << 8);
		tmp211__ |= (pSrc->non_trig_cqi_feedback << 9);
		tmp211__ |= (pSrc->tx_1024_qam_lt_242_tone_ru << 10);
		tmp211__ |= (pSrc->rx_1024_qam_lt_242_tone_ru << 11);
		tmp211__ |= (pSrc->rx_full_bw_su_he_mu_compress_sigb << 12);
		tmp211__ |= (pSrc->rx_full_bw_su_he_mu_non_cmpr_sigb << 13);
		tmp211__ |= (pSrc->reserved3 << 14);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
			      ...
			      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 36;
		++pBuf; ++(*pnConsumed);
		tmp212__ = 0U;
		tmp212__ |= (pSrc->default_pe << 0);
		tmp212__ |= (pSrc->twt_required << 3);
		tmp212__ |= (pSrc->txop_rts_threshold << 4);
		tmp212__ |= (pSrc->vht_oper_present << 14);
		tmp212__ |= (pSrc->co_located_bss << 15);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 2;
		...
		nBuf -=  2 ;
		tmp213__ = 0U;
		tmp213__ |= (pSrc->er_su_disable << 0);
		tmp213__ |= (pSrc->oper_info_6g_present << 1);
		tmp213__ |= (pSrc->reserved2 << 2);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp214__ = 0U;
		tmp214__ |= (pSrc->bss_color << 0);
		tmp214__ |= (pSrc->partial_bss_col << 6);
		tmp214__ |= (pSrc->bss_col_disabled << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->oper_info_6g_present) {
			...
			case 1:
				...
				*pnConsumed += 1;
				pBuf += 1;
				tmp215__ = 0U;
				tmp215__ |= (pSrc->oper_info_6g.info.ch_width << 0);
				tmp215__ |= (pSrc->oper_info_6g.info.dup_bcon << 2);
				tmp215__ |= (pSrc->oper_info_6g.info.reg_info << 3);
				tmp215__ |= (pSrc->oper_info_6g.info.reserved << 6);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
				      ...
				      uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 0x10;
		++pBuf; ++(*pnConsumed);
		tmp216__ = 0U;
		tmp216__ |= (pSrc->dgaf_dis << 0);
		tmp216__ |= (pSrc->hs_id_present << 1);
		tmp216__ |= (pSrc->reserved << 3);
		tmp216__ |= (pSrc->release_num << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
					       ...
					       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 72;
		...
		++pBuf; ++(*pnConsumed);
		tmp217__ = 0U;
		tmp217__ |= (pSrc->info_request << 0);
		tmp217__ |= (pSrc->forty_mhz_intolerant << 1);
		tmp217__ |= (pSrc->twenty_mhz_bsswidth_req << 2);
		tmp217__ |= (pSrc->obss_scan_exemption_req << 3);
		tmp217__ |= (pSrc->obss_scan_exemption_grant << 4);
		tmp217__ |= (pSrc->unused << 5);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
			       ...
			       uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 107;
		++pBuf; --nBuf; ++(*pnConsumed);
		tmp218__ = 0U;
		tmp218__ |= (pSrc->type << 0);
		tmp218__ |= (pSrc->reserved << 3);
		tmp218__ |= (pSrc->mld_mac_addr_present << 4);
		tmp218__ |= (pSrc->link_id_info_present << 5);
		tmp218__ |= (pSrc->bss_param_change_cnt_present << 6);
		tmp218__ |= (pSrc->medium_sync_delay_info_present << 7);
		tmp218__ |= (pSrc->eml_capab_present << 8);
		tmp218__ |= (pSrc->mld_capab_present << 9);
		tmp218__ |= (pSrc->reserved_1 << 10);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

		frameshtons(pCtx, pBuf, tmp218__, 0);
		*pnConsumed += 2;
		pBuf += 2;
		nBuf -=  2 ;
		...
		if (pSrc->link_id_info_present) {
			...
			case 1:
				tmp219__ = 0U;
				tmp219__ |= (pSrc->link_id_info.info.link_id << 0);
				tmp219__ |= (pSrc->link_id_info.info.reserved << 4);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->medium_sync_delay_info_present) {
			...
			case 1:
				tmp220__ = 0U;
				tmp220__ |= (pSrc->medium_sync_delay_info.info.medium_sync_duration << 0);
				tmp220__ |= (pSrc->medium_sync_delay_info.info.medium_sync_ofdm_ed_thresh << 8);
				tmp220__ |= (pSrc->medium_sync_delay_info.info.medium_sync_max_txop_num << 12);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;

				frameshtons(pCtx, pBuf, tmp220__, 0);
				*pnConsumed += 2;
				pBuf += 2;
				nBuf -=  2 ;
				break;
		...
		if (pSrc->eml_capab_present) {
			...
			case 1:
				tmp221__ = 0U;
				tmp221__ |= (pSrc->eml_capabilities.info.emlsr_support << 0);
				tmp221__ |= (pSrc->eml_capabilities.info.emlsr_delay << 1);
				tmp221__ |= (pSrc->eml_capabilities.info.emlmr_support << 4);
				tmp221__ |= (pSrc->eml_capabilities.info.emlmr_delay << 5);
				tmp221__ |= (pSrc->eml_capabilities.info.transition_timeout << 8);
				tmp221__ |= (pSrc->eml_capabilities.info.reserved << 12);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;
				...
				*pnConsumed += 2;
				...
				nBuf -=  2 ;
				tmp222__ = 0U;
				tmp222__ |= (pSrc->eml_capabilities.info.emlmr_rx_nss << 0);
				tmp222__ |= (pSrc->eml_capabilities.info.emlmr_tx_nss << 4);
				if (unlikely(nBuf < 1))
					return DOT11F_INCOMPLETE_IE;
		...
		if (pSrc->mld_capab_present) {
			...
			case 1:
				tmp223__ = 0U;
				tmp223__ |= (pSrc->mld_capabilities.info.max_simultaneous_link_num << 0);
				tmp223__ |= (pSrc->mld_capabilities.info.srs_support << 4);
				tmp223__ |= (pSrc->mld_capabilities.info.tid_link_map_supported << 5);
				tmp223__ |= (pSrc->mld_capabilities.info.str_freq_separation << 7);
				tmp223__ |= (pSrc->mld_capabilities.info.reserved << 12);
				if (unlikely(nBuf < 2))
					return DOT11F_INCOMPLETE_IE;
					  ...
					  uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp224__ = 0U;
		tmp224__ |= (pSrc->acbe_aifsn << 0);
		tmp224__ |= (pSrc->acbe_acm << 4);
		tmp224__ |= (pSrc->acbe_aci << 5);
		tmp224__ |= (pSrc->unused1 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp225__ = 0U;
		tmp225__ |= (pSrc->acbe_acwmin << 0);
		tmp225__ |= (pSrc->acbe_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp226__ = 0U;
		tmp226__ |= (pSrc->acbk_aifsn << 0);
		tmp226__ |= (pSrc->acbk_acm << 4);
		tmp226__ |= (pSrc->acbk_aci << 5);
		tmp226__ |= (pSrc->unused2 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp227__ = 0U;
		tmp227__ |= (pSrc->acbk_acwmin << 0);
		tmp227__ |= (pSrc->acbk_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp228__ = 0U;
		tmp228__ |= (pSrc->acvi_aifsn << 0);
		tmp228__ |= (pSrc->acvi_acm << 4);
		tmp228__ |= (pSrc->acvi_aci << 5);
		tmp228__ |= (pSrc->unused3 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp229__ = 0U;
		tmp229__ |= (pSrc->acvi_acwmin << 0);
		tmp229__ |= (pSrc->acvi_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		pBuf += 1;
		tmp230__ = 0U;
		tmp230__ |= (pSrc->acvo_aifsn << 0);
		tmp230__ |= (pSrc->acvo_acm << 4);
		tmp230__ |= (pSrc->acvo_aci << 5);
		tmp230__ |= (pSrc->unused4 << 7);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
		...
		*pnConsumed += 1;
		...
		nBuf -=  1 ;
		tmp231__ = 0U;
		tmp231__ |= (pSrc->acvo_acwmin << 0);
		tmp231__ |= (pSrc->acvo_acwmax << 4);
		if (unlikely(nBuf < 1))
			return DOT11F_INCOMPLETE_IE;
						...
						uint32_t *pnConsumed)
{
	...
	while (pSrc->present) {
		...
		*pBuf = 201;
		...
		++pBuf; ++(*pnConsumed);
		tmp232__ = 0U;
		tmp232__ |= (pSrc->tbtt_type << 0);
		tmp232__ |= (pSrc->filtered_neighbor_ap << 2);
		tmp232__ |= (pSrc->reserved << 3);
		tmp232__ |= (pSrc->tbtt_info_count << 4);
		tmp232__ |= (pSrc->tbtt_info_len << 8);
		if (unlikely(nBuf < 2))
			return DOT11F_INCOMPLETE_IE;

		frameshtons(pCtx, pBuf, tmp232__, 0);
		*pnConsumed += 2;
		pBuf += 2;
		nBuf -=  2 ;
		*pBuf = pSrc->op_class;
		...
		*pnConsumed += 1;
		...
		case 4:
			...
			*pnConsumed += 1;
			pBuf += 1;
			tmp233__ = 0U;
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_4.mld_id << 0);
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_4.link_id << 8);
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_4.bss_param_change_cnt << 12);
			tmp233__ |= (pSrc->tbtt_info.tbtt_info_4.reserved << 20);
			if (unlikely(nBuf < 4))
				return DOT11F_INCOMPLETE_IE;

			frameshtonl(pCtx, pBuf, tmp233__, 0);
			*pnConsumed += 4;
			/* fieldsEndFlag  = 1 */
			nBuf -=  4 ;
			break;
		...
		case 10:
			...
			*pnConsumed += 6;
			pBuf += 6;
			tmp234__ = 0U;
			tmp234__ |= (pSrc->tbtt_info.tbtt_info_10.mld_id << 0);
			tmp234__ |= (pSrc->tbtt_info.tbtt_info_10.link_id << 8);
			tmp234__ |= (pSrc->tbtt_info.tbtt_info_10.bss_param_change_cnt << 12);
			tmp234__ |= (pSrc->tbtt_info.tbtt_info_10.reserved << 20);
			if (unlikely(nBuf < 4))
				return DOT11F_INCOMPLETE_IE;

			frameshtonl(pCtx, pBuf, tmp234__, 0);
			*pnConsumed += 4;
			/* fieldsEndFlag  = 1 */
			nBuf -=  4 ;
			break;
		...
		case 16:
			...
			*pnConsumed += 1;
			pBuf += 1;
			tmp235__ = 0U;
			tmp235__ |= (pSrc->tbtt_info.tbtt_info_16.mld_id << 0);
			tmp235__ |= (pSrc->tbtt_info.tbtt_info_16.link_id << 8);
			tmp235__ |= (pSrc->tbtt_info.tbtt_info_16.bss_param_change_cnt << 12);
			tmp235__ |= (pSrc->tbtt_info.tbtt_info_16.reserved << 20);
			if (unlikely(nBuf < 4))
				return DOT11F_INCOMPLETE_IE;

			frameshtonl(pCtx, pBuf, tmp235__, 0);
			*pnConsumed += 4;
			/* fieldsEndFlag  = 1 */
			nBuf -=  4 ;
			break;
